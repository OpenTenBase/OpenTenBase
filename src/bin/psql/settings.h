...
typedef struct _psqlSettings
{
	...
	bool send_extra_lines;	/* send blank lines and single-line comments */
	char *node_name;		/*current node name for opentenbase*/
	bool echo_row_delimiter; /* print a special string before accepting the next input line each time. */
} PsqlSettings;
