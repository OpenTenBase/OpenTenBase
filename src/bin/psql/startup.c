...
parse_psql_options(int argc, char *argv[], struct adhoc_opts *options)
{
	static struct option long_options[] =
	{
		...
		{"echo-row-delimiter", no_argument, NULL, 'r'},
		...
		{"send-extra-lines", no_argument, NULL, '2'},
	...
	while ((c = getopt_long(argc, argv, "aAbc:d:eEf:F:h:HlL:no:p:P:qrR:sStT:U:v:VwWxXz?012",
