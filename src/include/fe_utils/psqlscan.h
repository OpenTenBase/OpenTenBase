...
typedef enum _promptStatus
{
	...
	PROMPT_PAREN,
	PROMPT_COPY,
	PROMPT_QQUOTE /* opentenbase-ora-compatible:add q quoted status */
} promptStatus_t;
...
extern PsqlScanResult psql_scan_ora(PsqlScanState state,
		  PQExpBuffer query_buf,
		  promptStatus_t *prompt);

extern void psql_scan_reset(PsqlScanState state);
extern void psql_scan_slash_reset(PsqlScanState state);
...
extern char* skip_label(char *query, bool *is_find);
extern char* skip_comments(char *query_string, int query_len);
