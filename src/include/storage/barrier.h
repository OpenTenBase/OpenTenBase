...
typedef struct Barrier
{
	...
	int			max_parts;		/* max number of participants should attached */
	bool		static_party;	/* used only for assertions */
	ConditionVariable condition_variable;
} Barrier;

extern void BarrierInit(Barrier *barrier, int num_workers, int max_participants);
...
extern void BarrierRefreshParticipants(Barrier *barrier, int max_participants);
