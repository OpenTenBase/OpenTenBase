...
#define ShutdownWalRcv() ShutdownWalRcvInternal(__FILE__, __LINE__)
...
extern void ShutdownWalRcvInternal(char *file, int32 lineno);
extern bool WalRcvStreaming(void);
extern bool WalRcvRunning(void);
extern bool RequestXLogStreaming(TimeLineID tli, XLogRecPtr recptr,
