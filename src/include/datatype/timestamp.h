...
/* Like opentenbase_ora, the day precision is 0-9 */
#define MAX_INTERVAL_DAY_PRECISION 9
#define MAX_INTERVAL_YEAR_PRECISION 9
#define MAX_INTERVAL_MONTH_PRECISION 9
#define MAX_INTERVAL_HOUR_PRECISION 9
#define MAX_INTERVAL_MINUTE_PRECISION 9
