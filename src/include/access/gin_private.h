...
#define GinEnableChecksum(relation) \
	(((relation)->rd_rel->relkind == RELKIND_INDEX && \
	  (relation)->rd_rel->relam == GIN_AM_OID && (relation)->rd_options) ? \
	 ((GinOptions *)(relation)->rd_options)->checksum : false)
...
extern void GinInitBuffer(Buffer b, uint32 f, bool checksum_enabled);
extern void GinInitPage(Page page, uint32 f, Size pageSize, bool checksum_enabled);
extern void GinInitMetabuffer(Buffer b, bool checksum_enabled);
