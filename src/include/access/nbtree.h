...
#define BTTidSame(i1, i2)	\
	(ItemPointerGetBlockNumberNoCheck(&(i1)) == ItemPointerGetBlockNumber(&(i2)))
 ...
 */
extern void _bt_initmetapage(Page page, BlockNumber rootbknum, uint32 level, bool checksum_enabled);
...
extern void _bt_pageinit(Page page, Size size, bool tde, bool checksum_enabled);
...
extern bool SearchBufferAndCheckUnique(Relation rel, IndexTuple itup, IndexUniqueCheck checkUnique,
                                       Relation heapRel,                                      BTCheckElement *element, List *update_ctid, bool violationOK,
