...
#define REGBUF_KEEP_DATA	0x10	/* include data even if a full-page image
									 * is taken */
#define REGBUF_CHECKSUM_ENABLED 0x20


#define XLogRegisterBuffer(block_id, buffer, flags) \
	XLogRegisterBuffer_TDE(block_id, buffer, flags, false)
...
extern void XLogRegisterBuffer_TDE(uint8 block_id, Buffer buffer, uint8 flags, bool checksum_enabled);
extern void XLogRegisterBlock(uint8 block_id, RelFileNode *rnode,
				  ForkNumber forknum, BlockNumber blknum, char *page,
				  uint8 flags, bool checksum_enabled);
...
extern XLogRecPtr log_newpage_buffer(Buffer buffer, bool page_std, bool checksum_enabled);
extern void log_newpage_range(Relation rel, ForkNumber forknum, BlockNumber startblk,
