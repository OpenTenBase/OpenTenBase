...
extern void SpGistInitPage(Page page, uint16 f, bool checksum_enabled);
extern void SpGistInitBuffer(Buffer b, uint16 f, bool checksum_enabled);
extern void SpGistInitMetapage(Page page, bool checksum_enabled);
