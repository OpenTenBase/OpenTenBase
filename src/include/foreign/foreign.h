...
extern char               *get_foreign_server_name(Oid serverid);

extern bool rel_is_external_table(Oid relid);
extern bool rel_is_hdfsfdw_table(Oid relid);

extern char* TrimStr(const char* str);
extern List* DeserializePartitions(const char* partition);
