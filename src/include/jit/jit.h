...
typedef void (*JitProviderCompileHJCB) (struct HashJoinState *hjstate);
#endif
...
#ifdef __OPENTENBASE_C__
	JitProviderCompileHJCB compile_hashjoin;
#endif
};
...
#ifdef __OPENTENBASE_C__
extern void jit_compile_hashjoin(struct HashJoinState *hjstate);
#endif
