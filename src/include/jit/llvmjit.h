...
extern LLVMTypeRef StructVectorTableSlot;
extern LLVMTypeRef StructVectorDatumData;
extern LLVMTypeRef StructPlanState;
extern LLVMTypeRef StructHashJoinState;
extern LLVMTypeRef StructHashJoinTableData;
extern LLVMTypeRef StructHashJoinTupleData;
extern LLVMTypeRef StructHashJoinTableBuckets;
extern LLVMTypeRef StructHashJoinTupleNext;
#endif
...
#ifdef __OPENTENBASE_C__
extern LLVMValueRef FuncLLVMDebug;
extern LLVMValueRef FuncExecParallelHashFirstTuple;
extern LLVMValueRef FuncExecParallelHashNextTuple;
#endif
...
#ifdef __OPENTENBASE_C__
extern LLVMValueRef llvm_crc_reference(LLVMJitContext *context);
extern void llvm_compile_hashjoin(struct HashJoinState *hjstate);

/*
 * llvm::crc32 function definition
 */
#if defined(__aarch64__) || defined(__aarch64)
/* i32 @llvm.aarch64.crc32cx(i32, i64) */
#define llvm_crc32_32_64(crc_fn, crc, data)                             \
	{                                                                   \
		LLVMValueRef params[2];                                         \
		params[0] = crc;                                                \
		params[1] = data;                                               \
		crc = LLVMBuildCall(b, crc_fn, params, lengthof(params), "");   \
	}
#else
/* i64 @llvm.x86.sse42.crc32.64.64(i64, i64) */
#define llvm_crc32_32_64(crc_fn, crc, data)                             \
	{                                                                   \
		LLVMValueRef params[2];                                         \
		params[0] = LLVMBuildZExt(b, crc, LLVMInt64Type(), "");         \
		params[1] = data;                                               \
		crc = LLVMBuildTrunc(b,                                         \
				LLVMBuildCall(b, crc_fn, params, lengthof(params), ""), \
				LLVMInt32Type(), "");                                   \
	}
#endif
