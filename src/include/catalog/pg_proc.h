...
CATALOG(pg_proc,1255) BKI_BOOTSTRAP BKI_ROWTYPE_OID(81) BKI_SCHEMA_MACRO
{
	 ...
	 * proargtypes
	 */
	oidvector	proargtypes;	/* parameter types (excludes OUT params of functions) */
...
#define ORA_ANYCOUNTOID 2698
#define ORA_COUNTOID    3409
...
ORADATA(insert OID = 5070 (  longin         PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 8186 "2275" _null_ _null_ _null_ _null_ _null_ longin _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID =  5071 (  longout       PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "8186" _null_ _null_ _null_ _null_ _null_ longout _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 5072 (  longrecv       PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 8186 "2281" _null_ _null_ _null_ _null_ _null_ longrecv _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 5082 (  longsend       PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 17 "8186" _null_ _null_ _null_ _null_ _null_ longsend _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 5083 (  long2text      PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "8186" _null_ _null_ _null_ _null_ _null_ long2text _null_ _null_ _null_ ));
ORADESCR("I/O");
...
DATA(insert OID = 3416 ( starts_with       PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "25 25" _null_ _null_ _null_ _null_ _null_ text_starts_with _null_ _null_ _null_ ));
DESCR("starts with");
...
DESCR("length");
DATA(insert OID = 1258 (  textcat          PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 25 "25 25" _null_ _null_ _null_ _null_ _null_ textcat _null_ _null_ _null_ ));
...
/* opentenbase_ora remainder */
ORADATA(insert OID = 4766 ( remainder      PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1700 "1700 1700" _null_ _null_ _null_ _null_ _null_ numeric_remainder _null_ _null_ _null_ ));
ORADESCR("Use banker's rounding to return the remainder");
ORADATA(insert OID = 4767 ( remainder      PGORCL PGUID 14 1 0 0 0 f f f t f i s 2 0 1700 "25 25" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.remainder($1::numeric, $2::numeric)" _null_ _null_ _null_ ));
ORADESCR("Use banker's rounding to return the remainder");
ORADATA(insert OID = 4768 ( remainder      PGORCL PGUID 14 1 0 0 0 f f f t f i s 2 0 1700 "25 1700" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.remainder($1::numeric, $2)" _null_ _null_ _null_ ));
ORADESCR("Use banker's rounding to return the remainder");
ORADATA(insert OID = 4769 ( remainder      PGORCL PGUID 14 1 0 0 0 f f f t f i s 2 0 1700 "1700 25" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.remainder($1, $2::numeric)" _null_ _null_ _null_ ));
ORADESCR("Use banker's rounding to return the remainder");
ORADATA(insert OID = 4770 ( remainder      PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 23 "23 23" _null_ _null_ _null_ _null_ _null_ int4remainder _null_ _null_ _null_ ));
ORADESCR("Use banker's rounding to return the remainder with int4");
ORADATA(insert OID = 4771 ( remainder      PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 21 "21 21" _null_ _null_ _null_ _null_ _null_ int2remainder _null_ _null_ _null_ ));
ORADESCR("Use banker's rounding to return the remainder with int2");
ORADATA(insert OID = 4772 ( remainder      PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "20 20" _null_ _null_ _null_ _null_ _null_ int8remainder _null_ _null_ _null_ ));
ORADESCR("Use banker's rounding to return the remainder with int8");
ORADATA(insert OID = 4773 ( remainder      PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 700 "700 700" _null_ _null_ _null_ _null_ _null_ float4remainder _null_ _null_ _null_ ));
ORADESCR("Use banker's rounding to return the remainder with float4");
ORADATA(insert OID = 4774 ( remainder      PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 701 "701 701" _null_ _null_ _null_ _null_ _null_ float8remainder _null_ _null_ _null_ ));
ORADESCR("Use banker's rounding to return the remainder with float8");
...
DESCR("hash");
/* bithash(bit) => int4 */
DATA(insert OID = 8148 (  bithash          PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "1560" _null_ _null_ _null_ _null_ _null_ bithash _null_ _null_ _null_ ));
DESCR("hash");
/* bithash(varbit) => int4 */
DATA(insert OID = 8149 (  bithash          PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "1562" _null_ _null_ _null_ _null_ _null_ bithash _null_ _null_ _null_ ));
DESCR("hash");

DATA(insert OID = 4660 (  hashint2extended  PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "21 20" _null_ _null_ _null_ _null_ _null_ hashint2extended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4661 (  hashint4extended  PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "23 20" _null_ _null_ _null_ _null_ _null_ hashint4extended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4662 (  hashint8extended  PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "20 20" _null_ _null_ _null_ _null_ _null_ hashint8extended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4663 (  hashfloat4extended    PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "700 20" _null_ _null_ _null_ _null_ _null_ hashfloat4extended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4664 (  hashfloat8extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "701 20" _null_ _null_ _null_ _null_ _null_ hashfloat8extended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4665 (  hashoidextended   PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "26 20" _null_ _null_ _null_ _null_ _null_ hashoidextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4666 (  hashcharextended  PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "18 20" _null_ _null_ _null_ _null_ _null_ hashcharextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4667 (  hashnameextended  PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "19 20" _null_ _null_ _null_ _null_ _null_ hashnameextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4668 (  hashtextextended  PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "25 20" _null_ _null_ _null_ _null_ _null_ hashtextextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4669 (  hashvarlenaextended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "2281 20" _null_ _null_ _null_ _null_ _null_ hashvarlenaextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4670 (  hashoidvectorextended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "30 20" _null_ _null_ _null_ _null_ _null_ hashoidvectorextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4671 (  hash_aclitem_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "1033 20" _null_ _null_ _null_ _null_ _null_ hash_aclitem_extended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4672 (  hashmacaddrextended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "829 20" _null_ _null_ _null_ _null_ _null_ hashmacaddrextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4673 (  hashinetextended  PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "869 20" _null_ _null_ _null_ _null_ _null_ hashinetextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4674 (  hash_numeric_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "1700 20" _null_ _null_ _null_ _null_ _null_ hash_numeric_extended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4675 (  hashmacaddr8extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "774 20" _null_ _null_ _null_ _null_ _null_ hashmacaddr8extended _null_ _null_ _null_ ));
DESCR("hash");
...
ORADATA(insert OID = 5075 (  raw_larger       PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 4831 "4831 4831" _null_ _null_ _null_ _null_ _null_ raw_larger _null_ _null_ _null_ ));
ORADESCR("larger of two");
ORADATA(insert OID = 5076 (  raw_smaller      PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 4831 "4831 4831" _null_ _null_ _null_ _null_ _null_ raw_smaller _null_ _null_ _null_ ));
ORADESCR("smaller of two");
...
DESCR("hash");
DATA(insert OID = 4686 (  hash_array_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "2277 20" _null_ _null_ _null_ _null_ _null_ hash_array_extended _null_ _null_ _null_ ));
DESCR("hash");
...
DATA(insert OID = 395 (  array_to_string   PGNSP PGUID 12 1 0 0 0 f f f f f s s 2 0 25 "2277 25" _null_ _null_ _null_ _null_ _null_ array_to_text _null_ _null_ _null_ ));
...
DESCR("hash");
DATA(insert OID = 4676 (  hashbpcharextended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "1042 20" _null_ _null_ _null_ _null_ _null_    hashbpcharextended _null_ _null_ _null_ ));
DESCR("hash");
...
DESCR("I/O");
#define TIMESTAMPTZ_IN_OID 1150
...
DATA(insert OID = 1176 (  timestamptz      PGNSP PGUID 14 1 0 0 0 f f f t f s s 2 0 1184 "1082 1083" _null_ _null_ _null_ _null_ _null_ "select cast(($1 + $2) as pg_catalog.timestamptz)" _null_ _null_ _null_ ));
...
PGDATA(insert OID = 9299 (  last_day          PGNSP PGUID 12 1 0 0 0 f f f t f s r 1 0 1114 "1114" _null_ _null_ _null_ _null_ _null_ last_day _null_ _null_ _null_ ));
PGDESCR("last day");
PGDATA(insert OID = 9300 (  last_day          PGNSP PGUID 12 1 0 0 0 f f f t f s r 1 0 1184 "1184" _null_ _null_ _null_ _null_ _null_ last_day_timestamptz _null_ _null_ _null_ ));
PGDESCR("last day");
/* OIDS 1300 - 1399 */
...
#define SETVAL3_OID 1765
PGDATA(insert OID = 3078 (  pg_sequence_parameters    PGNSP PGUID 12 1 0 0 0 f f f t f s s 1 0 2249 "26" "{26,20,20,20,20,16,20,26}" "{i,o,o,o,o,o,o,o}" "{sequence_oid,start_value,minimum_value,maximum_value,increment,cycle_option,cache_size,data_type}" _null_ _null_ pg_sequence_parameters _null_ _null_ _null_));
PGDESCR("sequence parameters, for use by information schema");
ORADATA(insert OID = 3418 (  pg_sequence_parameters    PGNSP PGUID 12 1 0 0 0 f f f t f s s 1 0 2249 "26" "{26,1700,1700,1700,1700,16,1700,26,16}" "{i,o,o,o,o,o,o,o,o}" "{sequence_oid,start_value,minimum_value,maximum_value,increment,cycle_option,cache_size,data_type,order_option}" _null_ _null_ pg_sequence_parameters _null_ _null_ _null_));
ORADESCR("sequence parameters, for use by information schema");
...
DATA(insert OID = 5049 (  pseudo_proc_pkg	PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "23" _null_ _null_ _null_ _null_ _null_ pseudo_proc_pkg _null_ _null_ _null_ ));
DESCR("empty function in package header");
...
/* opentenbase_ora Compatibility Related Functions - By Edmund Mergl <E.Mergl@bawue.de> */
...
DATA(insert OID =  873 (  lpad         PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 25 "25 1700 25" _null_ _null_ _null_ _null_ _null_    lpad _null_ _null_ _null_ ));
DESCR("left-pad string to length");
DATA(insert OID =  874 (  rpad         PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 25 "25 1700 25" _null_ _null_ _null_ _null_ _null_    rpad _null_ _null_ _null_ ));
...
DATA(insert OID = 7014 (  ltrim        PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 25 "25 25 25" _null_ _null_ _null_ _null_ _null_ ltrim3 _null_ _null_ _null_ ));
DESCR("trim selected characters from left end of string");
DATA(insert OID = 7015 (  rtrim        PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 25 "25 25 25" _null_ _null_ _null_ _null_ _null_ rtrim3 _null_ _null_ _null_ ));
DESCR("trim selected characters from right end of string");
...
DATA(insert OID =  879 (  lpad         PGNSP PGUID 14 100 0 0 0 f f f t f i s 2 0 25 "25 1700" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.lpad($1, $2, '' '')" _null_ _null_ _null_ ));
DESCR("left-pad string to length");
DATA(insert OID =  880 (  rpad         PGNSP PGUID 14 100 0 0 0 f f f t f i s 2 0 25 "25 1700" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.rpad($1, $2, '' '')" _null_ _null_ _null_ ));
DESCR("right-pad string to length");
...
DESCR("extract portion of string");
PGDATA(insert OID = 9374 (  substr       PGNSP PGUID 12 1 0 0 0 f f f t f s s 2 0 25 "1700 1700" _null_ _null_ _null_ _null_  _null_ number_substr _null_ _null_ _null_ ));
PGDESCR("substr(numeric, numeric)");
PGDATA(insert OID = 9375 (  substr       PGNSP PGUID 12 1 0 0 0 f f f t f s s 3 0 25 "1700 1700 1700" _null_ _null_ _null_ _null_  _null_ number_substr _null_ _null_ _null_ ));
PGDESCR("substr(numeric, numeric, numeric)");
PGDATA(insert OID =  9994 (  substr       PGNSP PGUID 14 1 0 0 0 f f f t f i s 2 0 25 "1082 23" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.substr($1::text, $2)" _null_ _null_ _null_ ));
PGDESCR("substr(date, int)");
PGDATA(insert OID =  9995 (  substr       PGNSP PGUID 14 1 0 0 0 f f f t f i s 3 0 25 "1082 23 23" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.substr($1::text, $2, $3)" _null_ _null_ _null_ ));
PGDESCR("substr(date, int, int)");
PGDATA(insert OID =  9996 (  substr       PGNSP PGUID 14 1 0 0 0 f f f t f i s 2 0 25 "1114 23" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.substr($1::text, $2)" _null_ _null_ _null_ ));
PGDESCR("substr(timestamp, int)");
PGDATA(insert OID =  9997 (  substr       PGNSP PGUID 14 1 0 0 0 f f f t f i s 3 0 25 "1114 23 23" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.substr($1::text, $2, $3)" _null_ _null_ _null_ ));
PGDESCR("substr(timestamp, int, int)");
PGDATA(insert OID =  9998 (  substr       PGNSP PGUID 14 1 0 0 0 f f f t f i s 2 0 25 "1184 23" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.substr($1::text, $2)" _null_ _null_ _null_ ));
PGDESCR("substr(timestamptz, int)");
PGDATA(insert OID =  9999 (  substr       PGNSP PGUID 14 1 0 0 0 f f f t f i s 3 0 25 "1184 23 23" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.substr($1::text, $2, $3)" _null_ _null_ _null_ ));
PGDESCR("substr(timestamptz, int, int)");
...
DATA(insert OID = 7013 (  btrim        PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 25 "25 25 25" _null_ _null_ _null_ _null_ _null_ btrim3 _null_ _null_ _null_ ));
DESCR("trim selected characters from both ends of string");
...
DESCR("extract portion of string");
DATA(insert OID =  2087 ( replace      PGNSP PGUID 12 1 0 0 0 f f f f f i s 3 0 25 "25 25 25" _null_ _null_ _null_ _null_ _null_    replace_text _null_ _null_ _null_ ));
...
DATA(insert OID =  4720 ( regexp_like     PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "25 25" _null_ _null_ _null_ _null_ _null_ orcl_regexp_like_2 _null_ _null_ _null_ ));
DESCR("find first match for regexp");
DATA(insert OID =  4721 ( regexp_like     PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 16 "25 25 25" _null_ _null_ _null_ _null_ _null_ orcl_regexp_like _null_ _null_ _null_ ));
DESCR("find first match for regexp");
...
DATA(insert OID = 9221 ( pg_check_pushdown_function PGNSP PGUID 12 1 0 0 0 f f f t f s s 1 0 16 "26" _null_ _null_ _null_ _null_ _null_ pg_check_pushdown_function _null_ _null_ _null_));
DESCR("auto pushdown function");
...
DATA(insert OID = 1679 (  bitcat            PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 1562 "1562 1562" _null_ _null_ _null_ _null_ _null_    bitcat _null_ _null_ _null_ ));
...
DATA(insert OID = 2196 (  inet_client_addr      PGNSP PGUID 12 1 0 0 0 f f f f f i r 0 0 869 "" _null_ _null_ _null_ _null_ _null_ inet_client_addr _null_ _null_ _null_ ));
DESCR("inet address of the client");
DATA(insert OID = 2197 (  inet_client_port      PGNSP PGUID 12 1 0 0 0 f f f f f i r 0 0 23 "" _null_ _null_ _null_ _null_ _null_ inet_client_port _null_ _null_ _null_ ));
DESCR("client's port number for this connection");
DATA(insert OID = 2198 (  inet_server_addr      PGNSP PGUID 12 1 0 0 0 f f f f f i s 0 0 869 "" _null_ _null_ _null_ _null_ _null_ inet_server_addr _null_ _null_ _null_ ));
DESCR("inet address of the server");
DATA(insert OID = 2199 (  inet_server_port      PGNSP PGUID 12 1 0 0 0 f f f f f i s 0 0 23 "" _null_ _null_ _null_ _null_ _null_ inet_server_port _null_ _null_ _null_ ));
...
DESCR("GiST support");
DATA(insert OID = 3556 (  inet_gist_decompress	PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ inet_gist_decompress _null_ _null_ _null_ ));
DESCR("GiST support");
...
DESCR("hash");
DATA(insert OID = 4677 (  time_hash_extended   PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "1083 20" _null_ _null_ _null_ _null_ _null_ time_hash_extended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4678 (  timetz_hash_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "1266 20" _null_ _null_ _null_ _null_ _null_ timetz_hash_extended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 4679 (  interval_hash_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "1186 20" _null_ _null_ _null_ _null_ _null_ interval_hash_extended _null_ _null_ _null_ ));
DESCR("hash");
...
ORADATA(insert OID = 8143 ( numeric                PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 1700 "701 23" _null_ _null_ _null_ _null_ _null_ float8_numeric _null_ _null_ _null_ ));
ORADESCR("convert float8 to numeric with typmod");
...
ORADATA(insert OID = 4997 ( numeric_dec            PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 1700 "1700" _null_ _null_ _null_ _null_ _null_ numeric_dec _null_ _null_ _null_ ));
ORADESCR("decrement by one");
ORADATA(insert OID = 4996 ( numeric_inc_any            PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1700 "1700 2276" _null_ _null_ _null_ _null_ _null_ numeric_inc_any _null_ _null_ _null_ ));
ORADESCR("increment by one");
ORADATA(insert OID = 4995 ( numeric_dec_any           PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1700 "1700 2276" _null_ _null_ _null_ _null_ _null_ numeric_dec_any _null_ _null_ _null_ ));
ORADESCR("decrement by one");
...
#define PG_TODATE_TEXTTEXT_OID 1780
...
/* This to_char function v3 oid 8349 is used by pg_type, so use 9222 here */
DATA(insert OID = 9222 ( to_char            		PGNSP PGUID 12 1 0 0 0 f f f t f s s 2 0 25 "25 25" _null_ _null_ _null_ _null_  _null_ orcl_to_char _null_ _null_ _null_ ));
DESCR("format timestamp with time zone to text");

PGDATA(insert OID = 9287 ( to_timestamp				PGNSP PGUID 12 100 0 0 0 f f f f f s s 1 0 1114 "25" _null_ _null_ _null_ _null_  _null_ lightweight_ora_totimestamp_default _null_ _null_ _null_ ));
PGDESCR("convert text to timestamp with out time zone");

PGDATA(insert OID = 9571 ( to_date            PGNSP PGUID 12 1 0 0 0 f f f t f s s 2 0 1114 "1700 25" _null_ _null_ _null_ _null_  _null_ lightweight_ora_num_to_date _null_ _null_ _null_ ));
PGDESCR("convert numeric to date");
PGDATA(insert OID = 9572 ( to_date            PGNSP PGUID 12 1 0 0 0 f f f t f s s 1 0 1114 "1700" _null_ _null_ _null_ _null_  _null_ lightweight_ora_num_to_date _null_ _null_ _null_ ));
PGDESCR("convert numeric to date");

/* This to_date function v3 oid is 8288 */
PGDATA(insert OID = 8288 ( to_date					PGORCL PGUID 12 1 0 0 0 f f f f f s s 1 0 1114 "25" _null_ _null_ _null_ _null_  _null_ lightweight_ora_todate_default _null_ _null_ _null_ ));
PGDESCR("convert text to date compatible with lightweight_ora");

#define ORA_TODATE_TEXTTEXT_OID 8282
PGDATA(insert OID = 8282 ( to_date					PGORCL PGUID 12 1 0 0 0 f f f f f s s 2 0 1114 "25 25" _null_ _null_ _null_ _null_  _null_ lightweight_ora_todate _null_ _null_ _null_ ));
PGDESCR("convert text to date compatible with lightweight_ora");

/* This to_date function v3 oid 8285 is used by pg_operator, so use 9226 here */
PGDATA(insert OID = 9226 ( to_date					PGORCL PGUID 14 100 0 0 0 f f f f f s s 1 0 1114 "1114" _null_ _null_ _null_ _null_  _null_ "SELECT opentenbase_ora.to_date($1::pg_catalog.text)" _null_ _null_ _null_ ));
PGDESCR("convert date to date compatible with lightweight_ora");

/* This to_date function v3 oid 8291 is used by pg_type, so use 9227 here */
PGDATA(insert OID = 9227 ( to_date					PGORCL PGUID 14 100 0 0 0 f f f f f s s 2 0 1114 "1114 25" _null_ _null_ _null_ _null_  _null_ "SELECT opentenbase_ora.to_date($1::pg_catalog.text, $2)" _null_ _null_ _null_ ));
PGDESCR("convert date to date compatible with lightweight_ora");
...
PGDATA(insert OID = 9636 (  if PGNSP PGUID 14 1 0 0 0 f f f f f i s 3 0 1700 "16 1700 1700" _null_ _null_ _null_ _null_ _null_ "SELECT CASE $1 WHEN TRUE THEN $2 ELSE $3 END" _null_ _null_ _null_ ));
PGDESCR("if function numeric");
PGDATA(insert OID = 9637 (  if PGNSP PGUID 14 1 0 0 0 f f f f f i s 3 0 25 "16 25 25" _null_ _null_ _null_ _null_ _null_ "SELECT CASE $1 WHEN TRUE THEN $2 ELSE $3 END" _null_ _null_ _null_ ));
PGDESCR("if function text");
PGDATA(insert OID = 9638 (  integer_string_agg_transfn PGNSP PGUID 12 1 0 0 0 f f f f f i s 3 0 2281 "2281 20 25" _null_ _null_ _null_ _null_ _null_ integer_string_agg_transfn _null_ _null_ _null_ ));
PGDESCR("aggregate transition function for integer");
PGDATA(insert OID = 9649 (  string_agg                PGNSP PGUID 12 1 0 0 0 a f f f f i s 2 0 25 "20 25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
PGDESCR("concatenate aggregate input into a string for integer");
PGDATA(insert OID = 9648 (  interval         PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1186 "23" _null_ _null_ _null_ _null_ _null_ int4_interval _null_ _null_ _null_ ));
PGDESCR("convert integer to interval");
PGDATA(insert OID = 9750 (  interval         PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1186 "21" _null_ _null_ _null_ _null_ _null_ int2_interval _null_ _null_ _null_ ));
PGDESCR("convert int2 to interval");
PGDATA(insert OID = 9751 (  interval         PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1186 "700" _null_ _null_ _null_ _null_ _null_ float4_interval _null_ _null_ _null_ ));
PGDESCR("convert float4 to interval");
PGDATA(insert OID = 9752 (  interval         PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1186 "701" _null_ _null_ _null_ _null_ _null_ float8_interval _null_ _null_ _null_ ));
PGDESCR("convert float8 to interval");
PGDATA(insert OID = 9753 (  interval         PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1186 "1700" _null_ _null_ _null_ _null_ _null_ numeric_interval _null_ _null_ _null_ ));
PGDESCR("convert numeric to interval");
PGDATA(insert OID = 9647 (  substring    PGNSP PGUID 14 1 0 0 0 f f f t f i s 3 0 25 "23 23 23" _null_ _null_ _null_ _null_ _null_    "select substring($1::text, $2, $3)" _null_ _null_ _null_ ));
PGDESCR("extract portion of integer");

/* sum(text) */
PGDATA(insert OID = 9646 (  text_nu_sum      PGNSP PGUID 12 1 0 0 0 f f f f f i s 1 0 1700 "2281" _null_ _null_ _null_ _null_ _null_ text_nu_sum _null_ _null_ _null_ ));
PGDESCR("aggregate final function");
DATA(insert OID = 9645 (  text_nu_avg_accum    PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 25" _null_ _null_ _null_ _null_ _null_ text_nu_avg_accum _null_ _null_ _null_ ));
DESCR("aggregate transition function");
PGDATA(insert OID = 9644 (  text_nu_avg_combine    PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 2281" _null_ _null_ _null_ _null_ _null_ text_nu_avg_combine _null_ _null_ _null_ ));
PGDESCR("aggregate combine function");
PGDATA(insert OID = 9643 (  text_nu_avg_serialize    PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 17 "2281" _null_ _null_ _null_ _null_ _null_ text_nu_avg_serialize _null_ _null_ _null_ ));
PGDESCR("aggregate serial function");
PGDATA(insert OID = 9642 (  text_nu_avg_deserialize    PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 2281 "17 2281" _null_ _null_ _null_ _null_ _null_ text_nu_avg_deserialize _null_ _null_ _null_ ));
PGDESCR("aggregate deserial function");
PGDATA(insert OID = 9641 (  text_nu_accum_inv    PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 25" _null_ _null_ _null_ _null_ _null_ text_nu_accum_inv _null_ _null_ _null_ ));
PGDESCR("aggregate transition function");
PGDATA(insert OID = 9640 (  sum               PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 1700 "25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
PGDESCR("sum as numeric across all text input values");
/* to_timestamp_tz */
PGDATA(insert OID = 9639 ( to_timestamp_tz			PGNSP PGUID 12 100 0 0 0 f f f t f s s 1 0 1184 "25" _null_ _null_ _null_ _null_  _null_ lightweight_ora_totimestamptz_default _null_ _null_ _null_ ));
PGDESCR("convert text to timestamp with time zone");
/* END LIGHTWEIGHT_ORA */
...
DATA(insert OID = 5104 (  pg_stat_get_last_data_changed_time PGNSP PGUID 12 1 0 0 0 f f f t f s r 1 0 1184 "26" _null_ _null_ _null_ _null_ _null_ pg_stat_get_last_data_changed_time _null_ _null_ _null_ ));
DESCR("statistics: last data changed for a table");
...
DATA(insert OID = 2022 (  pg_stat_get_activity          PGNSP PGUID 12 1 100 0 0 f f f f t s r 1 0 2249 "23" "{23,26,23,26,25,25,25,25,25,1184,1184,1184,1184,869,25,23,28,28,25,16,25,25,23,16,25,25,25,25,25,23,25,25,20,20}" "{i,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o}" "{pid,datid,pid,usesysid,application_name,state,query,wait_event_type,wait_event,xact_start,query_start,backend_start,state_change,client_addr,client_hostname,client_port,backend_xid,backend_xmin,backend_type,ssl,sslversion,sslcipher,sslbits,sslcompression,sslclientdn,nodename,queryid,rsgname,wait_event_info,local_fid,planstate,statement,qid_ts_node,qid_seq}" _null_ _null_ pg_stat_get_activity _null_ _null_ _null_ ));
DESCR("statistics: information about currently active backends");
DATA(insert OID = 6150 (  pg_stat_get_cluster_activity          PGNSP PGUID 12 1 100 0 0 f f f f t s r 2 0 2249 "25 16" "{25,16,25,25,26,25,23,26,25,25,869,25,23,1184,1184,1184,1184,25,25,25,23,25,28,28,25,25,25,25,20,20}" "{i,i,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o}" "{queryid,onlycn,queryid,nodename,datid,datname,pid,usesysid,usename,application_name,client_addr,client_hostname,client_port,backend_start,xact_start,query_start,state_change,wait_event_type,wait_event,wait_event_info,local_fid,state,backend_xid,backend_xmin,query,backend_type,rsgname,planstate,qid_ts_node,qid_seq}" _null_ _null_ pg_stat_get_cluster_activity _null_ _null_ _null_ ));
DESCR("statistics: information about currently cluster active backends");
...
DATA(insert OID = 2026 (  pg_backend_pid                PGNSP PGUID 12 1 0 0 0 f f f t f i r 0 0 23 "" _null_ _null_ _null_ _null_ _null_ pg_backend_pid _null_ _null_ _null_ ));
...
DATA(insert OID = 5096 (  pg_stat_get_db_tuples_stashed PGNSP PGUID 12 1 0 0 0 f f f t f s r 1 0 20 "26" _null_ _null_ _null_ _null_ _null_ pg_stat_get_db_tuples_stashed _null_ _null_ _null_ ));
DESCR("statistics: tuples stashed in database");
...
DATA(insert OID = 2003 (  textanycat       PGNSP PGUID 14 1 0 0 0 f f f f f s s 2 0 25 "25 2776" _null_ _null_ _null_ _null_ _null_ "select $1 || $2::pg_catalog.text" _null_ _null_ _null_ ));
DATA(insert OID = 2004 (  anytextcat       PGNSP PGUID 14 1 0 0 0 f f f f f s s 2 0 25 "2776 25" _null_ _null_ _null_ _null_ _null_ "select $1::pg_catalog.text || $2" _null_ _null_ _null_ ));
...
DESCR("octet length");
DATA(insert OID = 2011 (  byteacat         PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 17 "17 17" _null_ _null_ _null_ _null_ _null_ byteacat _null_ _null_ _null_ ));
...
DESCR("hash");
DATA(insert OID = 4680 (  timestamp_hash_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "1114 20" _null_ _null_ _null_ _null_ _null_ timestamp_hash_extended _null_ _null_ _null_ ));
DESCR("hash");
...
DATA(insert OID = 4630 ( pg_xact_local_commit_timestamp PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 1184 "28" _null_ _null_ _null_ _null_ _null_ pg_xact_local_commit_timestamp _null_ _null_ _null_ ));
...
/* opentenbase-ora-compatible: Support avg for varchar2/text */
ORADATA(insert OID = 6061 (  avg               PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 1700 "8026" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("the average (arithmetic mean) as numeric of all varchar2 values");
ORADATA(insert OID = 6062 (  avg               PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 1700 "25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("the average (arithmetic mean) as numeric of all text values");
...
ORADATA(insert OID = 5073 (  max            PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 4831 "4831" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("maximum value of all text input values");
...
ORADATA(insert OID = 5074 (  min            PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 4831 "4831" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("minimum value of all text values");
...
PGDATA(insert OID = 2147 (  count             PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 20 "2276" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
PGDESCR("number of input rows for which the input expression is not null");
PGDATA(insert OID = 2803 (  count            PGNSP PGUID 12 1 0 0 0 a f f f f i s 0 0 20 "" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
PGDESCR("number of input rows");

ORADATA(insert OID = 2698 (  count             PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 1700 "2276" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("number of input rows for which the input expression is not null");
ORADATA(insert OID = 3409 (  count             PGNSP PGUID 12 1 0 0 0 a f f f f i s 0 0 1700 "" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("number of input rows");
...
/* start time function */
DATA(insert OID = 2560 (  pg_postmaster_start_time  PGNSP PGUID 12 1 0 0 0 f f f t f i s 0 0 1184 "" _null_ _null_ _null_ _null_ _null_ pg_postmaster_start_time _null_ _null_ _null_ ));
...
DESCR("GiST support");
DATA(insert OID = 2579 (  gist_box_compress		PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ gist_box_compress _null_ _null_ _null_ ));
DESCR("GiST support");
DATA(insert OID = 2580 (  gist_box_decompress	PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ gist_box_decompress _null_ _null_ _null_ ));
DESCR("GiST support");
DATA(insert OID = 3281 (  gist_box_fetch	PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ gist_box_fetch _null_ _null_ _null_ ));
DESCR("GiST support");
...
DESCR("hash");
DATA(insert OID = 4681 (  uuid_hash_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "2950 20" _null_ _null_ _null_ _null_ _null_ uuid_hash_extended _null_ _null_ _null_ ));
DESCR("hash");
...
DESCR("hash");
DATA(insert OID = 4682 (  pg_lsn_hash_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "3220 20" _null_ _null_ _null_ _null_ _null_ pg_lsn_hash_extended _null_ _null_ _null_ ));
DESCR("hash");
...
DESCR("hash");
DATA(insert OID = 4683 (  hashenumextended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "3500 20" _null_ _null_ _null_ _null_ _null_ hashenumextended _null_ _null_ _null_ ));
DESCR("hash");
...
DATA(insert OID = 3625 (  tsvector_concat       PGNSP PGUID 12 1 0  0 0 f f f f f i s 2 0 3614 "3614 3614" _null_ _null_ _null_ _null_ _null_ tsvector_concat _null_ _null_ _null_ ));
...
DATA(insert OID = 3670 (  tsquery_or        PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 3615 "3615 3615" _null_ _null_ _null_ _null_ _null_ tsquery_or _null_ _null_ _null_ ));
...
DATA(insert OID = 3696 (  gtsquery_decompress			PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ gtsquery_decompress _null_ _null_ _null_ ));
DESCR("GiST tsquery support");
...
DESCR("hash");
DATA(insert OID = 4684 (  jsonb_hash_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "3802 20" _null_ _null_ _null_ _null_ _null_ jsonb_hash_extended _null_ _null_ _null_ ));
DESCR("hash");
...
DESCR("GiST support");
DATA(insert OID = 3877 (  range_gist_compress	PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ range_gist_compress _null_ _null_ _null_ ));
DESCR("GiST support");
DATA(insert OID = 3878 (  range_gist_decompress PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ range_gist_decompress _null_ _null_ _null_ ));
DESCR("GiST support");
DATA(insert OID = 3996 (  range_gist_fetch		PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ range_gist_fetch _null_ _null_ _null_ ));
DESCR("GiST support");
...
DESCR("hash a range");
DATA(insert OID = 4685 (  hash_range_extended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "3831 20" _null_ _null_ _null_ _null_ _null_ hash_range_extended _null_ _null_ _null_ ));
DESCR("hash a range");
...
/* jsonpath */
DATA(insert OID = 4001 ( jsonpath_in    PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 4172 "2275" _null_ _null_ _null_ _null_ _null_ jsonpath_in _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 4002 ( jsonpath_recv  PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 4172 "2281" _null_ _null_ _null_ _null_ _null_ jsonpath_recv _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 4003 ( jsonpath_out   PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "4172" _null_ _null_ _null_ _null_ _null_ jsonpath_out _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 4004 ( jsonpath_send  PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 17   "4172" _null_ _null_ _null_ _null_ _null_ jsonpath_send _null_ _null_ _null_ ));
DESCR("I/O");

DATA(insert OID = 4005 ( jsonb_path_exists      PGNSP PGUID 12 1 0    0 0 f f f t f i s 4 0 16   "3802 4172 3802 16" _null_ _null_ _null_ _null_ _null_ jsonb_path_exists _null_ _null_ _null_ ));
DESCR("jsonpath exists test");
DATA(insert OID = 4006 ( jsonb_path_query       PGNSP PGUID 12 1 1000 0 0 f f f t t i s 4 0 3802 "3802 4172 3802 16" _null_ _null_ _null_ _null_ _null_ jsonb_path_query _null_ _null_ _null_ ));
DESCR("jsonpath query");
DATA(insert OID = 4007 ( jsonb_path_query_array PGNSP PGUID 12 1 0    0 0 f f f t f i s 4 0 3802 "3802 4172 3802 16" _null_ _null_ _null_ _null_ _null_ jsonb_path_query_array _null_ _null_ _null_ ));
DESCR("jsonpath query wrapped into array");
DATA(insert OID = 4008 ( jsonb_path_query_first PGNSP PGUID 12 1 0    0 0 f f f t f i s 4 0 3802 "3802 4172 3802 16" _null_ _null_ _null_ _null_ _null_ jsonb_path_query_first _null_ _null_ _null_ ));
DESCR("jsonpath query first item");
DATA(insert OID = 4009 ( jsonb_path_match       PGNSP PGUID 12 1 0    0 0 f f f t f i s 4 0 16   "3802 4172 3802 16" _null_ _null_ _null_ _null_ _null_ jsonb_path_match _null_ _null_ _null_ ));
DESCR("jsonpath match");

DATA(insert OID = 4010 ( jsonb_path_exists_opr  PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "3802 4172" _null_ _null_ _null_ _null_ _null_ jsonb_path_exists_opr _null_ _null_ _null_ ));
DESCR("implementation of @? operator");
DATA(insert OID = 4011 ( jsonb_path_match_opr   PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "3802 4172" _null_ _null_ _null_ _null_ _null_ jsonb_path_match_opr _null_ _null_ _null_ ));
DESCR("implementation of @@ operator");
...
DATA(insert OID = 6015 ( pg_msgmodule_set PGNSP PGUID 12 1 1 0 0 f f f t t i s 4 0 16 "20 20 20 25" _null_ _null_ _null_ _null_ _null_ pg_msgmodule_set _null_ _null_ _null_ ));
DESCR("set debugging level for module/file/msg");
DATA(insert OID = 6016 ( pg_msgmodule_change PGNSP PGUID 12 1 1 0 0 f f f t t i s 4 0 16 "20 20 20 20" _null_ _null_ _null_ _null_ _null_ pg_msgmodule_change _null_ _null_ _null_ ));
DESCR("change debugging level for module/file/msg");
DATA(insert OID = 6017 ( pg_msgmodule_enable PGNSP PGUID 12 1 1 0 0 f f f t t i s 1 0 16 "20" _null_ _null_ _null_ _null_ _null_ pg_msgmodule_enable _null_ _null_ _null_ ));
DESCR("pid to honour overriden log levels");
DATA(insert OID = 6018 ( pg_msgmodule_disable PGNSP PGUID 12 1 1 0 0 f f f t t i s 1 0 16 "20" _null_ _null_ _null_ _null_ _null_ pg_msgmodule_disable _null_ _null_ _null_ ));
DESCR("pid to ignore overriden log levels");
DATA(insert OID = 6019 ( pg_msgmodule_enable_all PGNSP PGUID 12 1 1 0 0 f f f t t i s 1 0 16 "16" _null_ _null_ _null_ _null_ _null_ pg_msgmodule_enable_all _null_ _null_ _null_ ));
DESCR("all current/future processes to honour overriden log levels");
DATA(insert OID = 6020 ( pg_msgmodule_disable_all PGNSP PGUID 12 1 1 0 0 f f f t t i s 0 0 16 "" _null_ _null_ _null_ _null_ _null_ pg_msgmodule_disable_all _null_ _null_ _null_ ));
...
DATA(insert OID = 3442 ( pg_control_checkpoint PGNSP PGUID 12 1 0 0 0 f f f t f v s 0 0 2249 "" "{3220,3220,3220,25,23,23,16,25,26,28,28,28,26,28,28,26,28,28,1184,1184,1184,23}" "{o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o}" "{checkpoint_lsn,prior_lsn,redo_lsn,redo_wal_file,timeline_id,prev_timeline_id,full_page_writes,next_xid,next_oid,next_multixact_id,next_multi_offset,oldest_xid,oldest_xid_dbid,oldest_active_xid,oldest_multi_xid,oldest_multi_dbid,oldest_commit_ts_xid,newest_commit_ts_xid,checkpoint_time,latest_committimestamp,latest_gts,need_mvcc_if_page_is_visible}" _null_ _null_ pg_control_checkpoint _null_ _null_ _null_ ));
...
DATA(insert OID = 4687 ( satisfies_hash_partition PGNSP PGUID 12 1 0 2276 0 f f f f f i s 4 0 16 "26 23 23 2276" _null_ "{i,i,i,v}" _null_ _null_ _null_ satisfies_hash_partition _null_ _null_ _null_ ));
DESCR("hash partition CHECK constraint");

/* information about a partition tree */
DATA(insert OID = 4688 ( pg_partition_tree PGNSP PGUID 12 1 1000 0 0 f f f t t v s 1 0 2249 "2205" "{2205,2205,2205,16,23}" "{i,o,o,o,o}" "{rootrelid,relid,parentrelid,isleaf,level}" _null_ _null_ pg_partition_tree _null_ _null_ _null_ ));
DESCR("view partition tree tables");

/* function to get the top-most partition root parent */
DATA(insert OID = 4689 ( pg_partition_root PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2205 "2205" _null_ _null_ _null_ _null_ _null_ pg_partition_root _null_ _null_ _null_ ));
DESCR("get top-most partition root parent");

DATA(insert OID = 4690 ( pg_partition_ancestors PGNSP PGUID 12 1 10 0 0 f f f t t v s 1 0 2205 "2205" "{2205,2205}" "{i,o}" "{partitionid,relid}" _null_ _null_ pg_partition_ancestors _null_ _null_ _null_ ));
DESCR("view ancestors of the partition");

/*
 * All other functions not defined by postgres.
 * NOTE: we should use oid between 8000~9999 (first choice) or 7000~8000 (second choice).
 */
#ifdef PGXC
DATA(insert OID = 7007 ( pgxc_pool_check	PGNSP PGUID 12 1 0 0 0 f f f t f v u 0 0 16 "" _null_ _null_ _null_ _null_ _null_ pgxc_pool_check _null_ _null_ _null_ ));
DESCR("check connection information consistency in pooler");
DATA(insert OID = 7008 ( pgxc_pool_reload	PGNSP PGUID 12 1 0 0 0 f f f t f v u 0 0 16 "" _null_ _null_ _null_ _null_ _null_ pgxc_pool_reload _null_ _null_ _null_ ));
DESCR("reload connection information in pooler and reload server sessions");
DATA(insert OID = 7009 ( pgxc_node_str		PGNSP PGUID 12 1 0 0 0 f f f t f s u 0 0 19 "" _null_ _null_ _null_ _null_ _null_ pgxc_node_str _null_ _null_ _null_ ));
DESCR("get the name of the node");
DATA(insert OID = 7010 (  pgxc_is_committed	PGNSP PGUID 12 1 1 0 0 f f f t t s u 1 0 16 "28" _null_ _null_ _null_ _null_ _null_ pgxc_is_committed _null_ _null_ _null_ ));
DESCR("is given GXID committed or aborted?");
DATA(insert OID = 7024 (  pgxc_is_inprogress	PGNSP PGUID 12 1 1 0 0 f f f t t s u 1 0 16 "28" _null_ _null_ _null_ _null_ _null_ pgxc_is_inprogress _null_ _null_ _null_ ));
DESCR("is given GXID in progress?");
DATA(insert OID = 7011 ( pgxc_lock_for_backup PGNSP PGUID 12 1 0 0 0 f f f t f v u 0 0 16 "" _null_ _null_ _null_ _null_ _null_ pgxc_lock_for_backup _null_ _null_ _null_ ));
DESCR("lock the cluster for taking backup");
DATA(insert OID = 7012 ( pgxc_pool_disconnect PGNSP PGUID 12 1 0 0 0 f f f t f v u 2 0 16 "19 19" "{19,19}" "{i,i}" "{database, username}" _null_ _null_ pgxc_pool_disconnect _null_ _null_ _null_ ));
DESCR("disconnect pooler to other nodes with the identified database and/or username");
#endif

/* numericd type */
DATA(insert OID = 9303 ( numericd_in             PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 9301 "2275 26 23" _null_ _null_ _null_ _null_ _null_ numericd_in _null_ _null_ _null_ ));
#define NUMERICD_IN_OID 9303
DESCR("I/O");
DATA(insert OID = 9304 ( numericd_out            PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "9301" _null_ _null_ _null_ _null_ _null_ numericd_out _null_ _null_ _null_ ));
DESCR("I/O");
#define NUMERICD_OUT 9304
DATA(insert OID = 9309 (  numericd_recv         PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 9301 "2281 26 23" _null_ _null_ _null_ _null_  _null_ numericd_recv _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 9310 (  numericd_send         PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 17 "9301" _null_ _null_ _null_ _null_ _null_    numericd_send _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 9305 (  avg               PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 9301 "9301" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("the average (arithmetic mean) as numericd of all numeric values");
DATA(insert OID = 9306 (  sum               PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 9301 "9301" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("sum as numericd across all numeric input values");
DATA(insert OID = 9307 (  max               PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 9301 "9301" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("maximum value of all numericd input values");
DATA(insert OID = 9308 (  min               PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 9301 "9301" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("minimum value of all numericd input values");
DATA(insert OID = 9311 ( numericd_larger         PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9301 "9301 9301" _null_ _null_ _null_ _null_ _null_    numericd_larger _null_ _null_ _null_ ));
DESCR("larger of two");
DATA(insert OID = 9312 ( numericd_smaller        PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9301 "9301 9301" _null_ _null_ _null_ _null_ _null_    numericd_smaller _null_ _null_ _null_ ));
DESCR("smaller of two");
DATA(insert OID = 9313 ( numericd_transform      PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ numericd_transform _null_ _null_ _null_ ));
DESCR("transform a numericd length coercion");
DATA(insert OID = 9314 ( numericd           PGNSP PGUID 12 1 0 0 numericd_transform f f f t f i s 2 0 9301 "9301 23" _null_ _null_ _null_ _null_ _null_ numericd _null_ _null_ _null_ ));
DESCR("adjust numericd to typmod precision/scale");
DATA(insert OID = 9410 (  btnumericdcmp       PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 23 "9301 9301" _null_ _null_ _null_ _null_ _null_ btnumericdcmp _null_ _null_ _null_ ));
DESCR("less-equal-greater");
DESCR("sort support");
DATA(insert OID = 9411 ( btnumericdsortsupport PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2278 "2281" _null_ _null_ _null_ _null_ _null_ btnumericdsortsupport _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 9412 (  hashnumericd        PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "9301" _null_ _null_ _null_ _null_ _null_ hashnumericd _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 9413 (  hashnumericdextended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "9301 20" _null_ _null_ _null_ _null_ _null_ hashnumericdextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 9500 (  numericd_eq       PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "9301 9301" _null_ _null_ _null_ _null_ _null_ numericd_eq _null_ _null_ _null_ ));
DATA(insert OID = 9501 (  numericd_ne       PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "9301 9301" _null_ _null_ _null_ _null_ _null_ numericd_ne _null_ _null_ _null_ ));
DATA(insert OID = 9502 (  numericd_lt       PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "9301 9301" _null_ _null_ _null_ _null_ _null_ numericd_lt _null_ _null_ _null_ ));
DATA(insert OID = 9503 (  numericd_le       PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "9301 9301" _null_ _null_ _null_ _null_ _null_ numericd_le _null_ _null_ _null_ ));
DATA(insert OID = 9504 (  numericd_gt       PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "9301 9301" _null_ _null_ _null_ _null_ _null_ numericd_gt _null_ _null_ _null_ ));
DATA(insert OID = 9505 (  numericd_ge       PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "9301 9301" _null_ _null_ _null_ _null_ _null_ numericd_ge _null_ _null_ _null_ ));
DATA(insert OID = 9506 (  numericd_mul         PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9301 "9301 9301" _null_ _null_ _null_ _null_ _null_    numericd_mul _null_ _null_ _null_ ));
DATA(insert OID = 9507 (  numericd_div         PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9301 "9301 9301" _null_ _null_ _null_ _null_ _null_    numericd_div _null_ _null_ _null_ ));
DATA(insert OID = 9508 (  numericd_pl          PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9301 "9301 9301" _null_ _null_ _null_ _null_ _null_    numericd_pl _null_ _null_ _null_ ));
DATA(insert OID = 9509 (  numericd_mi          PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9301 "9301 9301" _null_ _null_ _null_ _null_ _null_    numericd_mi _null_ _null_ _null_ ));
DATA(insert OID = 9510 (  numericd_avg_accum  PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9302 "9302 9301" _null_ _null_ _null_ _null_ _null_    numericd_avg_accum _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 9511 (  numericd_avg_combine PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9302 "9302 9302" _null_ _null_ _null_ _null_ _null_ numericd_avg_combine _null_ _null_ _null_ ));
DESCR("aggregate combine function");
DATA(insert OID = 9512 (  numericd_avg       PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9301 "9302" _null_ _null_ _null_ _null_ _null_ numericd_avg _null_ _null_ _null_ ));
DESCR("aggregate final function");
DATA(insert OID = 9601 ( int8                   PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 20 "9301" _null_ _null_ _null_ _null_ _null_ numericd_int8 _null_ _null_ _null_ ));
DESCR("convert numericd to int8");
DATA(insert OID = 9602 ( int2                   PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 21 "9301" _null_ _null_ _null_ _null_ _null_ numericd_int2 _null_ _null_ _null_ ));
DESCR("convert numericd to int2");
DATA(insert OID = 9603 ( int4                   PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "9301" _null_ _null_ _null_ _null_ _null_ numericd_int4 _null_ _null_ _null_ ));
DESCR("convert numericd to int4");
DATA(insert OID = 9604 ( float4                 PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 700 "9301" _null_ _null_ _null_ _null_ _null_ numericd_float4 _null_ _null_ _null_ ));
DESCR("convert numericd to float4");
DATA(insert OID = 9605 ( float8                 PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 701 "9301" _null_ _null_ _null_ _null_ _null_ numericd_float8 _null_ _null_ _null_ ));
DESCR("convert numericd to float8");
DATA(insert OID = 9606 ( numeric                PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1700 "9301" _null_ _null_ _null_ _null_ _null_ numericd_numeric _null_ _null_ _null_ ));
DESCR("convert numericd to numeric");
DATA(insert OID = 9607 ( numericd               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9301 "20" _null_ _null_ _null_ _null_ _null_ int8_numericd _null_ _null_ _null_ ));
DESCR("convert int8 to numericd");
DATA(insert OID = 9608 ( numericd               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9301 "21" _null_ _null_ _null_ _null_ _null_ int2_numericd _null_ _null_ _null_ ));
DESCR("convert int2 to numericd");
DATA(insert OID = 9609 ( numericd               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9301 "23" _null_ _null_ _null_ _null_ _null_ int4_numericd _null_ _null_ _null_ ));
DESCR("convert int4 to numericd");
DATA(insert OID = 9610 ( numericd               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9301 "700" _null_ _null_ _null_ _null_ _null_ float4_numericd _null_ _null_ _null_ ));
DESCR("convert float4 to numericd");
DATA(insert OID = 9611 ( numericd               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9301 "701" _null_ _null_ _null_ _null_ _null_ float8_numericd _null_ _null_ _null_ ));
DESCR("convert float8 to numericd");
DATA(insert OID = 9612 ( numericd               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9301 "1700" _null_ _null_ _null_ _null_ _null_ numeric_numericd _null_ _null_ _null_ ));
DESCR("convert numeric to numericd");

/* numericf type */
DATA(insert OID = 9353 ( numericf_in             PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 9351 "2275 26 23" _null_ _null_ _null_ _null_ _null_ numericf_in _null_ _null_ _null_ ));
#define NUMERICF_IN_OID 9353
DESCR("I/O");
DATA(insert OID = 9354 ( numericf_out            PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "9351" _null_ _null_ _null_ _null_ _null_ numericf_out _null_ _null_ _null_ ));
DESCR("I/O");
#define NUMERICF_OUT 9354
DATA(insert OID = 9359 (  numericf_recv         PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 9351 "2281 26 23" _null_ _null_ _null_ _null_  _null_ numericf_recv _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 9360 (  numericf_send         PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 17 "9351" _null_ _null_ _null_ _null_ _null_    numericf_send _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 9355 (  avg               PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 9301 "9351" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("the average (arithmetic mean) as numericf of all numeric values");
DATA(insert OID = 9356 (  sum               PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 9351 "9351" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("sum as numericf across all numeric input values");
DATA(insert OID = 9357 (  max               PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 9351 "9351" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("maximum value of all numericf input values");
DATA(insert OID = 9358 (  min               PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 9351 "9351" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("minimum value of all numericf input values");
DATA(insert OID = 9361 ( numericf_larger         PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9351 "9351 9351" _null_ _null_ _null_ _null_ _null_    numericf_larger _null_ _null_ _null_ ));
DESCR("larger of two");
DATA(insert OID = 9362 ( numericf_smaller        PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9351 "9351 9351" _null_ _null_ _null_ _null_ _null_    numericf_smaller _null_ _null_ _null_ ));
DESCR("smaller of two");
DATA(insert OID = 9363 ( numericf_transform      PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2281 "2281" _null_ _null_ _null_ _null_ _null_ numericf_transform _null_ _null_ _null_ ));
DESCR("transform a numericf length coercion");
DATA(insert OID = 9364 ( numericf           PGNSP PGUID 12 1 0 0 numericf_transform f f f t f i s 2 0 9351 "9351 23" _null_ _null_ _null_ _null_ _null_ numericf _null_ _null_ _null_ ));
DESCR("adjust numericf to typmod precision/scale");
DATA(insert OID = 9460 (  btnumericfcmp       PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 23 "9351 9351" _null_ _null_ _null_ _null_ _null_ btnumericfcmp _null_ _null_ _null_ ));
DESCR("less-equal-greater");
DESCR("sort support");
DATA(insert OID = 9461 ( btnumericfsortsupport PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2278 "2281" _null_ _null_ _null_ _null_ _null_ btnumericfsortsupport _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 9462 (  hashnumericf        PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "9351" _null_ _null_ _null_ _null_ _null_ hashnumericf _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 9463 (  hashnumericfextended PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "9351 20" _null_ _null_ _null_ _null_ _null_ hashnumericfextended _null_ _null_ _null_ ));
DESCR("hash");
DATA(insert OID = 9550 (  numericf_eq           PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16   "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_eq _null_ _null_ _null_ ));
DATA(insert OID = 9551 (  numericf_ne           PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16   "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_ne _null_ _null_ _null_ ));
DATA(insert OID = 9552 (  numericf_lt           PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16   "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_lt _null_ _null_ _null_ ));
DATA(insert OID = 9553 (  numericf_le           PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16   "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_le _null_ _null_ _null_ ));
DATA(insert OID = 9554 (  numericf_gt           PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16   "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_gt _null_ _null_ _null_ ));
DATA(insert OID = 9555 (  numericf_ge           PGNSP PGUID 12 1 0 0 0 f f t t f i s 2 0 16   "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_ge _null_ _null_ _null_ ));
DATA(insert OID = 9556 (  numericf_mul          PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9301 "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_mul _null_ _null_ _null_ ));
DATA(insert OID = 9557 (  numericf_div          PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9301 "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_div _null_ _null_ _null_ ));
DATA(insert OID = 9558 (  numericf_pl           PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9351 "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_pl _null_ _null_ _null_ ));
DATA(insert OID = 9559 (  numericf_mi           PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9351 "9351 9351" _null_ _null_ _null_ _null_ _null_ numericf_mi _null_ _null_ _null_ ));
DATA(insert OID = 9560 (  numericf_avg_accum    PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 9302 "9302 9351" _null_ _null_ _null_ _null_ _null_ numericf_avg_accum _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 9651 ( int8                   PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 20 "9351" _null_ _null_ _null_ _null_ _null_ numericf_int8 _null_ _null_ _null_ ));
DESCR("convert numericf to int8");
DATA(insert OID = 9652 ( int2                   PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 21 "9351" _null_ _null_ _null_ _null_ _null_ numericf_int2 _null_ _null_ _null_ ));
DESCR("convert numericf to int2");
DATA(insert OID = 9653 ( int4                   PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "9351" _null_ _null_ _null_ _null_ _null_ numericf_int4 _null_ _null_ _null_ ));
DESCR("convert numericf to int4");
DATA(insert OID = 9654 ( float4                 PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 700 "9351" _null_ _null_ _null_ _null_ _null_ numericf_float4 _null_ _null_ _null_ ));
DESCR("convert numericf to float4");
DATA(insert OID = 9655 ( float8                 PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 701 "9351" _null_ _null_ _null_ _null_ _null_ numericf_float8 _null_ _null_ _null_ ));
DESCR("convert numericf to float8");
DATA(insert OID = 9656 ( numeric                PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1700 "9351" _null_ _null_ _null_ _null_ _null_ numericf_numeric _null_ _null_ _null_ ));
DESCR("convert numericf to numeric");
DATA(insert OID = 9657 ( numericf               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9351 "20" _null_ _null_ _null_ _null_ _null_ int8_numericf _null_ _null_ _null_ ));
DESCR("convert int8 to numericf");
DATA(insert OID = 9658 ( numericf               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9351 "21" _null_ _null_ _null_ _null_ _null_ int2_numericf _null_ _null_ _null_ ));
DESCR("convert int2 to numericf");
DATA(insert OID = 9659 ( numericf               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9351 "23" _null_ _null_ _null_ _null_ _null_ int4_numericf _null_ _null_ _null_ ));
DESCR("convert int4 to numericf");
DATA(insert OID = 9660 ( numericf               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9351 "700" _null_ _null_ _null_ _null_ _null_ float4_numericf _null_ _null_ _null_ ));
DESCR("convert float4 to numericf");
DATA(insert OID = 9661 ( numericf               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9351 "701" _null_ _null_ _null_ _null_ _null_ float8_numericf _null_ _null_ _null_ ));
DESCR("convert float8 to numericf");
DATA(insert OID = 9662 ( numericf               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9351 "1700" _null_ _null_ _null_ _null_ _null_ numeric_numericf _null_ _null_ _null_ ));
DESCR("convert numeric to numericf");
DATA(insert OID = 9663 ( numericd               PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 9301 "9351" _null_ _null_ _null_ _null_ _null_ numericf_numericd _null_ _null_ _null_ ));
DESCR("convert numericf to numericd");

#ifdef __OPENTENBASE__
DATA(insert OID = 8000 (  opentenbase_version		PGNSP PGUID 12 1 0 0 0 f f f t f s s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ opentenbase_version _null_ _null_ _null_ ));
DESCR("OpenTenBase version string");

DATA(insert OID = 8001 (  show_node_lock PGNSP PGUID 12 1 1000 0 0 f f f t t v s 0 0 2249 "" "{25,25,25,25,25,25,25,25,25}" "{o,o,o,o,o,o,o,o,o}" "{HeavyLock,LightLock,Schema,Table,Shard,EventLock,ColstoreLock,ColstoreShard,ShardCluster}" _null_ _null_ show_node_lock _null_ _null_ _null_ ));
DESCR("show information about node lock");
DATA(insert OID = 8002 (  pg_node_lock PGNSP PGUID 12 1 0 0 0 f f f t f v s 6 0 16 "25 18 25 25 23 25" _null_ _null_ _null_ _null_  _null_ pg_node_lock _null_ _null_ _null_ ));
DESCR("set node lock");
DATA(insert OID = 8003 (  pg_node_unlock PGNSP PGUID 12 1 0 0 0 f f f t f v s 5 0 16 "25 18 25 25 25" _null_ _null_ _null_ _null_  _null_ pg_node_unlock _null_ _null_ _null_ ));
DESCR("release node lock");

DATA(insert OID = 8017 (  pg_list_gtm_store		PGNSP PGUID 12 1 0 0 0 f f f f f s r 0 0 2249 "" "{20,23,23,23,20,23,23,23,23,23,23,23,23,20,1184,23}" "{o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o}" "{system_identifier,major_version,minor_version,gtm_status,global_time_stamp,global_xmin,next_gxid,seq_total,seq_used,seq_freelist,txn_total,txn_used,txn_freelist,system_lsn,last_update_time,crc_check_value}" _null_ _null_ pg_list_gtm_store _null_ _null_ _null_ ));
DESCR("gtm store: list gtm store info");
DATA(insert OID = 8018 (  pg_list_storage_sequence		PGNSP PGUID 12 1 0 0 0 f f f f f s r 0 0 2249 "" "{25,23,20,20,20,20,20,16,16,16,23,23,1184,23,23}" "{o,o,o,o,o,o,o,o,o,o,o,o,o,o,o}" "{gsk_key,gsk_type,gs_value,gs_init_value,gs_increment_by,gs_min_value,gs_max_value,gs_cycle,gs_called,gs_reserved,gs_status,gti_store_handle,last_update_time,gs_next,gs_crc}" _null_ _null_ pg_list_storage_sequence _null_ _null_ _null_ ));
DESCR("gtm store: list gtm stored sequence info");
DATA(insert OID = 8019 (  pg_list_storage_transaction		PGNSP PGUID 12 1 0 0 0 f f f f f s r 0 0 2249 "" "{25,25,23,23,1184,23,23}" "{o,o,o,o,o,o,o}" "{gti_gid,node_list,gti_state,gti_store_handle,last_update_time,gs_next,gs_crc}" _null_ _null_ pg_list_storage_transaction _null_ _null_ _null_ ));
DESCR("gtm store: list gtm stored sequence info");
DATA(insert OID = 8020 (  pg_check_storage_sequence		PGNSP PGUID 12 1 0 0 0 f f f f f s r 1 0 2249 "16" "{16,25,23,20,20,20,20,20,16,16,16,23,23,1184,23,23,23,23}" "{i,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o}" "{need_fix, gsk_key,gsk_type,gs_value,gs_init_value,gs_increment_by,gs_min_value,gs_max_value,gs_cycle,gs_called,gs_reserved,gs_status,gti_store_handle,last_update_time,gs_next,gs_crc,error_msg,check_status}" _null_ _null_ pg_check_storage_sequence _null_ _null_ _null_ ));
DESCR("gtm store: check gtm stored sequence status");
DATA(insert OID = 8021 (  pg_check_storage_transaction		PGNSP PGUID 12 1 0 0 0 f f f f f s r 1 0 2249 "16" "{16,25,25,23,23,1184,23,23,23,23}" "{i,o,o,o,o,o,o,o,o,o}" "{need_fix, gti_gid,node_list,gti_state,gti_store_handle,last_update_time,gs_next,gs_crc,error_msg,check_status}" _null_ _null_ pg_check_storage_transaction _null_ _null_ _null_ ));
DESCR("gtm store: list gtm stored sequence info");

DATA(insert OID = 8092 (  pgxz_license		PGNSP PGUID 12 1 0 0 0 f f f t f i s 0 0 25 "" 	_null_ _null_ _null_ _null_ _null_ pgxz_license _null_ _null_ _null_ ));
DESCR("list pgxz license info");
DATA(insert OID = 8093 (  pgxz_reload_license	PGNSP PGUID 12 1 0 0 0 f f f t f i s 0 0 16 "" 	_null_ _null_ _null_ _null_ _null_ pgxz_reload_license _null_ _null_ _null_ ));
DESCR("reload pgxz license info");
#endif

#ifdef __AUDIT__
DATA(insert OID = 8030 (  pg_get_audit_action_name	   PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "23" _null_ _null_ _null_ _null_ _null_ pg_get_audit_action_name _null_ _null_ _null_ ));
DESCR("audit action name by OID (with fallback)");
DATA(insert OID = 8031 (  pg_get_audit_action_mode	   PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "18" _null_ _null_ _null_ _null_ _null_ pg_get_audit_action_mode _null_ _null_ _null_ ));
DESCR("audit action name by OID (with fallback)");
DATA(insert OID = 8032 (  add_policy	   PGNSP PGUID 12 1 0 0 0 f f f f f i s 10 0 16 "25 25 25 25 25 25 25 16 25 16" _null_ _null_ "{object_schema,object_name,policy_name,audit_columns,audit_condition,handler_schema,handler_module,audit_enable,statement_types,audit_column_opts}" _null_ _null_ add_policy _null_ _null_ _null_ ));
DESCR("create fga audit policy");
DATA(insert OID = 8033 (  drop_policy	   PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 16 "25 25 25" _null_ _null_ "{object_schema,object_name,policy_name}" _null_ _null_ drop_policy _null_ _null_ _null_ ));
DESCR("drop fga audit policy");
DATA(insert OID = 8034 (  enable_policy	   PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 16 "25 25 25" _null_ _null_ "{object_schema,object_name,policy_name}" _null_ _null_ enable_policy _null_ _null_ _null_ ));
DESCR("enable fga audit policy");
DATA(insert OID = 8035 (  disable_policy	   PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 16 "25 25 25" _null_ _null_ "{object_schema,object_name,policy_name}" _null_ _null_ disable_policy _null_ _null_ _null_ ));
DESCR("disable fga audit policy");
DATA(insert OID = 8036 (  enable_all_policy	   PGNSP PGUID 12 1 0 0 0 f f f t f i s 0 0 16 "" _null_ _null_ _null_ _null_ _null_ enable_all_policy _null_ _null_ _null_ ));
DESCR("enable fga audit policy");
DATA(insert OID = 8037 (  disable_all_policy	   PGNSP PGUID 12 1 0 0 0 f f f t f i s 0 0 16 "" _null_ _null_ _null_ _null_ _null_ disable_all_policy _null_ _null_ _null_ ));
DESCR("disable fga audit policy");
DATA(insert OID = 8038 (  drop_all_policy	   PGNSP PGUID 12 1 0 0 0 f f f t f i s 0 0 16 "" _null_ _null_ _null_ _null_ _null_ drop_all_policy _null_ _null_ _null_ ));
DESCR("disable fga audit policy");
DATA(insert OID = 8039 ( pg_rotate_audit_logfile		PGNSP PGUID 12 1 0 0 0 f f f t f v s 0 0 16 "" _null_ _null_ _null_ _null_ _null_ pg_rotate_audit_logfile _null_ _null_ _null_ ));
DESCR("rotate audit log file");
#endif

#ifdef _MLS_
DATA(insert OID = 8040 (  clsitemin    PGNSP PGUID 12 1 0 0 0 f f f t f s s 1 0 8015 "2275" _null_ _null_ _null_ _null_ _null_ clsitemin    _null_ _null_ _null_ ));
DESCR("cls I/O");
DATA(insert OID = 8041 (  clsitemout   PGNSP PGUID 12 1 0 0 0 f f f t f s s 1 0 2275 "8015" _null_ _null_ _null_ _null_ _null_ clsitemout   _null_ _null_ _null_ ));
DESCR("cls I/O");
DATA(insert OID = 8042 (  pg_cls_check PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 16   "8015" _null_ _null_ _null_ _null_ _null_ pg_cls_check _null_ _null_ _null_ ));
DESCR("check cls strategy");
DATA(insert OID = 8043 (  pg_execute_query_on_all_nodes PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 16   "25" _null_ _null_ _null_ _null_ _null_ pg_execute_query_on_all_nodes _null_ _null_ _null_ ));
DESCR("execute query string on all nodes");
DATA(insert OID = 8044 (  pg_get_table_oid_by_name PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 26   "25" _null_ _null_ _null_ _null_ _null_ pg_get_table_oid_by_name _null_ _null_ _null_ ));
DESCR("get table oid on current exec node");
DATA(insert OID = 8045 (  pg_get_role_oid_by_name PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 26   "19" _null_ _null_ _null_ _null_ _null_ pg_get_role_oid_by_name _null_ _null_ _null_ ));
DESCR("get role oid on current exec node");
DATA(insert OID = 8046 (  pg_get_function_oid_by_name PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 26   "19" _null_ _null_ _null_ _null_ _null_ pg_get_function_oid_by_name _null_ _null_ _null_ ));
DESCR("get function oid on current exec node");
DATA(insert OID = 8047 (  pg_get_schema_oid_by_name PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 26   "19" _null_ _null_ _null_ _null_ _null_ pg_get_schema_oid_by_name _null_ _null_ _null_ ));
DESCR("get schema oid on current exec node");
DATA(insert OID = 8048 (  pg_get_tablespace_oid_by_tablename PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 26   "25" _null_ _null_ _null_ _null_ _null_ pg_get_tablespace_oid_by_tablename _null_ _null_ _null_ ));
DESCR("get tablespace oid on current exec node");
DATA(insert OID = 8049 (  pg_get_tablespace_name_by_tablename PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 19   "25" _null_ _null_ _null_ _null_ _null_ pg_get_tablespace_name_by_tablename _null_ _null_ _null_ ));
DESCR("get tablespace name on current exec node");
DATA(insert OID = 8050 (  pg_get_current_database_oid PGNSP PGUID 12 1 0 0 0 f f f t f v s 0 0 26   "" _null_ _null_ _null_ _null_ _null_ pg_get_current_database_oid _null_ _null_ _null_ ));
DESCR("get database oid on current exec node");
DATA(insert OID = 8051 (  pg_transparent_crypt_support_datatype PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 16   "26" _null_ _null_ _null_ _null_ _null_ pg_transparent_crypt_support_datatype _null_ _null_ _null_ ));
DESCR("check datatype is supported column crypt or not");
#endif

#ifdef _SHARDING_
DATA(insert OID = 8054 (  pg_extent_info				PGNSP PGUID 12 10 20 0 0 f f f f t v s 1 0 2249 "2205" "{2205,23,16,23,23,23,23,23,23,23}" "{i,o,o,o,o,o,o,o,o,o}" "{rel,eid,is_occupied,shardid,freespace_cat,hwm,scan_next,scan_prev,alloc_next,alloc_prev}" _null_ _null_ pg_extent_info_oid _null_ _null_ _null_ ));
DESCR("get extent info of a relation");
DATA(insert OID = 8055 (  pg_shard_scan_list			PGNSP PGUID 12 10 20 0 0 f f f f t v s 2 0 2249 "2205 23" "{2205,23,23,16,23,23,23,23}" "{i,i,o,o,o,o,o,o}" "{rel,sid,eid,is_occupied,shardid,freespace_cat,hwm,scan_next}" _null_ _null_ pg_shard_scan_list_oid _null_ _null_ _null_ ));
DESCR("get shard scan list of a relation");
DATA(insert OID = 8056 (  pg_shard_alloc_list			PGNSP PGUID 12 10 20 0 0 f f f f t v s 2 0 2249 "2205 23" "{2205,23,23,16,23,23,23,23}" "{i,i,o,o,o,o,o,o}" "{rel,sid,eid,is_occupied,shardid,freespace_cat,hwm,alloc_next}" _null_ _null_ pg_shard_alloc_list_oid _null_ _null_ _null_ ));
DESCR("get shard alloc list of a relation");
DATA(insert OID = 8057 (  pg_shard_anchor				PGNSP PGUID 12 10 20 0 0 f f f f t v s 1 0 2249 "2205" "{2205,23,23,23,23,23,23,23}" "{i,o,o,o,o,o,o,o}" "{rel,sid,pageno,slotinpage,scanhead,scantail,allochead,alloctail}" _null_ _null_ pg_shard_anchor_oid _null_ _null_ _null_ ));
DESCR("get all of shard anchor of a relation");
DATA(insert OID = 8058 (  pg_stat_barrier_shards		PGNSP PGUID 12 10 20 0 0 f f f f t v s 0 0 2249 "" "{23,23,23,23,21,1184,23}" "{o,o,o,o,o,o,o}" "{pid,dbid,spcid,relid,shardid,start,flags}" _null_ _null_ pg_stat_barrier_shards _null_ _null_ _null_ ));
DESCR("get all of barrier shards");
DATA(insert OID = 8059 (  pg_check_extent				PGNSP PGUID 12 10 20 0 0 f f f f t v s 1 0 2249 "2205" "{2205,23,23,25,23,16,23,23,23,23,23,23,23}" "{i,o,o,o,o,o,o,o,o,o,o,o,o}" "{rel,eid,err_code,error,page_shardid,is_occupied,shardid,freespace_cat,hwm,scan_next,scan_prev,alloc_next,alloc_prev}" _null_ _null_ pg_check_extent _null_ _null_ _null_ ));
DESCR("check extent catalog");

DATA(insert OID = 8060 ( pg_allocated_tablespace_size		PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 20 "26" _null_ _null_ _null_ _null_ _null_ pg_allocated_tablespace_size_oid _null_ _null_ _null_ ));
DESCR("total disk space allocated for the specified tablespace");
DATA(insert OID = 8061 ( pg_allocated_tablespace_size		PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 20 "19" _null_ _null_ _null_ _null_ _null_ pg_allocated_tablespace_size_name _null_ _null_ _null_ ));
DESCR("total disk space allocated for the specified tablespace");
DATA(insert OID = 8062 ( pg_allocated_database_size		PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 20 "26" _null_ _null_ _null_ _null_ _null_ pg_allocated_database_size_oid _null_ _null_ _null_ ));
DESCR("total disk space allocated for the specified database");
DATA(insert OID = 8063 ( pg_allocated_database_size		PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 20 "19" _null_ _null_ _null_ _null_ _null_ pg_allocated_database_size_name _null_ _null_ _null_ ));
DESCR("total disk space allocated for the specified database");
DATA(insert OID = 8064 ( pg_allocated_relation_size		PGNSP PGUID 14 1 0 0 0 f f f t f v s 1 0 20 "2205" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.pg_allocated_relation_size($1, ''main'')" _null_ _null_ _null_ ));
DESCR("disk space allocated for the main fork of the specified table or index");
DATA(insert OID = 8065 ( pg_allocated_relation_size		PGNSP PGUID 12 1 0 0 0 f f f t f v s 2 0 20 "2205 25" _null_ _null_ _null_ _null_ _null_ pg_allocated_relation_size _null_ _null_ _null_ ));
DESCR("disk space allocated for the specified fork of a table or index");
DATA(insert OID = 8066 ( pg_allocated_total_relation_size PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 20 "2205" _null_ _null_ _null_ _null_ _null_ pg_allocated_total_relation_size _null_ _null_ _null_ ));
DESCR("total disk space allocated for the specified table and associated indexes");
DATA(insert OID = 8067 ( pg_allocated_table_size			PGNSP PGUID 12 1 0 0 0 f f f t f v s 1 0 20 "2205" _null_ _null_ _null_ _null_ _null_ pg_allocated_table_size _null_ _null_ _null_ ));
DESCR("disk space allocated for the specified table, including TOAST, free space and visibility map");
DATA(insert OID = 8068 (  pg_stat_all_shard 				PGNSP PGUID 12 1 1000 0 0 f f f t t v s 0 0 2249 "" "{23,20}" "{o,o}" "{shardid, tuplecount}" _null_ _null_ pg_stat_all_shard _null_ _null_ _null_ ));
DESCR("stat database shard tuple count");
DATA(insert OID = 8069 (  pg_stat_table_shard 			PGNSP PGUID 12 1 1000 0 0 f f f t t v s 1 0 2249 "25" "{25,23,20}" "{i,o,o}" "{relation, shardid, tuplecount}" _null_ _null_ pg_stat_table_shard _null_ _null_ _null_ ));
DESCR("stat table shard tuple count");

DATA(insert OID = 8070 (  opentenbase_table_shard_stat_sample 	PGNSP PGUID 12 1 1000 0 0 f f f f t v s 2 0 2249 "25 700" "{25,700,23,20,20}" "{i,i,o,o,o}" "{relation,ratio,shard_id, ntups, size}" _null_ _null_ opentenbase_table_shard_stat_internal _null_ _null_ _null_ ));
DESCR("stat table shard tuple count");
DATA(insert OID = 8071 (  opentenbase_shard_stat_sample 			PGNSP PGUID 12 1 1000 0 0 f f f f t v s 1 0 2249 "700" "{700,23,20,20}" "{i,o,o,o}" "{ratio,shard_id, ntups, size}" _null_ _null_ opentenbase_shard_stat_internal _null_ _null_ _null_ ));
DESCR("stat table shard tuple count");
#endif

#ifdef __STORAGE_SCALABLE__
DATA(insert OID = 8072 (  opentenbase_get_pub_stat PGNSP PGUID 12 1 0 0 0 f f f t t v r 1 0 2249 "25" "{25,25,20,20,20,20,20}" "{i,o,o,o,o,o,o}" "{sub_name,subscription_name,ntups_copyOut,ntups_insert,ntups_delete,checksum_insert,checksum_delete}" _null_ _null_ opentenbase_get_pub_stat _null_ _null_ _null_ ));
DESCR("get statistic data of one publication");
DATA(insert OID = 8073 (  opentenbase_get_all_pub_stat PGNSP PGUID 12 1 0 0 0 f f f t t v r 0 0 2249 "" "{25,20,20,20,20,20}" "{o,o,o,o,o,o}" "{subscription_name,ntups_copyOut,ntups_insert,ntups_delete,checksum_insert,checksum_delete}" _null_ _null_ opentenbase_get_all_pub_stat _null_ _null_ _null_ ));
DESCR("get statistic data of all publications");
DATA(insert OID = 8074 (  opentenbase_get_sub_stat PGNSP PGUID 12 1 0 0 0 f f f t t v r 1 0 2249 "25" "{25,25,20,20,20,20,20}" "{i,o,o,o,o,o,o}" "{sub_name,subscription_name,ntups_copyIn,ntups_insert,ntups_delete,checksum_insert,checksum_delete}" _null_ _null_ opentenbase_get_sub_stat _null_ _null_ _null_ ));
DESCR("get statistic data of one subscription");
DATA(insert OID = 8075 (  opentenbase_get_all_sub_stat PGNSP PGUID 12 1 0 0 0 f f f t t v r 0 0 2249 "" "{25,20,20,20,20,20}" "{o,o,o,o,o,o}" "{subscription_name,ntups_copyIn,ntups_insert,ntups_delete,checksum_insert,checksum_delete}" _null_ _null_ opentenbase_get_all_sub_stat _null_ _null_ _null_ ));
DESCR("get statistic data of all subscriptions");
DATA(insert OID = 8076 (  opentenbase_get_pubtable_stat PGNSP PGUID 12 1 0 0 0 f f f t t v r 2 0 2249 "26 26" "{26,26,26,26,20,20,20,20,20}" "{i,i,o,o,o,o,o,o,o}" "{subid,relid,subscription_id,relation_id,ntups_copyOut,ntups_insert,ntups_delete,checksum_insert,checksum_delete}" _null_ _null_ opentenbase_get_pubtable_stat _null_ _null_ _null_ ));
DESCR("get statistic data of one publication with one table");
DATA(insert OID = 8077 (  opentenbase_get_all_pubtable_stat PGNSP PGUID 12 1 0 0 0 f f f t t v r 0 0 2249 "" "{26,26,20,20,20,20,20}" "{o,o,o,o,o,o,o}" "{subscription_id,relation_id,ntups_copyOut,ntups_insert,ntups_delete,checksum_insert,checksum_delete}" _null_ _null_ opentenbase_get_all_pubtable_stat _null_ _null_ _null_ ));
DESCR("get statistic data of all publications with its tables");
DATA(insert OID = 8078 (  opentenbase_get_subtable_stat PGNSP PGUID 12 1 0 0 0 f f f t t v r 2 0 2249 "26 26" "{26,26,26,26,18,20,20,20,20,20}" "{i,i,o,o,o,o,o,o,o,o}" "{subid,relid,subscription_id,relation_id,state,ntups_copyIn,ntups_insert,ntups_delete,checksum_insert,checksum_delete}" _null_ _null_ opentenbase_get_subtable_stat _null_ _null_ _null_ ));
DESCR("get statistic data of one subscription with one table");
DATA(insert OID = 8079 (  opentenbase_get_all_subtable_stat PGNSP PGUID 12 1 0 0 0 f f f t t v r 0 0 2249 "" "{26,26,18,20,20,20,20,20}" "{o,o,o,o,o,o,o,o}" "{subscription_id,relation_id,state,ntups_copyIn,ntups_insert,ntups_delete,checksum_insert,checksum_delete}" _null_ _null_ opentenbase_get_all_subtable_stat _null_ _null_ _null_ ));
DESCR("get statistic data of all subscriptions with its tables");
DATA(insert OID = 8080 (  opentenbase_set_pub_stat_check PGNSP PGUID 12 1 0 0 0 f f f t f v r 2 0 16 "16 16" _null_ _null_ _null_ _null_ _null_ opentenbase_set_pub_stat_check _null_ _null_ _null_ ));
DESCR("enable collecting publication statistic data");
DATA(insert OID = 8081 (  opentenbase_set_sub_stat_check PGNSP PGUID 12 1 0 0 0 f f f t f v r 2 0 16 "16 16" _null_ _null_ _null_ _null_ _null_ opentenbase_set_sub_stat_check _null_ _null_ _null_ ));
DESCR("enable collecting subscription statistic data");
DATA(insert OID = 8082 (  opentenbase_get_pub_stat_check PGNSP PGUID 12 1 0 0 0 f f f t t v r 0 0 2249 "" "{16,16}" "{o,o}" "{statcount,statchecksum}" _null_ _null_ opentenbase_get_pub_stat_check _null_ _null_ _null_ ));
DESCR("show publication statistic data collection info");
DATA(insert OID = 8083 (  opentenbase_get_sub_stat_check PGNSP PGUID 12 1 0 0 0 f f f t t v r 0 0 2249 "" "{16,16}" "{o,o}" "{statcount,statchecksum}" _null_ _null_ opentenbase_get_sub_stat_check _null_ _null_ _null_ ));
DESCR("show subscription statistic data collection info");
DATA(insert OID = 8084 (  opentenbase_remove_pub_stat PGNSP PGUID 12 1 0 0 0 f f f t f v r 1 0 16 "25" _null_ _null_ _null_ _null_ _null_ opentenbase_remove_pub_stat _null_ _null_ _null_ ));
DESCR("remove publication statistic entry in hashtable");
DATA(insert OID = 8085 (  opentenbase_remove_pubtable_stat PGNSP PGUID 12 1 0 0 0 f f f t f v r 1 0 16 "26" _null_ _null_ _null_ _null_ _null_ opentenbase_remove_pubtable_stat _null_ _null_ _null_ ));
DESCR("remove publication table statistic entry in hashtable");
DATA(insert OID = 8086 (  opentenbase_remove_sub_stat PGNSP PGUID 12 1 0 0 0 f f f t f v r 1 0 16 "25" _null_ _null_ _null_ _null_ _null_ opentenbase_remove_sub_stat _null_ _null_ _null_ ));
DESCR("remove subscription statistic entry in hashtable");
DATA(insert OID = 8087 (  opentenbase_remove_subtable_stat PGNSP PGUID 12 1 0 0 0 f f f t f v r 1 0 16 "26" _null_ _null_ _null_ _null_ _null_ opentenbase_remove_subtable_stat _null_ _null_ _null_ ));
DESCR("remove subscription table statistic entry in hashtable");
DATA(insert OID = 8088 (  vacuum_hidden_shards	PGNSP PGUID 12 1 0 0 0 f f f t f s r 1 0 20 "25" _null_ _null_ _null_ _null_ _null_ vacuum_hidden_shards _null_ _null_ _null_ ));
DESCR("vacuum hidden shards");
DATA(insert OID = 8089 (  opentenbase_shard_statistic PGNSP PGUID 12 1 0 0 0 f f f t t v r 0 0 2249 "" "{25,25,23,20,20,20,20,20,20}" "{o,o,o,o,o,o,o,o,o}" "{group_name,node_name,shard_id,ntups_select,ntups_insert,ntups_update,ntups_delete,size,ntups}" _null_ _null_ opentenbase_shard_statistic _null_ _null_ _null_ ));
DESCR("show statistic data of all shards");

DATA(insert OID = 8090 (  opentenbase_set_need_mvcc PGNSP PGUID 12 1 0 0 0 f f f t f v r 1 0 16 "23" _null_ _null_ _null_ _null_ _null_ opentenbase_set_need_mvcc _null_ _null_ _null_ ));
DESCR("set need_mvcc flag");
DATA(insert OID = 8091 (  opentenbase_show_need_mvcc PGNSP PGUID 12 1 0 0 0 f f f t f v r 0 0 23 "" _null_ _null_ _null_ _null_ _null_ opentenbase_show_need_mvcc _null_ _null_ _null_ ));
DESCR("show need_mvcc flag");
#endif

#ifdef _PG_ORCL_
ORADATA(insert OID = 8188 (  orcl_int4div		PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 1700 "23 23" _null_ _null_ _null_ _null_ _null_ "SELECT pg_catalog.numeric_div(cast($1 as pg_catalog.numeric), cast($2 as pg_catalog.numeric))" _null_ _null_ _null_ ));
ORADESCR("int4 divide int4");

/* varchar2 built-in functions */
ORADATA(insert OID = 8101 (  varchar2in	   PGORCL PGUID 12 1 0 0 0 f f f t f i s 3 0 8026 "2275 26 23" _null_ _null_ _null_ _null_ _null_ varchar2in _null_ _null_ _null_ ));
ORADESCR("I/O");
#define VARCHAR2_IN_OID 8101
ORADATA(insert OID = 8102 (  varchar2out	   PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "8026" _null_ _null_ _null_ _null_ _null_ varchar2out _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8103 (  varchar2typmodin  PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "1263" _null_ _null_ _null_ _null_ _null_ varchar2typmodin _null_ _null_ _null_ ));
ORADESCR("I/O typmod");
ORADATA(insert OID = 8104 (  varchar2typmodout PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "23" _null_ _null_ _null_ _null_ _null_ varchar2typmodout _null_ _null_ _null_ ));
ORADESCR("I/O typmod");
ORADATA(insert OID = 8105 (  varchar2recv	   PGORCL PGUID 12 1 0 0 0 f f f t f s s 3 0 8026 "2281 26 23" _null_ _null_ _null_ _null_  _null_ varchar2recv _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8106 (  varchar2send		PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 17 "8026" _null_ _null_ _null_ _null_ _null_ varchar2send _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8107 (  varchar2		   PGORCL PGUID 12 1 0 0 varchar_transform f f f t f i s 3 0 8026 "8026 23 16" _null_ _null_ _null_ _null_ _null_ varchar2 _null_ _null_ _null_ ));
ORADESCR("adjust varchar2() to typmod length");

/* nvarchar2 built-in functions */
ORADATA(insert OID = 8108 (  nvarchar2in	   PGORCL PGUID 12 1 0 0 0 f f f t f i s 3 0 8027 "2275 26 23" _null_ _null_ _null_ _null_ _null_ nvarchar2in _null_ _null_ _null_ ));
ORADESCR("I/O");
#define NVARCHAR2_IN_OID 8108
ORADATA(insert OID = 8109 (  nvarchar2out	   PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "8027" _null_ _null_ _null_ _null_ _null_ nvarchar2out _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8110 (  nvarchar2typmodin  PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "1263" _null_ _null_ _null_ _null_ _null_ nvarchar2typmodin _null_ _null_ _null_ ));
ORADESCR("I/O typmod");
ORADATA(insert OID = 8111 (  nvarchar2typmodout PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "23" _null_ _null_ _null_ _null_ _null_ nvarchar2typmodout _null_ _null_ _null_ ));
ORADESCR("I/O typmod");
ORADATA(insert OID = 8112 (  nvarchar2recv	   PGORCL PGUID 12 1 0 0 0 f f f t f s s 3 0 8027 "2281 26 23" _null_ _null_ _null_ _null_  _null_ nvarchar2recv _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8113 (  nvarchar2send		PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 17 "8027" _null_ _null_ _null_ _null_ _null_ nvarchar2send _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8114 (  nvarchar2		   PGORCL PGUID 12 1 0 0 varchar_transform f f f t f i s 3 0 8027 "8027 23 16" _null_ _null_ _null_ _null_ _null_ nvarchar2 _null_ _null_ _null_ ));
ORADESCR("adjust nvarchar2() to typmod length");


/* rowid builtin functions */
ORADATA(insert OID = 8115 (  rowid_in			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 8022 "2275" _null_ _null_ _null_ _null_ _null_ rowid_in _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8116 (  rowid_out			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "8022" _null_ _null_ _null_ _null_ _null_ rowid_out _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8117 (  rowid_recv		PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 8022 "2281" _null_ _null_ _null_ _null_ _null_ rowid_recv _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8118 (  rowid_send		PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 17 "8022" _null_ _null_ _null_ _null_ _null_ rowid_send _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8119 (  rowid_eq			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8022 8022" _null_ _null_ _null_ _null_ _null_ rowid_eq _null_ _null_ _null_ ));
ORADATA(insert OID = 8120 (  rowid_ne			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8022 8022" _null_ _null_ _null_ _null_ _null_ rowid_ne _null_ _null_ _null_ ));
ORADATA(insert OID = 8121 (  rowid_lt			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8022 8022" _null_ _null_ _null_ _null_ _null_ rowid_lt _null_ _null_ _null_ ));
ORADATA(insert OID = 8122 (  rowid_le			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8022 8022" _null_ _null_ _null_ _null_ _null_ rowid_le _null_ _null_ _null_ ));
ORADATA(insert OID = 8123 (  rowid_gt			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8022 8022" _null_ _null_ _null_ _null_ _null_ rowid_gt _null_ _null_ _null_ ));
ORADATA(insert OID = 8124 (  rowid_ge			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8022 8022" _null_ _null_ _null_ _null_ _null_ rowid_ge _null_ _null_ _null_ ));
ORADATA(insert OID = 8125 (  rowid_larger		PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 8022 "8022 8022" _null_ _null_ _null_ _null_ _null_ rowid_larger _null_ _null_ _null_ ));
ORADESCR("larger of two");
ORADATA(insert OID = 8126 (  rowid_smaller		PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 8022 "8022 8022" _null_ _null_ _null_ _null_ _null_ rowid_smaller _null_ _null_ _null_ ));
ORADESCR("smaller of two");
ORADATA(insert OID = 8127 (  btrowidcmp		PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 23 "8022 8022" _null_ _null_ _null_ _null_ _null_ btrowidcmp _null_ _null_ _null_ ));
ORADESCR("less-equal-greater");
ORADATA(insert OID = 8128 (  rowid_hash	    PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "8022" _null_ _null_ _null_ _null_ _null_ rowid_hash _null_ _null_ _null_ ));
ORADESCR("hash");
ORADATA(insert OID = 9205 (  rowid_hash_extended	PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "8022 20" _null_ _null_ _null_ _null_ _null_ rowid_hash_extended _null_ _null_ _null_ ));
ORADESCR("hash");
ORADATA(insert OID = 8129 (  rowidtoraw		PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "8022" _null_ _null_ _null_ _null_  _null_ rowid_to_raw_text _null_ _null_ _null_ ));
ORADESCR("convert rowid to raw format");
ORADATA(insert OID = 8130 (  rowidtochar		PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "8022" _null_ _null_ _null_ _null_  _null_ rowid_to_text _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton ROWIDTOCHAR(rid)");
ORADATA(insert OID = 8131 (  chartorowid		PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 8022 "25" _null_ _null_ _null_ _null_  _null_ text_to_rowid _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton CHARTOROWID(text)");

/* opentenbase_ora raw support */
ORADATA(insert OID = 4765 (  raw           		PGORCL PGUID 12 1 0 0 varchar_transform f f f t f i s 3 0 4831 "4831 23 16" _null_ _null_ _null_ _null_ _null_ varchar _null_ _null_ _null_ ));
ORADESCR("adjust raw() to typmod length");
ORADATA(insert OID = 4815 ( rawin             		PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 4831 "2275" _null_ _null_ _null_ _null_ _null_ rawin _null_ _null_ _null_ ));
ORADESCR("I/O");
#define RAW_IN_OID 4815
ORADATA(insert OID = 5080 ( lrawin             		PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 5504 "2275" _null_ _null_ _null_ _null_ _null_ rawin _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID =  4816 ( rawout            	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "4831" _null_ _null_ _null_ _null_ _null_ rawout _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID =  5078 ( lrawout            	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "5504" _null_ _null_ _null_ _null_ _null_ rawout _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 4817 ( rawrecv              	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 4831 "2281" _null_ _null_ _null_ _null_ _null_    bytearecv _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 5081 ( lrawrecv              	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 5504 "2281" _null_ _null_ _null_ _null_ _null_    bytearecv _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 4818 ( rawsend       			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 17 "4831" _null_ _null_ _null_ _null_ _null_ byteasend _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 5079 ( lrawsend       			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 17 "5504" _null_ _null_ _null_ _null_ _null_ byteasend _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 4819 (  raweq         		PGORCL PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "4831 4831" _null_ _null_ _null_ _null_ _null_ raweq _null_ _null_ _null_ ));
ORADATA(insert OID = 4820 (  rawlt          		PGORCL PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "4831 4831" _null_ _null_ _null_ _null_ _null_ rawlt _null_ _null_ _null_ ));
ORADATA(insert OID = 4821 (  rawle        			PGORCL PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "4831 4831" _null_ _null_ _null_ _null_ _null_ rawle _null_ _null_ _null_ ));
ORADATA(insert OID = 4822 (  rawgt         		PGORCL PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "4831 4831" _null_ _null_ _null_ _null_ _null_ rawgt _null_ _null_ _null_ ));
ORADATA(insert OID = 4823 (  rawge          		PGORCL PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "4831 4831" _null_ _null_ _null_ _null_ _null_ rawge _null_ _null_ _null_ ));
ORADATA(insert OID = 4824 (  rawne        			PGORCL PGUID 12 1 0 0 0 f f t t f i s 2 0 16 "4831 4831" _null_ _null_ _null_ _null_ _null_ rawne _null_ _null_ _null_ ));
ORADATA(insert OID = 4825 (  rawlike        		PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "4831 4831" _null_ _null_ _null_ _null_ _null_ rawlike _null_ _null_ _null_ ));
ORADATA(insert OID = 4826 (  rawnlike     			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "4831 4831" _null_ _null_ _null_ _null_ _null_ rawnlike _null_ _null_ _null_ ));
ORADATA(insert OID = 4827 (  rawcmp         		PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 23 "4831 4831" _null_ _null_ _null_ _null_ _null_ rawcmp _null_ _null_ _null_ ));
ORADESCR("less-equal-greater");
ORADATA(insert OID = 4828 (  rawcat       		  	PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 4831 "4831 4831" _null_ _null_ _null_ _null_ _null_ rawcat _null_ _null_ _null_ ));
ORADESCR("rawcat");
ORADATA(insert OID = 4829 (  rawmodin  			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "1263" _null_ _null_ _null_ _null_ _null_  rawmodin _null_ _null_ _null_ ));
ORADESCR("I/O typmod");
ORADATA(insert OID = 4830 (  rawmodout 			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "23" _null_ _null_ _null_ _null_ _null_    rawmodout _null_ _null_ _null_ ));
ORADESCR("I/O typmod");
ORADATA(insert OID = 4844 ( rawtohex               PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "4831" _null_ _null_ _null_ _null_ _null_ rawtotext _null_ _null_ _null_ ));
ORADESCR("convert raw to hex");
ORADATA(insert OID = 4845 ( rawtohex               PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "25" _null_ _null_ _null_ _null_ _null_ rawtohex _null_ _null_ _null_ ));
ORADESCR("convert text to hex");
ORADATA(insert OID = 4846 ( hextoraw               PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 4831 "25" _null_ _null_ _null_ _null_ _null_ texttoraw _null_ _null_ _null_ ));
ORADESCR("convert hex to raw");
ORADATA(insert OID = 9193 ( rawtohex               PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "1700" _null_ _null_ _null_ _null_ _null_ numrawtotext _null_ _null_ _null_ ));
ORADESCR("convert text to hex");
ORADATA(insert OID = 9195 ( rawtohex               PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "700" _null_ _null_ _null_ _null_ _null_ float4rawtohex _null_ _null_ _null_ ));
ORADESCR("convert text to hex");
ORADATA(insert OID = 9196 ( rawtohex               PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "701" _null_ _null_ _null_ _null_ _null_ float8rawtohex _null_ _null_ _null_ ));
ORADESCR("convert text to hex");
ORADATA(insert OID = 9194 ( hextoraw               PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 4831 "1700" _null_ _null_ _null_ _null_ _null_ numerictoraw _null_ _null_ _null_ ));
ORADESCR("convert hex to raw");
ORADATA(insert OID = 4847 ( rawtotext          	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "4831" _null_ _null_ _null_ _null_ _null_ rawtotext _null_ _null_ _null_ ));
ORADESCR("convert raw to text");

ORADATA(insert OID = 6133 (  to_clob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8764 "1043" _null_ _null_ _null_ _null_ _null_ "select $1::clob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_clob(varchar)");
ORADATA(insert OID = 6134 (  to_clob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8764 "23" _null_ _null_ _null_ _null_ _null_ "select $1::clob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_clob(int4)");
ORADATA(insert OID = 6135 (  to_clob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8764 "20" _null_ _null_ _null_ _null_ _null_ "select $1::clob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_clob(int8)");
ORADATA(insert OID = 6136 (  to_clob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8764 "700" _null_ _null_ _null_ _null_ _null_ "select $1::clob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_clob(float4)");
ORADATA(insert OID = 6137 (  to_clob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8764 "701" _null_ _null_ _null_ _null_ _null_ "select $1::clob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_clob(float8)");
ORADATA(insert OID = 6138 (  to_clob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8764 "1700" _null_ _null_ _null_ _null_ _null_ "select $1::clob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_clob(numeric)");
ORADATA(insert OID = 9008 ( clobtochar PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1042 "8764 23" _null_ _null_ _null_ _null_ _null_ clobtochar _null_ _null_ _null_ ));
ORADESCR("convert clob to char");

ORADATA(insert OID = 6122 (  to_nclob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8291 "1043" _null_ _null_ _null_ _null_ _null_ "select $1::nclob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_nclob(varchar)");
ORADATA(insert OID = 6123 (  to_nclob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8291 "23" _null_ _null_ _null_ _null_ _null_ "select $1::nclob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_nclob(int4)");
ORADATA(insert OID = 6124 (  to_nclob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8291 "20" _null_ _null_ _null_ _null_ _null_ "select $1::nclob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_nclob(int8)");
ORADATA(insert OID = 6125 (  to_nclob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8291 "700" _null_ _null_ _null_ _null_ _null_ "select $1::nclob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_nclob(float4)");
ORADATA(insert OID = 6126 (  to_nclob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8291 "701" _null_ _null_ _null_ _null_ _null_ "select $1::nclob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_nclob(float8)");
ORADATA(insert OID = 6128 (  to_nclob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8291 "1700" _null_ _null_ _null_ _null_ _null_ "select $1::nclob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_nclob(numeric)");
ORADATA(insert OID = 6129 (  to_nclob PGORCL PGUID 14 1 0 0 0 f f f t f i s 1 0 8291 "1186" _null_ _null_ _null_ _null_ _null_ "select $1::nclob" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:to_nclob(interval)");
/* nchr function */
ORADATA(insert OID = 8132 (  nchr PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "1700" _null_ _null_ _null_ _null_ _null_ orcl_nchr _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:nchr(numeric)");

ORADATA(insert OID = 8133 (  empty_blob PGORCL PGUID 12 1 0 0 0 f f f t f i s 0 0 8762 "" _null_ _null_ _null_ _null_ _null_	get_empty_blob _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton get_empty_blob()");

PGDATA(insert OID = 8200 (  orcl_sysdate		PGORCL PGUID 12 1 0 0 0 f f f t f s r 0 0 1114 "" _null_ _null_ _null_ _null_ _null_ orcl_sysdate _null_ _null_ _null_ ));
PGDESCR("sysdate compatible with opentenbase_ora only in PG mode");
// support old version upgrade
PGDATA(insert OID = 8203 (  orcl_timestamp_pl_day_i4 PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1114 "1114 23" _null_ _null_ _null_ _null_ _null_	lightweight_ora_timestamp_pl_day_i4 _null_ _null_ _null_ ));
PGDATA(insert OID = 8204 (  orcl_timestamp_pl_day_i8 PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1114 "1114 20" _null_ _null_ _null_ _null_ _null_	lightweight_ora_timestamp_pl_day_i8 _null_ _null_ _null_ ));
PGDATA(insert OID = 8205 (  orcl_timestamp_pl_day_i2 PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1114 "1114 21" _null_ _null_ _null_ _null_ _null_	lightweight_ora_timestamp_pl_day_i2 _null_ _null_ _null_ ));
PGDATA(insert OID = 8206 (  orcl_timestamp_pl_day_n PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1114 "1114 1700" _null_ _null_ _null_ _null_ _null_	lightweight_ora_timestamp_pl_day_n _null_ _null_ _null_ ));
PGDATA(insert OID = 8207 (  orcl_timestamp_mi_day_i4 PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1114 "1114 23" _null_ _null_ _null_ _null_ _null_	lightweight_ora_timestamp_mi_day_i4 _null_ _null_ _null_ ));
PGDATA(insert OID = 8208 (  orcl_timestamp_mi_day_i8 PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1114 "1114 20" _null_ _null_ _null_ _null_ _null_	lightweight_ora_timestamp_mi_day_i8 _null_ _null_ _null_ ));
PGDATA(insert OID = 8209 (  orcl_timestamp_mi_day_i2 PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1114 "1114 21" _null_ _null_ _null_ _null_ _null_	lightweight_ora_timestamp_mi_day_i2 _null_ _null_ _null_ ));
PGDATA(insert OID = 8210 (  orcl_timestamp_mi_day_n PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 1114 "1114 1700" _null_ _null_ _null_ _null_ _null_	lightweight_ora_timestamp_mi_day_n _null_ _null_ _null_ ));

ORADATA(insert OID = 8213 (  max				PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 8022 "8022" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("maximum value of all rid input values");
ORADATA(insert OID = 8214 (  min				PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 8022 "8022" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("minimum value of all rid input values");

/* urowid */
ORADATA(insert OID = 8410 (  max				PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 8004 "8004" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("maximum value of all urowid input values");
ORADATA(insert OID = 8411 (  min				PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 8004 "8004" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("minimum value of all urowid input values");
ORADATA(insert OID = 8412 (  urowid_eq			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8004 8004" _null_ _null_ _null_ _null_ _null_ texteq _null_ _null_ _null_ ));
ORADATA(insert OID = 8413 (  urowid_ne			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8004 8004" _null_ _null_ _null_ _null_ _null_ textne _null_ _null_ _null_ ));
ORADATA(insert OID = 8414 (  urowid_lt			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8004 8004" _null_ _null_ _null_ _null_ _null_ text_lt _null_ _null_ _null_ ));
ORADATA(insert OID = 8415 (  urowid_le			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8004 8004" _null_ _null_ _null_ _null_ _null_ text_le _null_ _null_ _null_ ));
ORADATA(insert OID = 8416 (  urowid_gt			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8004 8004" _null_ _null_ _null_ _null_ _null_ text_gt _null_ _null_ _null_ ));
ORADATA(insert OID = 8417 (  urowid_ge			PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 16 "8004 8004" _null_ _null_ _null_ _null_ _null_ text_ge _null_ _null_ _null_ ));
ORADATA(insert OID = 8418 (  urowid_in			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 8004 "2275" _null_ _null_ _null_ _null_ _null_ varcharin _null_ _null_ _null_ ));
ORADATA(insert OID = 8419 (  urowid_out			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "8004" _null_ _null_ _null_ _null_ _null_ varcharout _null_ _null_ _null_ ));
ORADATA(insert OID = 8420 (  urowid_recv		PGORCL PGUID 12 1 0 0 0 f f f t f s s 3 0 8004 "2281 26 23" _null_ _null_ _null_ _null_ _null_ varcharrecv _null_ _null_ _null_ ));
ORADATA(insert OID = 8421 (  urowid_send		PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 17 "8004" _null_ _null_ _null_ _null_ _null_ varcharsend _null_ _null_ _null_ ));
ORADATA(insert OID = 8422 (  urowid_larger		PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 8004 "8004 8004" _null_ _null_ _null_ _null_ _null_ text_larger _null_ _null_ _null_ ));
ORADATA(insert OID = 8423 (  urowid_smaller		PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 8004 "8004 8004" _null_ _null_ _null_ _null_ _null_ text_smaller _null_ _null_ _null_ ));
ORADATA(insert OID = 9009 (  urowid				PGORCL PGUID 12 1 0 0 0 f f f t f i s 3 0 8004 "8004 23 16" _null_ _null_ _null_ _null_ _null_ unirowid _null_ _null_ _null_ ));

ORADATA(insert OID = 8215 (  xmltype_in           PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 8024 "2275" _null_ _null_ _null_ _null_ _null_ xmltype_in _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8216 (  xmltype_out          PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "8024" _null_ _null_ _null_ _null_ _null_ xmltype_out _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8217 (  xmltype_recv         PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 8024 "2281" _null_ _null_ _null_ _null_ _null_ xmltype_recv _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8218 (  xmltype_send         PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 17 "8024" _null_ _null_ _null_ _null_ _null_ xmltype_send _null_ _null_ _null_ ));
ORADESCR("I/O");

ORADATA(insert OID = 8219 (  orcl_extract      PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 8024 "8024 25 25" _null_ _null_ _null_ _null_ _null_ extract_internal _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora extract xml expression, with namespaces support");
ORADATA(insert OID = 8220 (  orcl_extract      PGORCL PGUID 14 1 0 0 0 f f f f f i s 2 0 8024 "8024 25" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.orcl_extract($1, $2, null)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora extract xml expression");
ORADATA(insert OID = 8221 (  extractvalue      PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 25 "8024 25 25" _null_ _null_ _null_ _null_ _null_ extractvalue_internal _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora extract value xml expression, with namespaces support");
ORADATA(insert OID = 8222 (  extractvalue      PGORCL PGUID 14 1 0 0 0 f f f f f i s 2 0 25 "8024 25" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.extractvalue($1, $2, null)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora extract value xml expression");
ORADATA(insert OID = 5084 (  updatexml      PGORCL PGUID 12 1 0 2276 0 f f f f f i u 1 0 8024 "2276" "{2276}" "{v}" _null_ _null_ _null_ orcl_updatexml _null_ _null_ _null_ ));
ORADESCR("update xml");

ORADATA(insert OID = 3414 (  ratio_to_report     PGORCL PGUID 12 1 0 0 0 w f f t f i s 1 0 2283 "2283" _null_ _null_ _null_ _null_ _null_ window_ratio_to_report _null_ _null_ _null_ ));
ORADESCR("report the proportion of the current value in the total value");

DATA(insert OID = 8223 (  list_agg_finalfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 1 0 25 "2281" _null_ _null_ _null_ _null_ _null_ list_agg_finalfn _null_ _null_ _null_ ));
DESCR("aggregate final function");
DATA(insert OID = 8224 (  list_agg_p1_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 25" _null_ _null_ _null_ _null_ _null_ list_agg_p1_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8225 (  list_agg_p2i_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 2281 "2281 25 23" _null_ _null_ _null_ _null_ _null_ list_agg_p2i_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8226 (  list_agg_p2u_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 2281 "2281 25 25" _null_ _null_ _null_ _null_ _null_ list_agg_p2u_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8227 (  list_agg_p3_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 4 0 2281 "2281 25 25 23" _null_ _null_ _null_ _null_ _null_ list_agg_p3_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8228 (  list_agg_p5_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 6 0 2281 "2281 25 25 23 25 23" _null_ _null_ _null_ _null_ _null_ list_agg_p5_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8229 (  list_agg_i_p1_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 23" _null_ _null_ _null_ _null_ _null_ list_agg_i_p1_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8230 (  list_agg_i_p2i_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 2281 "2281 23 23" _null_ _null_ _null_ _null_ _null_ list_agg_i_p2i_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8231 (  list_agg_i_p2u_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 2281 "2281 23 25" _null_ _null_ _null_ _null_ _null_ list_agg_i_p2u_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8232 (  list_agg_i_p3_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 4 0 2281 "2281 23 25 23" _null_ _null_ _null_ _null_ _null_ list_agg_i_p3_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8233 (  list_agg_i_p5_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 6 0 2281 "2281 23 25 23 25 23" _null_ _null_ _null_ _null_ _null_ list_agg_i_p5_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8234 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 25 "25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with one param: text ");
DATA(insert OID = 8235 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 2 0 25 "25 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with two params: text and int4 ");
DATA(insert OID = 8236 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 2 0 25 "25 25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with two params: text and text ");
DATA(insert OID = 8237 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 3 0 25 "25 25 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with three params: text, text and int4 ");
DATA(insert OID = 8238 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 5 0 25 "25 25 23 25 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with five params: text, text, int4, text and int4 ");
DATA(insert OID = 8239 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 25 "23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with one param: int4 ");
DATA(insert OID = 8240 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 2 0 25 "23 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with two params: int4 and int4 ");
DATA(insert OID = 8241 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 2 0 25 "23 25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with two params: int4 and text ");
DATA(insert OID = 8242 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 3 0 25 "23 25 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with three params: int4, text and int4 ");
DATA(insert OID = 8243 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 5 0 25 "23 25 23 25 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with five params: int4, text, int4, text and int4 ");

DATA(insert OID = 8244 (  list_agg_numeric_p1_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 1700" _null_ _null_ _null_ _null_ _null_ list_agg_numeric_p1_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8245 (  list_agg_numeric_p2i_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 2281 "2281 1700 23" _null_ _null_ _null_ _null_ _null_ list_agg_numeric_p2i_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8246 (  list_agg_numeric_p2u_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 2281 "2281 1700 25" _null_ _null_ _null_ _null_ _null_ list_agg_numeric_p2u_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8247 (  list_agg_numeric_p3_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 4 0 2281 "2281 1700 25 23" _null_ _null_ _null_ _null_ _null_ list_agg_numeric_p3_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8248 (  list_agg_numeric_p5_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 6 0 2281 "2281 1700 25 23 25 23" _null_ _null_ _null_ _null_ _null_ list_agg_numeric_p5_transfn _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 8249 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 25 "1700" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with one param: numeric ");
DATA(insert OID = 8250 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 2 0 25 "1700 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with two params: numeric and int4 ");
DATA(insert OID = 8251 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 2 0 25 "1700 25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with two params: numeric and text ");
DATA(insert OID = 8252 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 3 0 25 "1700 25 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with three params: numeric, text and int4 ");
DATA(insert OID = 8253 (  listagg				PGORCL PGUID 12 1 0 0 0 a f f f f i s 5 0 25 "1700 25 23 25 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("aggregate function with five params: numeric, text, int4, text and int4 ");

DATA(insert OID = 8254 (  length                PGNSP PGUID 14 1 0 0 0 f f f t f i s 1 0 23 "23" _null_ _null_ _null_ _null_ _null_ "SELECT pg_catalog.length($1::text);" _null_ _null_ _null_ ));
DESCR("length number's string");
ORADATA(insert OID = 8255 (  wm_concat_numeric_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 1700" _null_ _null_ _null_ _null_ _null_ wm_concat_numeric_transfn _null_ _null_ _null_ ));
ORADESCR("aggregate transition function");
ORADATA(insert OID = 8256 (  wm_concat_int_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 23" _null_ _null_ _null_ _null_ _null_ wm_concat_int_transfn _null_ _null_ _null_ ));
ORADESCR("aggregate transition function");
ORADATA(insert OID = 8257 (  wm_concat_text_transfn		PGORCL PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 25" _null_ _null_ _null_ _null_ _null_ wm_concat_text_transfn _null_ _null_ _null_ ));
ORADESCR("aggregate transition function");
ORADATA(insert OID = 8258 (  array_subscript_is_valid      PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 16 "2277 23 23" _null_ _null_ _null_ _null_ _null_ array_subscript_is_valid _null_ _null_ _null_ ));
ORADESCR("check the subscript is valid for array");

ORADATA(insert OID = 8259 (  numericcat          PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 25 "1700 1700" _null_ _null_ _null_ _null_ _null_ numeric_cat _null_ _null_ _null_ ));
ORADESCR("cat with numeric params as a string");
ORADATA(insert OID = 8260 (  text_nu_sum      PGNSP PGUID 12 1 0 0 0 f f f f f i s 1 0 1700 "2281" _null_ _null_ _null_ _null_ _null_ text_nu_sum _null_ _null_ _null_ ));
ORADESCR("aggregate final function");
ORADATA(insert OID = 8262 (  text_nu_avg_combine    PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 2281" _null_ _null_ _null_ _null_ _null_ text_nu_avg_combine _null_ _null_ _null_ ));
ORADESCR("aggregate combine function");
ORADATA(insert OID = 8263 (  text_nu_avg_serialize    PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 17 "2281" _null_ _null_ _null_ _null_ _null_ text_nu_avg_serialize _null_ _null_ _null_ ));
ORADESCR("aggregate serial function");
ORADATA(insert OID = 8264 (  text_nu_avg_deserialize    PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 2281 "17 2281" _null_ _null_ _null_ _null_ _null_ text_nu_avg_deserialize _null_ _null_ _null_ ));
ORADESCR("aggregate deserial function");
ORADATA(insert OID = 8265 (  text_nu_accum_inv    PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 25" _null_ _null_ _null_ _null_ _null_ text_nu_accum_inv _null_ _null_ _null_ ));
ORADESCR("aggregate transition function");
ORADATA(insert OID = 8266 (  varchar2_nu_avg_accum    PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 8026" _null_ _null_ _null_ _null_ _null_ varchar2_nu_avg_accum _null_ _null_ _null_ ));
ORADESCR("aggregate transition function");
ORADATA(insert OID = 8267 (  varchar2_nu_accum_inv    PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 8026" _null_ _null_ _null_ _null_ _null_ varchar2_nu_accum_inv _null_ _null_ _null_ ));
ORADESCR("aggregate transition function");
ORADATA(insert OID = 8268 (  sum               PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 1700 "25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("sum as numeric across all text input values");
ORADATA(insert OID = 8269 (  sum               PGORCL PGUID 12 1 0 0 0 a f f f f i s 1 0 1700 "8026" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
ORADESCR("sum as numeric across all varchar2 input values");
ORADATA(insert OID = 8270 ( mod                    PGORCL PGUID 14 1 0 0 0 f f f t f i s 2 0 23 "1043 23" _null_ _null_ _null_ _null_ _null_    "select pg_catalog.mod($1::numeric, $2)::integer" _null_ _null_ _null_ ));
ORADESCR("modulus");
ORADATA(insert OID = 8271 ( mod                    PGORCL PGUID 14 1 0 0 0 f f f t f i s 2 0 1700 "25 1700" _null_ _null_ _null_ _null_ _null_    "select pg_catalog.mod($1::numeric, $2)" _null_ _null_ _null_ ));
ORADESCR("modulus");

ORADATA(insert OID = 8272 (  get_major_version			PGORCL PGUID 12 1 0 0 0 f f f t f i s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ orcl_get_major_version _null_ _null_ _null_ ));
ORADESCR("Get current version etc, PostgreSQL 9.6, PostgreSQL 10");
ORADATA(insert OID = 8273 (  get_major_version_num		PGORCL PGUID 12 1 0 0 0 f f f t f i s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ orcl_get_major_version_num _null_ _null_ _null_ ));
ORADESCR("Get major version number 9.5, 9.6, 10, 11");
ORADATA(insert OID = 8274 (  get_full_version_num		PGORCL PGUID 12 1 0 0 0 f f f t f i s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ orcl_get_full_version_num _null_ _null_ _null_ ));
ORADESCR("Get version number string - 9.5.1, 10.2");
ORADATA(insert OID = 8275 (  get_platform				PGORCL PGUID 12 1 0 0 0 f f f t f i s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ orcl_get_platform _null_ _null_ _null_ ));
ORADESCR("Get compile evn, 32bit, 64bit");
ORADATA(insert OID = 8276 (  get_status				PGORCL PGUID 12 1 0 0 0 f f f t f i s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ orcl_get_status _null_ _null_ _null_ ));
ORADESCR("Get compile opt, Production | Debug");

ORADATA(insert OID = 8277 (  set_nls_sort				PGORCL PGUID 12 1 0 0 0 f f f t f s u 1 0 2278 "25" _null_ _null_ _null_ _null_ _null_ orcl_set_nls_sort _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible function, set_nls_sort");
ORADATA(insert OID = 8278 (  nlssort					PGORCL PGUID 12 1 0 0 0 f f f f f s u 2 0 17 "25 25" _null_ _null_ _null_ _null_ _null_ orcl_nlssort _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible function, nls_sort");
ORADATA(insert OID = 8279 (  nlssort					PGORCL PGUID 14 100 0 0 0 f f f t f s u 1 0 17 "25" _null_ _null_ _null_ _null_ _null_ "SELECT opentenbase_ora.nlssort($1, null)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible function, nls_sort");

PGDATA(insert OID = 8293 ( add_months					PGORCL PGUID 14 100 0 0 0 f f f t f i s 2 0 1114 "1114 23" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.timestamp_pl_interval($1, pg_catalog.interval_mul(interval ''1 month'', $2))" _null_ _null_ _null_ ));
PGDESCR("opentenbase_ora compatible funciton add_months(timestamp, int)");
PGDATA(insert OID = 8294 ( add_months					PGORCL PGUID 14 100 0 0 0 f f f t f i s 2 0 1184 "1184 23" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.timestamptz_pl_interval($1, pg_catalog.interval_mul(interval ''1 month'', $2))" _null_ _null_ _null_ ));
PGDESCR("opentenbase_ora compatible funciton add_months(timestamptz, int)");

PGDATA(insert OID = 8320 ( round						PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 1700 "700 23" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.round($1::numeric, $2)" _null_ _null_ _null_ ));
PGDESCR("opentenbase_ora compatible funciton round(float4, int4)");
PGDATA(insert OID = 8321 ( round						PGORCL PGUID 14 100 0 0 0 f f f t f s s 1 0 1700 "700" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.round($1::numeric, 0)" _null_ _null_ _null_ ));
PGDESCR("opentenbase_ora compatible funciton round(float4)");
PGDATA(insert OID = 8322 ( round						PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 1700 "701 23" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.round($1::numeric, $2)" _null_ _null_ _null_ ));
PGDESCR("opentenbase_ora compatible funciton round(float8, int4)");

PGDATA(insert OID = 8325 ( trunc						PGORCL PGUID 14 100 0 0 0 f f f t f i s 1 0 1082 "1082" _null_ _null_ _null_ _null_  _null_ "SELECT $1" _null_ _null_ _null_ ));
PGDESCR("opentenbase_ora compatible funciton trunc(date)");
PGDATA(insert OID = 8332 ( trunc						PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 1700 "700 23" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.trunc($1::numeric, $2)" _null_ _null_ _null_ ));
PGDESCR("opentenbase_ora compatible funciton trunc(float4, int4)");
PGDATA(insert OID = 8333 ( trunc						PGORCL PGUID 14 100 0 0 0 f f f t f s s 1 0 1700 "700" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.trunc($1::numeric, 0)" _null_ _null_ _null_ ));
PGDESCR("opentenbase_ora compatible funciton trunc(float4)");
PGDATA(insert OID = 8334 ( trunc						PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 1700 "701 23" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.trunc($1::numeric, $2)" _null_ _null_ _null_ ));
PGDESCR("opentenbase_ora compatible funciton trunc(float8, int4)");

DATA(insert OID = 8337 ( instr						PGORCL PGUID 12 1 0 0 0 f f f t f i s 4 0 23 "25 25 1700 1700" _null_ _null_ _null_ _null_  _null_ orcl_instr4 _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton instr(string, substring, position, occurrence)");
DATA(insert OID = 8338 ( instr						PGORCL PGUID 12 1 0 0 0 f f f t f i s 3 0 23 "25 25 1700" _null_ _null_ _null_ _null_  _null_ orcl_instr3 _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton instr(string, substring, position)");
DATA(insert OID = 8339 ( instr						PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 23 "25 25" _null_ _null_ _null_ _null_  _null_ orcl_instr2 _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton instr(string, substring)");

ORADATA(insert OID = 3998 ( instrb						PGORCL PGUID 12 1 0 0 0 f f f t f i s 4 0 23 "25 25 1700 1700" _null_ _null_ _null_ _null_  _null_ orcl_instrb4 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton instrb(string, substring, position, occurrence)");
ORADATA(insert OID = 8602 ( instrb						PGORCL PGUID 12 1 0 0 0 f f f t f i s 3 0 23 "25 25 1700" _null_ _null_ _null_ _null_  _null_ orcl_instrb3 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton instrb(string, substring, position)");
ORADATA(insert OID = 8603 ( instrb						PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 23 "25 25" _null_ _null_ _null_ _null_  _null_ orcl_instrb2 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton instrb(string, substring)");

DATA(insert OID = 8340 ( to_char					PGNSP PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "25" _null_ _null_ _null_ _null_  _null_ orcl_text_tochar _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_char(text)");
DATA(insert OID = 8341 ( to_char					PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "23" _null_ _null_ _null_ _null_ _null_ orcl_int4_tochar _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_char(int4)");
DATA(insert OID = 8342 ( to_char					PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "20" _null_ _null_ _null_ _null_ _null_ orcl_int8_tochar _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_char(int8)");
DATA(insert OID = 8343 ( to_char					PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "700" _null_ _null_ _null_ _null_ _null_ orcl_float4_tochar _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_char(real)");
DATA(insert OID = 8344 ( to_char					PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "701" _null_ _null_ _null_ _null_ _null_ orcl_float8_tochar _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_char(double)");
DATA(insert OID = 8345 ( to_char					PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "1700" _null_ _null_ _null_ _null_  _null_ orcl_numeric_tochar _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_char(numeric)");

DATA(insert OID = 8346 ( to_char					PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "1186" _null_ _null_ _null_ _null_  _null_ orcl_interval_tochar _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_char(interval)");
#define INTERVAL_TO_TEXT_OID 8346

/* 8347 is used by to_char function in v3, so change to 9229 */
ORADATA(insert OID = 9229 ( to_char					PGORCL PGUID 12 1 0 0 0 f f f t f s s 2 0 25 "1186 23" _null_ _null_ _null_ _null_  _null_ orcl_interval_typmode_tochar _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton to_char(interval)");
#define INTERVAL_TYPMOD_TO_TEXT_OID 9229

DATA(insert OID = 8347 ( to_char					PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "1114" _null_ _null_ _null_ _null_  _null_ lightweight_ora_timestamp_tochar _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_char(timestamp)");
DATA(insert OID = 8348 ( to_char					PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "1184" _null_ _null_ _null_ _null_  _null_ lightweight_ora_timestamptz_tochar _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_char(timestamptz)");

DATA(insert OID = 8350 ( to_number      			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 1700 "25" _null_ _null_ _null_ _null_ _null_ orcl_text_tonumber _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_number(text)");
DATA(insert OID = 8351 ( to_number    				PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 1700 "700" _null_ _null_ _null_ _null_ _null_ orcl_float4_tonumber _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_number(real)");
DATA(insert OID = 8352 ( to_number    				PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 1700 "701" _null_ _null_ _null_ _null_ _null_ orcl_float8_tonumber _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_number(double)");
ORADATA(insert OID = 8353 ( to_multi_byte     			PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 25 "25" _null_ _null_ _null_ _null_	_null_ orcl_to_multi_byte _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton to_multi_byte(text)");
DATA(insert OID = 8354 ( to_single_byte    			PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "25" _null_ _null_ _null_ _null_	_null_ orcl_to_single_byte _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton to_single_byte(text)");

ORADATA(insert OID = 8355 ( sinh						PGORCL PGUID 14 100 0 0 0 f f f t f i s 1 0 1700 "1700" _null_ _null_ _null_ _null_ _null_ "SELECT ((pg_catalog.exp($1) - pg_catalog.exp(-$1)) * 0.5)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton sinh(numeric)");
ORADATA(insert OID = 8356 ( sinh						PGORCL PGUID 14 100 0 0 0 f f f t f i s 1 0 701 "701" _null_ _null_ _null_ _null_ _null_ "SELECT ((pg_catalog.exp($1) - pg_catalog.exp(-$1)) * 0.5)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton sinh(float8)");
ORADATA(insert OID = 8357 ( cosh						PGORCL PGUID 14 100 0 0 0 f f f t f i s 1 0 1700 "1700" _null_ _null_ _null_ _null_ _null_ "SELECT ((pg_catalog.exp($1) + pg_catalog.exp(-$1)) * 0.5)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton cosh(numeric)");
ORADATA(insert OID = 8358 ( cosh						PGORCL PGUID 14 100 0 0 0 f f f t f i s 1 0 701 "701" _null_ _null_ _null_ _null_ _null_ "SELECT ((pg_catalog.exp($1) + pg_catalog.exp(-$1)) * 0.5)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton cosh(float8)");
ORADATA(insert OID = 8359 ( tanh						PGORCL PGUID 14 100 0 0 0 f f f t f i s 1 0 1700 "1700" _null_ _null_ _null_ _null_ _null_ "SELECT ((pg_catalog.exp($1) - pg_catalog.exp(-$1)) / (pg_catalog.exp($1) + pg_catalog.exp(-$1)))" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton tanh(numeric)");
ORADATA(insert OID = 8360 ( tanh						PGORCL PGUID 14 100 0 0 0 f f f t f i s 1 0 701 "701" _null_ _null_ _null_ _null_ _null_ "SELECT ((pg_catalog.exp($1) - pg_catalog.exp(-$1)) / (pg_catalog.exp($1) + pg_catalog.exp(-$1)))" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton tanh(float8)");

ORADATA(insert OID = 8361 ( nanvl						PGORCL PGUID 14 100 0 0 0 f f f t f i s 2 0 700 "700 700" _null_ _null_ _null_ _null_ _null_ "SELECT CASE WHEN $1 = ''NaN'' THEN $2 ELSE $1 END" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton nanvl(float4, float4)");
ORADATA(insert OID = 8362 ( nanvl						PGORCL PGUID 14 100 0 0 0 f f f t f i s 2 0 701 "701 701" _null_ _null_ _null_ _null_ _null_ "SELECT CASE WHEN $1 = ''NaN'' THEN $2 ELSE $1 END" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton nanvl(float8, float8)");
ORADATA(insert OID = 8363 ( nanvl						PGORCL PGUID 14 100 0 0 0 f f f t f i s 2 0 1700 "1700 1700" _null_ _null_ _null_ _null_ _null_ "SELECT CASE WHEN $1 = ''NaN'' THEN $2 ELSE $1 END" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton nanvl(numeric, numeric)");
ORADATA(insert OID = 8364 ( nanvl						PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 700 "700 1043" _null_ _null_ _null_ _null_ _null_ "SELECT CASE WHEN $1 = ''NaN'' THEN $2::float4 ELSE $1 END" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton nanvl(float4, varchar)");
ORADATA(insert OID = 8365 ( nanvl						PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 701 "701 1043" _null_ _null_ _null_ _null_ _null_ "SELECT CASE WHEN $1 = ''NaN'' THEN $2::float8 ELSE $1 END" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton nanvl(float8, varchar)");
ORADATA(insert OID = 8366 ( nanvl						PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 1700 "1700 1043" _null_ _null_ _null_ _null_ _null_ "SELECT CASE WHEN $1 = ''NaN'' THEN $2::numeric ELSE $1 END" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton nanvl(numeric, varchar)");

DATA(insert OID = 8367 ( nvl							PGORCL PGUID 12 1 0 0 0 f f f f f i s 2 0 2283 "2283 2283" _null_ _null_ _null_ _null_ _null_ orcl_nvl _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton nvl(anyelement, anyelement)");
DATA(insert OID = 8368 ( nvl2							PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 2283 "2276 2283 2283" _null_ _null_ _null_ _null_ _null_ orcl_nvl2 _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton nvl2(anyelement, anyelement, anyelement)");
DATA(insert OID = 8369 ( lnnvl							PGORCL PGUID 12 1 0 0 0 f f f f f i s 1 0 16 "16" _null_ _null_ _null_ _null_	_null_ orcl_lnnvl _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton lnnvl(bool)");

ORADATA(insert OID = 8370 ( dump      	           		PGORCL PGUID 14 100 0 0 0 f f f f f i u 1 0 1043 "2283" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.dump($1, null, null, null)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton dump(anyelement)");
ORADATA(insert OID = 8371 ( dump      	           		PGORCL PGUID 14 100 0 0 0 f f f f f i u 2 0 1043 "2283 23" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.dump($1, $2, null, null)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton dump(anyelement, int)");
ORADATA(insert OID = 8372 ( dump      	           		PGORCL PGUID 14 100 0 0 0 f f f f f i u 3 0 1043 "2283 23 23" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.dump($1, $2, $3, null)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton dump(anyelement, int, int)");
ORADATA(insert OID = 8373 ( dump      	           		PGORCL PGUID 12 1 0 0 0 f f f f f i u 4 0 1043 "2283 23 23 23" _null_ _null_ _null_ _null_ _null_ orcl_dump _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton dump(anyelement, int, int, int)");

ORADATA(insert OID = 8374 ( substr						PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 25 "1700 1700" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.substr($1::text, pg_catalog.trunc($2)::int)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton substr(numeric, numeric)");
ORADATA(insert OID = 8375 ( substr						PGORCL PGUID 14 100 0 0 0 f f f t f s s 3 0 25 "1700 1700 1700" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.substr($1::text, pg_catalog.trunc($2)::int, pg_catalog.trunc($3)::int)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton substr(numeric, numeric, numeric)");
ORADATA(insert OID = 8376 ( substr						PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 25 "1043 1700" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.substr($1, pg_catalog.trunc($2)::int)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton substr(varchar, numeric)");
ORADATA(insert OID = 8377 ( substr						PGORCL PGUID 14 100 0 0 0 f f f t f s s 3 0 25 "1043 1700 1700" _null_ _null_ _null_ _null_  _null_ "SELECT pg_catalog.substr($1, pg_catalog.trunc($2)::int, pg_catalog.trunc($3)::int)" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton substr(varchar, numeric, numeric)");
ORADATA(insert OID = 8378 ( substrb		   			PGORCL PGUID 12 100 0 0 0 f f f t f s s 3 0 25 "25 1700 1700" _null_ _null_ _null_ _null_ _null_ orcl_substrb_3 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton substrb(bytea, numeric, numeric)");
ORADATA(insert OID = 8379 ( substrb		   			PGORCL PGUID 12 100 0 0 0 f f f t f s s 2 0 25 "25 1700" _null_ _null_ _null_ _null_ _null_ orcl_substrb_2 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton substrb(bytea, numeric)");
DATA(insert OID = 8380 ( lengthb		   			PGORCL PGUID 14 100 0 0 0 f f f t f s s 1 0 23 "25" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.octet_length($1::bytea)" _null_ _null_ _null_ ));
DESCR("returns byte length of the input string");
ORADATA(insert OID = 8381 ( strposb		   			PGORCL PGUID 14 100 0 0 0 f f f t f s s 2 0 23 "25 25" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.position($1::bytea, $2::bytea)" _null_ _null_ _null_ ));
ORADESCR("returns the byte position of a specified string in the input string");

/* opentenbase_ora Function regexp_count */
DATA(insert OID = 8382 (  regexp_count PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 23 "25 25" _null_ _null_ _null_ _null_ _null_	orcl_regexp_count_2 _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton regexp_count(text,text)");
DATA(insert OID = 8383 (  regexp_count PGORCL PGUID 12 1 0 0 0 f f f t f i s 3 0 23 "25 25 23" _null_ _null_ _null_ _null_ _null_ orcl_regexp_count_3 _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton regexp_count(text,text,int)");
DATA(insert OID = 8384 (  regexp_count PGORCL PGUID 12 1 0 0 0 f f f t f i s 4 0 23 "25 25 23 25" _null_ _null_ _null_ _null_ _null_ orcl_regexp_count _null_ _null_ _null_ ));
DESCR("opentenbase_ora compatible funciton regexp_count(text,text,int,text)");

ORADATA(insert OID = 6031 (  regexp_count PGORCL PGUID 14 1 0 0 0 f f f t f i s 2 0 23 "1700 1700" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.regexp_count($1::text, $2::text);" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_count(numeric,numeric)");
ORADATA(insert OID = 6032 (  regexp_count PGORCL PGUID 14 1 0 0 0 f f f t f i s 3 0 23 "1700 1700 23" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.regexp_count($1::text, $2::text, $3);" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_count(numeric,numeric,integer)");
ORADATA(insert OID = 6033 (  regexp_count PGORCL PGUID 14 1 0 0 0 f f f t f i s 4 0 23 "1700 1700 23 25" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.regexp_count($1::text, $2::text, $3, $4);" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_count(numeric,numeric,integer,text)");

ORADATA(insert OID = 6034 (  regexp_count PGORCL PGUID 14 1 0 0 0 f f f t f i s 2 0 23 "25 1700" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.regexp_count($1, $2::text);" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_count(text,numeric)");
ORADATA(insert OID = 6035 (  regexp_count PGORCL PGUID 14 1 0 0 0 f f f t f i s 3 0 23 "25 1700 23" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.regexp_count($1, $2::text, $3);" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_count(text,numeric,integer)");
ORADATA(insert OID = 6036 (  regexp_count PGORCL PGUID 14 1 0 0 0 f f f t f i s 4 0 23 "25 1700 23 25" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.regexp_count($1, $2::text, $3, $4);" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_count(text,numeric,integer,text)");

ORADATA(insert OID = 6037 (  regexp_count PGORCL PGUID 14 1 0 0 0 f f f t f i s 2 0 23 "1700 25" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.regexp_count($1::text, $2::text);" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_count(numeric,text)");
ORADATA(insert OID = 6038 (  regexp_count PGORCL PGUID 14 1 0 0 0 f f f t f i s 3 0 23 "1700 25 23" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.regexp_count($1::text, $2::text, $3);" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_count(numeric,text,integer)");
ORADATA(insert OID = 6039 (  regexp_count PGORCL PGUID 14 1 0 0 0 f f f t f i s 4 0 23 "1700 25 23 25" _null_ _null_ _null_ _null_ _null_ "select opentenbase_ora.regexp_count($1::text, $2::text, $3, $4);" _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_count(numeric,text,integer,text)");

/* opentenbase_ora Function regexp_substr */
ORADATA(insert OID = 8385 (  regexp_substr PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 25 "25 25" _null_ _null_ _null_ _null_ _null_	orcl_regexp_substr_2 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_substr(text,text)");
ORADATA(insert OID = 8386 (  regexp_substr	PGORCL PGUID 12 1 0 0 0 f f f t f i s 3 0 25 "25 25 20" _null_ _null_ _null_ _null_ _null_	orcl_regexp_substr_3 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_substr(text,text,bigint)");
ORADATA(insert OID = 8387 (  regexp_substr	PGORCL PGUID 12 1 0 0 0 f f f t f i s 4 0 25 "25 25 20 20" _null_ _null_ _null_ _null_ _null_ orcl_regexp_substr_4 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_substr(text,text,bigint,bigint)");
ORADATA(insert OID = 8388 (  regexp_substr	PGORCL PGUID 12 1 0 0 0 f f f t f i s 5 0 25 "25 25 20 20 25" _null_ _null_ _null_ _null_ _null_ orcl_regexp_substr_5 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_substr(text,text,bigint,bigint,text)");
ORADATA(insert OID = 8389 (  regexp_substr PGORCL PGUID 12 1 0 0 0 f f f t f i s 6 0 25 "25 25 20 20 25 20" _null_ _null_ _null_ _null_ _null_	orcl_regexp_substr _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_substr(text,text,bigint,bigint,text,bigint)");

/* lightweight_ora Function regexp_substr */
PGDATA(insert OID = 9385 (  regexp_substr PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 25 "25 25" _null_ _null_ _null_ _null_ _null_	orcl_regexp_substr_2 _null_ _null_ _null_ ));
PGDESCR("regexp_substr(text,text)");
PGDATA(insert OID = 9386 (  regexp_substr	PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 25 "25 25 23" _null_ _null_ _null_ _null_ _null_	orcl_regexp_substr_3 _null_ _null_ _null_ ));
PGDESCR("regexp_substr(text,text,int)");
PGDATA(insert OID = 9387 (  regexp_substr	PGNSP PGUID 12 1 0 0 0 f f f t f i s 4 0 25 "25 25 23 23" _null_ _null_ _null_ _null_ _null_ orcl_regexp_substr_4 _null_ _null_ _null_ ));
PGDESCR("regexp_substr(text,text,int,int)");
PGDATA(insert OID = 9388 (  regexp_substr	PGNSP PGUID 12 1 0 0 0 f f f t f i s 5 0 25 "25 25 23 23 25" _null_ _null_ _null_ _null_ _null_ orcl_regexp_substr_5 _null_ _null_ _null_ ));
PGDESCR("regexp_substr(text,text,int,int,text)");
PGDATA(insert OID = 9389 (  regexp_substr PGNSP PGUID 12 1 0 0 0 f f f t f i s 6 0 25 "25 25 23 23 25 23" _null_ _null_ _null_ _null_ _null_	orcl_regexp_substr _null_ _null_ _null_ ));
PGDESCR("regexp_substr(text,text,int,int,text,int)");

/* opentenbase_ora Function regexp_replace */
ORADATA(insert OID = 8390 (  regexp_replace PGORCL PGUID 12 1 0 0 0 f f f f f i s 2 0 25 "25 25" _null_ _null_ _null_ _null_ _null_ orcl_regexp_replace_2 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_replace(text,text)");
ORADATA(insert OID = 8391 (  regexp_replace PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 25 "25 25 25" _null_ _null_ _null_ _null_ _null_ orcl_regexp_replace_3 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_replace(text,text,text)");
ORADATA(insert OID = 8392 (  regexp_replace PGORCL PGUID 12 1 0 0 0 f f f f f i s 4 0 25 "25 25 25 23" _null_ _null_ _null_ _null_ _null_ orcl_regexp_replace_4 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_replace(text,text,text,int)");
ORADATA(insert OID = 8393 (  regexp_replace PGORCL PGUID 12 1 0 0 0 f f f f f i s 5 0 25 "25 25 25 23 23" _null_ _null_ _null_ _null_ _null_ orcl_regexp_replace_5 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_replace(text,text,text,int,int)");
ORADATA(insert OID = 8394 (  regexp_replace PGORCL PGUID 12 1 0 0 0 f f f f f i s 6 0 25 "25 25 25 23 23 25" _null_ _null_ _null_ _null_ _null_ orcl_regexp_replace _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton regexp_replace(text,text,text,int,int,text)");

/* opentenbase_ora Function nls_lower */
ORADATA(insert OID = 8395 (  nls_lower	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "25" _null_ _null_ _null_ _null_ _null_ lower _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton: lowercase");
ORADATA(insert OID = 8396 (  nls_lower PGORCL PGUID 12 1 0 0 0 f f f t f s s 2 0 25 "25 25" _null_ _null_ _null_ _null_ _null_ orcl_lower _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton: lowercase");
/* opentenbase_ora Function nls_upper */
ORADATA(insert OID = 8397 (  nls_upper	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "25" _null_ _null_ _null_ _null_ _null_ upper _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton: uppercase");
ORADATA(insert OID = 8398 (  nls_upper PGORCL PGUID 12 1 0 0 0 f f f t f s s 2 0 25 "25 25" _null_ _null_ _null_ _null_ _null_ orcl_upper _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton: uppercase");
/* opentenbase_ora nls_ functions */
ORADATA(insert OID = 8399 (  nls_initcap PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "25" _null_ _null_ _null_ _null_ _null_ initcap _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:capitalize each word");
ORADATA(insert OID = 9200 (  nls_initcap PGORCL PGUID 12 1 0 0 0 f f f t f s s 2 0 25 "25 25" _null_ _null_ _null_ _null_ _null_ orcl_initcap _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora compatible funciton:capitalize each word");

/* opentenbase_ora Function ascii */
ORADATA(insert OID = 9201 (  ascii		PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "1700" _null_ _null_ _null_ _null_ _null_ ascii_numeric _null_ _null_ _null_ ));
ORADESCR("convert the integer highest digit data to int4 by ascii code");
ORADATA(insert OID = 9202 (  ascii		PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "8022" _null_ _null_ _null_ _null_ _null_ ascii_rowid _null_ _null_ _null_ ));
ORADESCR("convert rawid to int4 by ascii code");
/* opentenbase_ora Function replace */
ORADATA(insert OID =  9203 ( replace	PGORCL PGUID 12 1 0 0 0 f f f f f i s 2 0 25 "25 25" _null_ _null_ _null_ _null_ _null_    replace_text _null_ _null_ _null_ ));
ORADESCR("replace all occurrences in string of old_substr with ''");
ORADATA(insert OID =  9204 ( replace	PGORCL PGUID 12 1 0 0 0 f f f f f i s 3 0 25 "25 25 23" _null_ _null_ _null_ _null_ _null_ replace_text_with_integer _null_ _null_ _null_ ));
ORADESCR("replace all occurrences in string of old_substr with integer new_substr");

/* opentenbase_ora function ora_hash */
ORADATA(insert OID = 9206 (  ora_hash	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 20 "2283" _null_ _null_ _null_ _null_ _null_ orcl_ora_hash1 _null_ _null_ _null_ ));
ORADESCR("ora_hash");
ORADATA(insert OID = 9207 (  ora_hash	PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 20 "2283 20" _null_ _null_ _null_ _null_ _null_ orcl_ora_hash2 _null_ _null_ _null_ ));
ORADESCR("ora_hash");
ORADATA(insert OID = 9208 (  ora_hash	PGORCL PGUID 12 1 0 0 0 f f f t f i s 3 0 20 "2283 20 20" _null_ _null_ _null_ _null_ _null_ orcl_ora_hash3 _null_ _null_ _null_ ));
ORADESCR("ora_hash");

/* opentenbase_ora function vsize */
ORADATA(insert OID = 9225 (  vsize		PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 23 "2276" _null_ _null_ _null_ _null_ _null_ vsize _null_ _null_ _null_ ));
ORADESCR("bytes required to store the value, perhaps with compression, ignore header size and \'\\0\'");

/* opentenbase_ora lob functions */
DATA(insert OID = 8766 (  blob_in	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 8762 "2275" _null_ _null_ _null_ _null_ _null_ blob_in _null_ _null_ _null_ ));
DESCR("I/O");
#define BLOB_IN_OID 8766
DATA(insert OID = 8767 (  blob_out	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "8762" _null_ _null_ _null_ _null_ _null_ blob_out _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 8768 (  blob_recv	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 8762 "2281" _null_ _null_ _null_ _null_ _null_ blob_recv _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 8769 (  blob_send	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 17 "8762" _null_ _null_ _null_ _null_ _null_ blob_send _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 8770 (  clob_in	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 8764 "2275" _null_ _null_ _null_ _null_ _null_ clob_in _null_ _null_ _null_ ));
#define CLOB_IN_OID 8770
DESCR("I/O");
DATA(insert OID = 8771 (  clob_out	PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "8764" _null_ _null_ _null_ _null_ _null_ clob_out _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 8772 (  clob_recv	PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 8764 "2281" _null_ _null_ _null_ _null_ _null_ clob_recv _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 8773 (  clob_send	PGORCL PGUID 12 1 0 0 0 f f f t f s s 1 0 17 "8764" _null_ _null_ _null_ _null_ _null_ clob_send _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 8782 (  compare PGORCL PGUID 12 1 0 0 0 f f f t f i s 5 0 23 "8762 8762 23 23 23" _null_ _null_ _null_ _null_ _null_ compare_blob _null_ _null_ _null_ ));
DESCR("blob compare");
DATA(insert OID = 8783 (  compare PGORCL PGUID 12 1 0 0 0 f f f t f i s 5 0 23 "8764 8764 23 23 23" _null_ _null_ _null_ _null_ _null_ compare_clob _null_ _null_ _null_ ));
DESCR("clob compare");
DATA(insert OID = 8784 (  empty_clob PGORCL PGUID 12 1 0 0 0 f f f t f i s 0 0 8764 "" _null_ _null_ _null_ _null_ _null_ get_empty_clob _null_ _null_ _null_ ));
DESCR("empty_blob()");

ORADATA(insert OID = 4926 (  interval_interval_concate PGORCL PGUID 14 1 0 0 0 f f f t f i s 2 0 25 "1186 1186" _null_ _null_ _null_ _null_ _null_ "select $1::pg_catalog.text || $2::pg_catalog.text" _null_ _null_ _null_ ));
ORADESCR("interval and interval concatenate function");
ORADATA(insert OID = 5007 (  userenv PGORCL PGUID 12 1 0 0 0 f f f f f i r 1 0 8026 "8026" _null_ _null_ _null_ _null_ _null_ orcl_userenv _null_ _null_ _null_ ));
ORADESCR("Support opentenbase_ora userenv function");

#define SYS_CONTEXT_OID 5201
ORADATA(insert OID = 5201 (  sys_context PGORCL PGUID 12 1 0 0 0 f f f t f v r 3 0 8026 "8026 8026 1700" _null_ _null_ "{namespace,attribute,len}" _null_ _null_ sys_context _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora sys_context ");
ORADATA(insert OID = 5202 (  xs_sys_context PGORCL PGUID 12 1 0 0 0 f f f t f v r 3 0 8026 "8026 8026 1700" _null_ _null_ "{namespace,attribute,len}" _null_ _null_ xs_sys_context _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora xs_sys_context ");

ORADATA(insert OID = 8980 (  bfilename	   PGORCL PGUID 12 1 0 0 0 f f f t f i u 2 0 8999 "2275 2275" _null_ _null_ _null_ _null_ _null_ bfilename _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8981 (  bfilein	   PGORCL PGUID 12 1 0 0 0 f f f t f i u 1 0 8999 "8999" _null_ _null_ _null_ _null_ _null_ bfilein _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8982 (  bfileout	   PGORCL PGUID 12 1 0 0 0 f f f t f i u 1 0 2275 "8999" _null_ _null_ _null_ _null_ _null_ bfileout _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8983 (  bfile_send	PGNSP PGUID 12 1 0 0 0 f f f t f s u 1 0 17 "2275" _null_ _null_ _null_ _null_ _null_    cstring_send _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 8984 (  bfile_recv	PGNSP PGUID 12 1 0 0 0 f f f t f s u 1 0 2277 "2281" _null_ _null_ _null_ _null_ _null_ anyarray_recv _null_ _null_ _null_ ));
ORADESCR("I/O");

DATA(insert OID = 9800 (  nextval           PGORCL PGUID 12 1 0 0 0 f f f t f v u 1 0 1700 "2205" _null_ _null_ _null_ _null_ _null_ orcl_nextval_oid _null_ _null_ _null_ ));
DESCR("opentenbase_ora sequence next value");
DATA(insert OID = 9801 (  currval           PGORCL PGUID 12 1 0 0 0 f f f t f v u 1 0 1700 "2205" _null_ _null_ _null_ _null_ _null_ orcl_currval_oid _null_ _null_ _null_ ));
DESCR("opentenbase_ora sequence current value");
ORADATA(insert OID = 9802 (  setval            PGORCL PGUID 12 1 0 0 0 f f f t f v u 2 0 1700 "2205 1700" _null_ _null_ _null_ _null_  _null_ orcl_setval_oid _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora set sequence value");
ORADATA(insert OID = 9803 (  setval            PGORCL PGUID 12 1 0 0 0 f f f t f v u 3 0 1700 "2205 1700 16" _null_ _null_ _null_ _null_ _null_ orcl_setval3_oid _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora set sequence value and is_called status");
ORADATA(insert OID = 9808 ( lastval               PGORCL PGUID 12 1 0 0 0 f f f t f v u 0 0 1700 "" _null_ _null_ _null_ _null_ _null_    orcl_lastval _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora current value from last used sequence");


#endif /* _PG_ORCL_ */
ORADATA(insert OID = 5097 (  sys_guid PGORCL PGUID 12 1 0 0 0 f f f t f v r 0 0 4831 "" _null_ _null_ _null_ _null_ _null_ orcl_sys_guid _null_ _null_ _null_ ));
ORADESCR("compatible opentenbase_ora sys_guid function");

DATA(insert OID = 8400 ( pg_signal_query      PGNSP PGUID 12 1 0 0 0 f f f t f v u 3 0 16 "25 23 16" _null_ _null_ _null_ _null_ _null_ pg_signal_query _null_ _null_ _null_ ));
DESCR("send the signal to the query all process");
DATA(insert OID = 8401 ( pg_terminate_query   PGNSP PGUID 12 1 0 0 0 f f f t f v u 1 0 16 "25" _null_ _null_ _null_ _null_ _null_ pg_terminate_query _null_ _null_ _null_ ));
DESCR("terminate the query all process");
DATA(insert OID = 8402 ( pg_cancel_query   PGNSP PGUID 12 1 0 0 0 f f f t f v u 1 0 16 "25" _null_ _null_ _null_ _null_ _null_ pg_cancel_query _null_ _null_ _null_ ));
DESCR("cancel the query all process");

DATA(insert OID = 8403 ( pg_stat_pss_memory_usage      PGNSP PGUID 12 1 0 0 0 f f f t f v u 1 0 20 "23" _null_ _null_ _null_ _null_ _null_ pg_stat_pss_memory_usage _null_ _null_ _null_ ));
DESCR("Get the PSS memory usage of a single process ID.");
DATA(insert OID = 8404 ( pg_stat_session_memory_detail   PGNSP PGUID 12 1 0 0 0 f f f t f v u 0 0 2249 "" "{23,25,25,20}" "{o,o,o,o}" "{pid,sessionid,contextname,totalsize}" _null_ _null_ pg_stat_session_memory_detail _null_ _null_ _null_ ));
DESCR("Get the context memory usage of a session.");
DATA(insert OID = 8405 ( pg_stat_context_memory_detail   PGNSP PGUID 12 1 0 0 0 f f f t f v u 0 0 2249 "" "{23,25,25,25,23,20}" "{o,o,o,o,o,o}" "{pid,sessionid,context_name,file,line,size}" _null_ _null_ pg_stat_context_memory_detail _null_ _null_ _null_ ));
DESCR("Get the detailed memory allocation information of a context.");
DATA(insert OID = 8406 ( pg_stat_cluster_node_memory_detail   PGNSP PGUID 12 1 0 0 0 f f f t f v u 0 0 2249 "" "{25,1700}" "{o,o}" "{node_name,pss}" _null_ _null_ pg_stat_cluster_node_memory_detail _null_ _null_ _null_ ));
DESCR("Get the PSS memory usage of each node in the cluster.");
DATA(insert OID = 8407 ( pg_stat_cluster_session_memory_detail   PGNSP PGUID 12 1 0 0 0 f f f t f v u 0 0 2249 "" "{25,23,25,25,20}" "{o,o,o,o,o}" "{node_name,pid,sessionid,contextname,totalsize}" _null_ _null_ pg_stat_cluster_session_memory_detail _null_ _null_ _null_ ));
DESCR("Get the session memory usage of each node in the cluster.");
DATA(insert OID = 8408 ( pg_stat_cluster_context_memory_detail   PGNSP PGUID 12 1 0 0 0 f f f t f v u 0 0 2249 "" "{25,23,25,25,25,23,20}" "{o,o,o,o,o,o,o}" "{node_name,pid,sessionid,context_name,file,line,size}" _null_ _null_ pg_stat_cluster_context_memory_detail _null_ _null_ _null_ ));
DESCR("Get the context memory usage of each node in the cluster.");
DATA(insert OID = 8409 ( pg_log_backend_memory_contexts      PGNSP PGUID 12 1 0 0 0 f f f t f v u 1 0 16 "23" _null_ _null_ _null_ _null_ _null_ pg_log_backend_memory_contexts _null_ _null_ _null_ ));
DESCR("Signal a backend process to log its memory contexts.");
DATA(insert OID = 8628 ( pg_get_backend_memory_detail   PGNSP PGUID 12 1 1000 0 0 f f f t t v u 0 0 2249 "" "{23,25,20}" "{o,o,o}" "{pid,contextname,totalsize}" _null_ _null_ pg_get_backend_memory_detail _null_ _null_ _null_ ));
DESCR("Get the context memory usage of all backends.");
DATA(insert OID = 8629 ( pg_get_backend_memctx_detail   PGNSP PGUID 12 1 1000 0 0 f f f t t v u 2 0 2249 "23 25" "{23,25,25,23,20}" "{i,i,o,o,o}" "{pid,contextname,file,line,size}" _null_ _null_ pg_get_backend_memctx_detail _null_ _null_ _null_ ));
DESCR("Get the detailed memory allocation information of a context.");

DATA(insert OID = 8718 ( pg_spm_load_plans_from_history      PGNSP PGUID 12 1 0 0 0 f f f t f v u 4 0 23 "20 20 16 16" _null_ _null_ _null_ _null_ _null_ pg_spm_load_plans_from_history _null_ _null_ _null_ ));
DESCR("Apply a record from pg_spm_plan_history to the baseline.");
DATA(insert OID = 8719 ( pg_spm_drop_sql_plan_baseline      PGNSP PGUID 12 1 0 0 0 f f f f f v u 2 0 23 "20 20" _null_ _null_ _null_ _null_ _null_ pg_spm_drop_sql_plan_baseline _null_ _null_ _null_ ));
DESCR("Delete records from pg_spm_plan and pg_spm_plan_history.");
DATA(insert OID = 8720 ( pg_spm_alter_sql_plan_baseline      PGNSP PGUID 12 1 0 0 0 f f f t f v u 4 0 23 "20 20 25 25" _null_ _null_ _null_ _null_ _null_ pg_spm_alter_sql_plan_baseline _null_ _null_ _null_ ));
DESCR("Update records in the pg_spm_plan and pg_spm_plan_history tables.");
DATA(insert OID = 8721 ( pg_spm_reload_sql_plan_cache      PGNSP PGUID 12 1 0 0 0 f f f t f v u 0 0 16 "" _null_ _null_ _null_ _null_ _null_ pg_spm_reload_sql_plan_cache _null_ _null_ _null_ ));
DESCR("Rebuild spm plan cache in shared memory.");
DATA(insert OID = 8722 ( sql_identity      PGNSP PGUID 12 1 0 0 0 f f f t f s s 3 0 23 "25 16 16" _null_ _null_ _null_ _null_ _null_ sql_identity _null_ _null_ _null_ ));
DESCR("get sql identity");

#ifdef __OPENTENBASE_C__
DATA(insert OID = 8094 (  distinct_accum		PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 2276" _null_ _null_ _null_ _null_ _null_ distinct_accum _null_ _null_ _null_ ));
DESCR("distinct transition function");
DATA(insert OID = 8095 (  distinct_combine		PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 2281 "2281 2281" _null_ _null_ _null_ _null_ _null_ distinct_combine _null_ _null_ _null_ ));
DESCR("distinct combine function");
DATA(insert OID = 8096 (  distinct_serialize	PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 17 "2281" _null_ _null_ _null_ _null_ _null_ distinct_serialize _null_ _null_ _null_ ));
DESCR("distinct serialize function");
DATA(insert OID = 8097 (  distinct_deserialize	PGNSP PGUID 12 1 0 0 0 f f f t f i s 2 0 2281 "17 2281" _null_ _null_ _null_ _null_ _null_ distinct_deserialize _null_ _null_ _null_ ));
DESCR("distinct deserialize function");
DATA(insert OID = 8098 (  distinct_final		PGNSP PGUID 12 1 0 0 0 f f f f f i s 1 0 2276 "2281" _null_ _null_ _null_ _null_ _null_ distinct_final _null_ _null_ _null_ ));
DESCR("distinct final function");
DATA(insert OID = 8099 (  distinct				PGNSP PGUID 12 1 0 0 0 a f f f f i s 1 0 2276 "2276" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("distinct aggregate function");
DATA(insert OID = 8100 (  to_bigint				PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 20 "1043" _null_ _null_ _null_ _null_ _null_ varchar_to_int8 _null_ _null_ _null_ ));
DESCR("convert varchar to int8");
DATA(insert OID = 8134 (  to_integer			PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "1043" _null_ _null_ _null_ _null_ _null_ varchar_to_int4 _null_ _null_ _null_ ));
DESCR("convert varchar to int4");
DATA(insert OID = 8700 (  date_add			    PGNSP PGUID 12 1 0 0 0 f f f t f s s 2 0 1184 "1184 1186" _null_ _null_ _null_ _null_ _null_ timestamptz_pl_interval _null_ _null_ _null_ ));
DESCR("add interval to timestamp with time zone");
DATA(insert OID = 8701 (  date_add			    PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 1184 "1184 1186 25" _null_ _null_ _null_ _null_ _null_ timestamptz_pl_interval_at_zone _null_ _null_ _null_ ));
DESCR("add interval to timestamp with time zone in specified time zone");
DATA(insert OID = 8702 (  date_subtract			    PGNSP PGUID 12 1 0 0 0 f f f t f s s 2 0 1184 "1184 1186" _null_ _null_ _null_ _null_ _null_ timestamptz_mi_interval _null_ _null_ _null_ ));
DESCR("subtract interval from timestamp with time zone");
DATA(insert OID = 8703 (  date_subtract			    PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 1184 "1184 1186 25" _null_ _null_ _null_ _null_ _null_ timestamptz_mi_interval_at_zone _null_ _null_ _null_ ));
DESCR("subtract interval from timestamp with time zone in specified time zone");
DATA(insert OID = 8704 (  generate_series PGNSP PGUID 12 1 1000 0 0 f f f t t i s 4 0 1184 "1184 1184 1186 25" _null_ _null_ _null_ _null_ _null_ generate_series_timestamptz_at_zone _null_ _null_ _null_ ));
DESCR("non-persistent series generator");

PGDATA(insert OID = 8705 (  year			    PGNSP PGUID 14 1 0 0 0 f f f t f i s 1 0 701 "1114" _null_ _null_ _null_ _null_ _null_ "SELECT EXTRACT(YEAR FROM $1)" _null_ _null_ _null_ ));
PGDESCR("get the year in timestamp");
PGDATA(insert OID = 8706 (  year			    PGNSP PGUID 14 1 0 0 0 f f f t f i s 1 0 701 "1184" _null_ _null_ _null_ _null_ _null_ "SELECT EXTRACT(YEAR FROM $1)" _null_ _null_ _null_ ));
PGDESCR("get the year in timestamp with time zone");
PGDATA(insert OID = 8707 (  day			    PGNSP PGUID 14 1 0 0 0 f f f t f i s 1 0 701 "1114" _null_ _null_ _null_ _null_ _null_ "SELECT EXTRACT(DAY FROM $1)" _null_ _null_ _null_ ));
PGDESCR("get the day in timestamp");
PGDATA(insert OID = 8708 (  day			    PGNSP PGUID 14 1 0 0 0 f f f t f i s 1 0 701 "1184" _null_ _null_ _null_ _null_ _null_ "SELECT EXTRACT(DAY FROM $1)" _null_ _null_ _null_ ));
PGDESCR("get the day in timestamp with time zone");
PGDATA(insert OID = 8709 (  unix_timestamp	PGNSP PGUID 14 1 0 0 0 f f f t f s s 0 0 701 "" _null_ _null_ _null_ _null_ _null_ "SELECT FLOOR(EXTRACT(epoch FROM NOW()))" _null_ _null_ _null_ ));
PGDESCR("get the number of seconds elapsed from '1970-01-01 00:00:00'UTC to now");
PGDATA(insert OID = 8710 (  unix_timestamp	PGNSP PGUID 14 1 0 0 0 f f f t f i s 1 0 701 "1114" _null_ _null_ _null_ _null_ _null_ "SELECT EXTRACT(epoch FROM $1)" _null_ _null_ _null_ ));
PGDESCR("get the number of seconds elapsed from '1970-01-01 00:00:00'UTC to input parameter timestamp");
PGDATA(insert OID = 8711 (  unix_timestamp	PGNSP PGUID 14 1 0 0 0 f f f t f i s 1 0 701 "1184" _null_ _null_ _null_ _null_ _null_ "SELECT EXTRACT(epoch FROM $1)" _null_ _null_ _null_ ));
PGDESCR("get the number of seconds elapsed from '1970-01-01 00:00:00'UTC to input parameter timestamp with time zone");
PGDATA(insert OID = 8712 (  date_add			    PGNSP PGUID 14 1 0 0 0 f f f t f s s 2 0 1184 "1184 23" _null_ _null_ _null_ _null_ _null_ "SELECT DATE_ADD($1, make_interval(days := $2))" _null_ _null_ _null_ ));
PGDESCR("add interval x days to timestamp with time zone");
PGDATA(insert OID = 8713 (  date_sub		    PGNSP PGUID 14 1 0 0 0 f f f t f s s 2 0 1184 "1184 23" _null_ _null_ _null_ _null_ _null_ "SELECT DATE_SUBTRACT($1, make_interval(days := $2))" _null_ _null_ _null_ ));
PGDESCR("subtract interval x days from timestamp with time zone");
PGDATA(insert OID = 8714 (  date_sub			    PGNSP PGUID 12 1 0 0 0 f f f t f s s 2 0 1184 "1184 1186" _null_ _null_ _null_ _null_ _null_ timestamptz_mi_interval _null_ _null_ _null_ ));
PGDESCR("subtract interval from timestamp with time zone");
PGDATA(insert OID = 8715 (  date_sub			    PGNSP PGUID 12 1 0 0 0 f f f t f i s 3 0 1184 "1184 1186 25" _null_ _null_ _null_ _null_ _null_ timestamptz_mi_interval_at_zone _null_ _null_ _null_ ));
PGDESCR("subtract interval from timestamp with time zone in specified time zone");
PGDATA(insert OID = 8716 ( date_format            PGNSP PGUID 12 1 0 0 0 f f f t f s s 2 0 25 "1114 25" _null_ _null_ _null_ _null_  _null_ timestamp_to_char _null_ _null_ _null_ ));
PGDESCR("format timestamp to text");
PGDATA(insert OID = 8717 ( date_format            PGNSP PGUID 12 1 0 0 0 f f f t f s s 2 0 25 "1184 25" _null_ _null_ _null_ _null_  _null_ timestamptz_to_char _null_ _null_ _null_ ));
PGDESCR("format timestamp with time zone to text");

DATA(insert OID = 8752 (  to_numeric			PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1700 "1043" _null_ _null_ _null_ _null_ _null_ varchar_to_numeric _null_ _null_ _null_ ));
DESCR("convert varchar to numeric");
DATA(insert OID = 8753 (  text_date				PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1082 "25" _null_ _null_ _null_ _null_ _null_ text_to_date _null_ _null_ _null_ ));
DESCR("convert text to date");
DATA(insert OID = 8754 (  enable				PGNSP PGUID 12 1 0 0 0 p f f f f v u 1 0 2278 "23" _null_ _null_ _null_ _null_ _null_ output_enable _null_ _null_ _null_ ));
DESCR("set output buffer size");
DATA(insert OID = 8755 (  enable				PGNSP PGUID 12 1 0 0 0 p f f f f v u 0 0 2278 "" _null_ _null_ _null_ _null_ _null_ output_enable_default _null_ _null_ _null_ ));
DESCR("set output buffer size as default");
DATA(insert OID = 8756 (  disable				PGNSP PGUID 12 1 0 0 0 p f f f f v u 0 0 2278 "" _null_ _null_ _null_ _null_ _null_ output_disable _null_ _null_ _null_ ));
DESCR("empty output buffer");
DATA(insert OID = 8757 (  put					PGNSP PGUID 12 1 0 0 0 p f f f f v u 1 0 2278 "25" _null_ _null_ _null_ _null_ _null_ output_put _null_ _null_ _null_ ));
DESCR("put text into output buffer");
DATA(insert OID = 8758 (  put_line				PGNSP PGUID 12 1 0 0 0 p f f f f v u 1 0 2278 "25" _null_ _null_ _null_ _null_ _null_ output_put_line _null_ _null_ _null_ ));
DESCR("put text into output buffer and print buffer out");
DATA(insert OID = 8759 (  new_line				PGNSP PGUID 12 1 0 0 0 p f f f f v u 0 0 2278 "" _null_ _null_ _null_ _null_ _null_ output_new_line _null_ _null_ _null_ ));
DESCR("print output buffer out and start a new line");
DATA(insert OID = 8760 (  getdistributekey		PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 25 "2205" _null_ _null_ _null_ _null_ _null_ get_distribute_key _null_ _null_ _null_ ));
DESCR("get distribute columns");
DATA(insert OID = 8761 (  pg_systimestamp		PGNSP PGUID 12 1 0 0 0 f f f t f s r 0 0 1184 "" _null_ _null_ _null_ _null_ _null_ pg_systimestamp _null_ _null_ _null_ ));
DESCR("systimestamp");
DATA(insert OID = 8785 (  pg_get_tabledef		PGNSP PGUID 12 1 0 0 0 f f f f f s r 1 0 25 "2205" _null_ _null_ _null_ _null_ _null_ pg_get_tabledef _null_ _null_ _null_ ));
DESCR("get table's definition by table oid");
DATA(insert OID = 9047 (  fn_stat_get_activity	PGNSP PGUID 12 1 0 0 0 f f f t f v u 3 0 2249 "20 20 23" "{20,20,23,20,20,20,23,23,23}" "{i,i,i,o,o,o,o,o,o}" "{qid_ts_node,qid_seq,fid,send_entry,recv_entry,linger_entry,send_buffer_used,recv_buffer_used,local_buffer_used}" _null_ _null_ fn_stat_get_activity _null_ _null_ _null_ ));
DESCR("resources related to FN in shared memory");
DATA(insert OID = 9078 (  fn_stat_get_page		PGNSP PGUID 12 1 100 0 0 f f f f t v u 0 0 2249 "" "{20,20,21,21,21,21,23,23,23}" "{o,o,o,o,o,o,o,o,o}" "{qid_ts_node,qid_seq,fid,nodeid,workerid,virtualid,flag,size,bufid}" _null_ _null_ fn_stat_get_page _null_ _null_ _null_ ));
DESCR("all valid pages of FN in shared memory");
DATA(insert OID = 9094 (  fn_stat_get_entry		PGNSP PGUID 12 1 100 0 0 f f f f t v u 0 0 2249 "" "{20,20,21,23,16}" "{o,o,o,o,o}" "{qid_ts_node,qid_seq,fid,workerid,send}" _null_ _null_ fn_stat_get_entry _null_ _null_ _null_ ));
DESCR("all valid entries of FN in shared memory");
DATA(insert OID = 9080 (  fn_stat_clear_page	PGNSP PGUID 12 1 0 0 0 f f f t f v u 2 0 23 "20 20" _null_ _null_ _null_ _null_ _null_ fn_stat_clear_page _null_ _null_ _null_ ));
DESCR("clear pages of specific FN queryid in shared memory");
DATA(insert OID = 9731 (  pg_stat_lwlocks	PGNSP PGUID 12 1 1000 0 0 f f f f t s r 2 0 2249 "23 23" "{23,23,25,23,23,23}" "{i,i,o,o,o,o}" "{retry,period,lwlock_name,pid,backendid,num_of_wait}" _null_ _null_ pg_stat_lwlocks _null_ _null_ _null_ ));
DESCR("get lwlocks info which can not be acquired");
DATA(insert OID = 9732 (  set_lwlocks	PGNSP PGUID 12 1 0 0 0 f f f t f v u 2 0 16 "25 16" "{25,16,16}" "{i,i,o}" "{lwlock_name,flag,set}" _null_ _null_ set_lwlocks _null_ _null_ _null_ ));
DESCR("acquire or release a lwlock");

DATA(insert OID = 9095 (  fn_stat_clear_entry	PGNSP PGUID 12 1 0 0 0 f f f t f v u 5 0 16 "20 20 21 23 16" _null_ _null_ _null_ _null_ _null_ fn_stat_clear_entry _null_ _null_ _null_ ));
DESCR("clear entries of specific FN queryid in shared memory");
DATA(insert OID = 9109 (  pg_stat_get_query_cputime		PGNSP PGUID 12 1 0 0 0 f f f f t s r 1 0 2249 "25" "{25,25,25,701}" "{i,o,o,o}" "{queryid,queryid,nodename,cputime}" _null_ _null_ pg_stat_get_query_cputime _null_ _null_ _null_ ));
DESCR("cpu time of a query on a specific node (cn/dn)");
DATA(insert OID = 9209 (  pg_stat_get_cluster_query_cputime		PGNSP PGUID 12 1 0 0 0 f f f f t s r 2 0 2249 "25 16" "{25,16,25,25,701}" "{i,i,o,o,o}" "{queryid,datanodeonly,queryid,nodename,cputime}" _null_ _null_ pg_stat_get_cluster_query_cputime _null_ _null_ _null_ ));
DESCR("cpu time of a query on all nodes in the cluster");
DATA(insert OID = 9211 (  pg_stat_get_query_memory		PGNSP PGUID 12 1 0 0 0 f f f f t s r 1 0 2249 "25" "{25,25,25,20}" "{i,o,o,o}" "{queryid,queryid,nodename,memory}" _null_ _null_ pg_stat_get_query_memory _null_ _null_ _null_ ));
DESCR("cpu time of a query on a specific node (cn/dn)");
DATA(insert OID = 9212 (  pg_stat_get_cluster_query_memory		PGNSP PGUID 12 1 0 0 0 f f f f t s r 2 0 2249 "25 16" "{25,16,25,25,20,20}" "{i,i,o,o,o,o}" "{queryid,datanodeonly,queryid,nodename,memory_sum,memory_max}" _null_ _null_ pg_stat_get_cluster_query_memory _null_ _null_ _null_ ));
DESCR("cpu time of a query on all nodes in the cluster");
DATA(insert OID = 9213 (  pg_stat_get_query_workfile_usage		PGNSP PGUID 12 1 0 0 0 f f f f t s r 1 0 2249 "25" "{25,25,25,20,25,23,25,23,23}" "{i,o,o,o,o,o,o,o,o}" "{queryid,nodename,prefix,size,operation,fid,queryid,commandid,numfiles}" _null_ _null_ pg_stat_get_query_workfile_usage _null_ _null_ _null_ ));
DESCR("workfile stat of a query on a specific node (cn/dn)");
DATA(insert OID = 9214 (  pg_stat_get_cluster_query_workfile_usage		PGNSP PGUID 12 1 0 0 0 f f f f t s r 2 0 2249 "25 16" "{25,16,25,25,20,1700}" "{i,i,o,o,o,o}" "{queryid,datanodeonly,queryid,nodename,total_numfiles,total_size}" _null_ _null_ pg_stat_get_cluster_query_workfile_usage _null_ _null_ _null_ ));
DESCR("workfile stat of a query on all nodes in the cluster");
DATA(insert OID = 9215 (  pg_stat_get_workfile_diskspace		PGNSP PGUID 12 1 0 0 0 f f f f t s r 0 0 2249 "" "{25,20}" "{o,o}" "{nodename,diskspace}" _null_ _null_ pg_stat_get_workfile_diskspace _null_ _null_ _null_ ));
DESCR("workfile stat of a query on all nodes in the cluster");
DATA(insert OID = 9216 (  pg_stat_get_cluster_workfile_diskspace		PGNSP PGUID 12 1 0 0 0 f f f f t s r 0 0 2249 "" "{25,20}" "{o,o}" "{nodename,diskspace}" _null_ _null_ pg_stat_get_cluster_workfile_diskspace _null_ _null_ _null_ ));
DESCR("workfile stat of a query on all nodes in the cluster");
DATA(insert OID = 9217 (  pg_stat_get_query_io		PGNSP PGUID 12 1 0 0 0 f f f f t s r 1 0 2249 "25" "{25,25,25,20,20}" "{i,o,o,o,o}" "{queryid,queryid,nodename,read,write}" _null_ _null_ pg_stat_get_query_io _null_ _null_ _null_ ));
DESCR("io of a query on a specific node (cn/dn)");
DATA(insert OID = 9218 (  pg_stat_get_cluster_query_io		PGNSP PGUID 12 1 0 0 0 f f f f t s r 2 0 2249 "25 16" "{25,16,25,25,20,20}" "{i,i,o,o,o,o}" "{queryid,datanodeonly,queryid,nodename,read,write}" _null_ _null_ pg_stat_get_cluster_query_io _null_ _null_ _null_ ));
DESCR("io of a query on all nodes in the cluster");
#endif
DATA(insert OID = 9219 (  pg_get_xact_relstat_info	 PGNSP PGUID 12 1 0 0 0 f f f f t s r 0 0 2249 "" "{26,19,19,20,1184,23,23,23}" "{o,o,o,o,o,o,o,o}" "{relid,relnamespace,relname,changes_since_analyze,last_analyze_time,last_analyze_time_consumed_ms,analyze_times,total_analyze_time_ms}" _null_ _null_ pg_get_xact_relstat_info _null_ _null_ _null_ ));
DESCR("get current transaction relation stat info");


DATA(insert OID = 9220 ( pg_clean_unused_temp_schema      PGNSP PGUID 12 1 0 0 0 f f f f f v s 1 0 16 "19" _null_ _null_ "{schema_name}" _null_ _null_ pg_clean_unused_temp_schema _null_ _null_ _null_ ));
DESCR("Clean up the specified unused temporary schema, If no name is given, clean up the unused temporary schema in the current database");

#ifdef __RESOURCE_QUEUE__
DATA(insert OID = 9100 ( opentenbase_resource_queue_acquire PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 23 "19 20" _null_ _null_ _null_ _null_  _null_ opentenbase_resource_queue_acquire _null_ _null_ _null_ ));
DESCR("test acqurie memory from resrouce queue");
DATA(insert OID = 9101 ( opentenbase_resource_queue_release PGNSP PGUID 12 1 0 0 0 f f f f f i s 2 0 23 "19 20" _null_ _null_ _null_ _null_  _null_ opentenbase_resource_queue_release _null_ _null_ _null_ ));
DESCR("test release memory from resrouce queue");
DATA(insert OID = 9102 ( opentenbase_list_all_storage_resqueue	PGNSP PGUID 12 1 0 0 0 f f f f f s r 0 0 2249 "" "{19,20,20,23,21,25,23,23,23,23}" "{o,o,o,o,o,o,o,o,o,o}" "{resq_name,resq_memory_limit_bytes,resq_network_limit_bytes,resq_active_stmts_limit,resq_wait_overload,resq_priority,resq_status,gti_store_handle,gti_next,resq_crc}" _null_ _null_ opentenbase_list_all_storage_resqueue _null_ _null_ _null_ ));
DESCR("gtm store: list gtm stored resource queue info");
DATA(insert OID = 9103 ( opentenbase_check_all_storage_resqueue PGNSP PGUID 12 1 0 0 0 f f f f f s r 1 0 2249 "16" "{16,19,20,20,23,21,25,23,23,23,23,23,23}" "{i,o,o,o,o,o,o,o,o,o,o,o,o}" "{need_fix,resq_name,resq_memory_limit_bytes,resq_network_limit_bytes,resq_active_stmts_limit,resq_wait_overload,resq_priority,resq_status,gti_store_handle,gti_next,resq_crc,error_code,check_status}" _null_ _null_ opentenbase_check_all_storage_resqueue _null_ _null_ _null_ ));
DESCR("gtm store: check gtm stored resource queue status");
DATA(insert OID = 9104 ( opentenbase_list_all_resqueue	PGNSP PGUID 12 1 0 0 0 f f f f f s r 0 0 2249 "" "{19,20,20,23,21,25,23,23,20}" "{o,o,o,o,o,o,o,o,o}" "{resq_name,resq_memory_limit_bytes,resq_network_limit_bytes,resq_active_stmts_limit,resq_wait_overload,resq_priority,resq_state,gti_store_handle,resq_memory_used}" _null_ _null_ opentenbase_list_all_resqueue _null_ _null_ _null_ ));
DESCR("gtm store: list gtm stored resource queue info");
DATA(insert OID = 9105 ( opentenbase_list_resqueue_usage PGNSP PGUID 12 1 0 0 0 f f f f f s r 1 0 2249 "19" "{19,19,19,23,23,20,25}" "{i,o,o,o,o,o,o}" "{name,resq_name,node_name,node_proc_pid,node_backend_id,memory_bytes,role}" _null_ _null_ opentenbase_list_resqueue_usage _null_ _null_ _null_ ));
DESCR("gtm store: get gtm resource queue usage info");

DATA(insert OID = 9106 (  pg_resgroup_get_status_kv    PGNSP PGUID 12 1 1000 0 0 f f f f t v r 1 0 2249 "25" "{25,19,25,25}" "{i,o,o,o}" "{prop_in,groupname,prop,value}" _null_ _null_ pg_resgroup_get_status_kv _null_ _null_ _null_ ));
DESCR("statistics: information about resource groups in key-value style");
DATA(insert OID = 9107 (  pg_resgroup_get_status    PGNSP PGUID 12 1 1000 0 0 f f f f t v r 1 0 2249 "2275" "{2275,19,114,114,114,114,114,114}" "{i,o,o,o,o,o,o,o}" "{groupname_in,groupname,num_running,num_queueing,num_queued,num_executed,total_queue_duration,cpu_usage}" _null_ _null_ pg_resgroup_get_status _null_ _null_ _null_ ));
DESCR("statistics: information about resource groups");
DATA(insert OID = 9112 (  pg_resgroup_clean_slot		PGNSP PGUID 12 1 0 0 0 f f f f t s r 1 0 2249 "25" "{25,25,25,16}" "{i,o,o,o}" "{rsgname,rsgname,nodename,cleaned}" _null_ _null_ pg_resgroup_clean_slot _null_ _null_ _null_ ));
DESCR("clean resgroup slot if procs not exists on a specific node)");
DATA(insert OID = 9113 (  pg_resgroup_cluster_clean_slot		PGNSP PGUID 12 1 0 0 0 f f f f t s r 2 0 2249 "25 16" "{25,16,25,25,16}" "{i,i,o,o,o}" "{rsgname,coordonly,rsgname,nodename,cleaned}" _null_ _null_ pg_resgroup_cluster_clean_slot _null_ _null_ _null_ ));
DESCR("clean resgroup slot if procs not exists on all nodes in the cluster");

#endif

ORADATA(insert OID = 4848 (  pludt_in       PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 3450 "2275" _null_ _null_ _null_ _null_ _null_ pludt_in _null_ _null_ _null_ ));
ORADESCR("I/O");
ORADATA(insert OID = 4849 (  pludt_out      PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 2275 "3450" _null_ _null_ _null_ _null_ _null_ pludt_out _null_ _null_ _null_ ));
ORADESCR("I/O");
/*opentenbase_ora's hook function to handle plpgsql's function*/
ORADATA(insert OID = 4217 (  opentenbase_ora_collect_func PGNSP PGUID 12 1 0 0 0 f f f t f v r 4 0 23 "25 20 23 23" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_func _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's function");

ORADATA(insert OID = 4216 (  opentenbase_ora_collect_exists PGNSP PGUID 12 1 0 0 0 f f f t f v r 4 0 16 "25 20 23 23" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_exists _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's function exists");

ORADATA(insert OID = 4215 (  opentenbase_ora_collect_proc PGNSP PGUID 12 1 0 0 0 f f f t f v r 6 0 2278 "25 20 23 23 23 23" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_proc _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's procedure");

ORADATA(insert OID = 4219 (  opentenbase_ora_collect_func_text PGNSP PGUID 12 1 0 0 0 f f f t f v r 4 0 25 "25 20 23 25" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_func_text _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's function");

ORADATA(insert OID = 4220 (  opentenbase_ora_collect_exists_text PGNSP PGUID 12 1 0 0 0 f f f t f v r 4 0 16 "25 20 23 25" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_exists_text _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's function exists");

ORADATA(insert OID = 4221 (  opentenbase_ora_collect_proc_text PGNSP PGUID 12 1 0 0 0 f f f t f v r 6 0 2278 "25 20 23 25 25 23" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_proc_text _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's procedure");

ORADATA(insert OID = 4222 (  opentenbase_ora_collect_get_subscript PGNSP PGUID 12 1 0 0 0 f f f f f v r 3 0 23  "20 23 23" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_fetch_iidx _null_ _null_ _null_ ));
ORADESCR("hook function to fetch opentenbase_ora aasociative array's index");

ORADATA(insert OID = 4223 (  opentenbase_ora_collect_get_subscript PGNSP PGUID 12 1 0 0 0 f f f f f v r 3 0 23  "20 23 25" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_fetch_sidx _null_ _null_ _null_ ));
ORADESCR("hook function to fetch opentenbase_ora aasociative array's index");

ORADATA(insert OID = 4235 (  opentenbase_ora_collect_get_subscript PGNSP PGUID 12 1 0 0 0 f f f f f v r 4 0 23 "25 20 23 23" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_fetch_array_iidx _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's array's index");

ORADATA(insert OID = 4236 (  opentenbase_ora_collect_func PGNSP PGUID 14 1 0 0 0 f f f t f v r 4 0 23 "25 20 23 1700" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.opentenbase_ora_collect_func($1, $2, $3, $4::int4)" _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's function");

ORADATA(insert OID = 4237 (  opentenbase_ora_collect_exists PGNSP PGUID 14 1 0 0 0 f f f t f v r 4 0 16 "25 20 23 1700" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.opentenbase_ora_collect_exists($1, $2, $3, $4::int4)" _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's function exists");

ORADATA(insert OID = 4238 (  opentenbase_ora_collect_proc PGNSP PGUID 14 1 0 0 0 f f f t f v r 6 0 2278 "25 20 23 1700 1700 23" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.opentenbase_ora_collect_proc($1, $2, $3, $4::int4, $5::int4, $6)" _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's procedure");

ORADATA(insert OID = 4239 (  opentenbase_ora_collect_get_subscript PGNSP PGUID 14 1 0 0 0 f f f f f v r 4 0 23 "25 20 23 1700" _null_ _null_ _null_ _null_ _null_ "select pg_catalog.opentenbase_ora_collect_get_subscript($1, $2, $3, $4::int4)" _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's array's index");

ORADATA(insert OID = 4240 (  opentenbase_ora_collect_func_text PGNSP PGUID 12 1 0 0 0 f f f t f v r 4 0 25 "25 20 23 8186" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_func_text _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's function");

ORADATA(insert OID = 4241 (  opentenbase_ora_collect_exists_text PGNSP PGUID 12 1 0 0 0 f f f t f v r 4 0 16 "25 20 23 8186" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_exists_text _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's function exists");

ORADATA(insert OID = 4242 (  opentenbase_ora_collect_proc_text PGNSP PGUID 12 1 0 0 0 f f f t f v r 6 0 2278 "25 20 23 8186 8186 23" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_proc_text _null_ _null_ _null_ ));
ORADESCR("hook function to handle opentenbase_ora collect's procedure");

ORADATA(insert OID = 4243 (  opentenbase_ora_collect_get_subscript PGNSP PGUID 12 1 0 0 0 f f f f f v r 3 0 23  "20 23 8186" _null_ _null_ _null_ _null_ _null_ opentenbase_ora_collect_fetch_sidx _null_ _null_ _null_ ));
ORADESCR("hook function to fetch opentenbase_ora aasociative array's index");

DATA(insert OID = 6142 ( bool PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 16 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_bool  _null_ _null_ _null_ ));
DESCR("convert jsonb to boolean");
DATA(insert OID = 6143 ( numeric PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 1700 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_numeric  _null_ _null_ _null_ ));
DESCR("convert jsonb to numeric");
DATA(insert OID = 6144 ( int2 PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 21 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_int2  _null_ _null_ _null_ ));
DESCR("convert jsonb to int2");
DATA(insert OID = 6145 ( int4 PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 23 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_int4  _null_ _null_ _null_ ));
DESCR("convert jsonb to int4");
DATA(insert OID = 6146 ( int8 PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 20 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_int8  _null_ _null_ _null_ ));
DESCR("convert jsonb to int8");
DATA(insert OID = 6147 ( float4 PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 700 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_float4  _null_ _null_ _null_ ));
DESCR("convert jsonb to float4");
DATA(insert OID = 6148 ( float8 PGNSP PGUID 12 1 0 0 0 f f f t f i s 1 0 701 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_float8  _null_ _null_ _null_ ));
DESCR("convert jsonb to float8");

ORADATA(insert OID = 9122 ( blobtoraw PGORCL PGUID 12 1 0 0 0 f f f t f i s 2 0 4831 "8762 23" _null_ _null_ _null_ _null_ _null_ blobtoraw _null_ _null_ _null_ ));
ORADESCR("convert blob to raw");
ORADATA(insert OID = 3417 ( numeric_fn PGORCL PGUID 12 1 0 0 0 f f f t f i s 1 0 1700 "20" _null_ _null_ _null_ _null_ _null_ int8_numeric _null_ _null_ _null_ ));
ORADESCR("convert int8 to numeric for count");
ORADATA(insert OID = 9123 ( multiset_fn PGORCL PGUID 12 100 0 0 0 f f f f f i s 4 0 2283 "2283 2283 23 23" _null_ _null_ _null_ _null_ _null_ multiset_expr _null_ _null_ _null_ ));
ORADESCR("support nested table multiset");
ORADATA(insert OID = 9124 ( multiset_fn_ua PGORCL PGUID 14 100 0 0 0 f f f f f i s 2 0 2283 "2283 2283" _null_ _null_ _null_ _null_ _null_ "select (case when array_ndims($1) > 1 then array(select unnest_dim($1, 1) union all select unnest_dim($2, 1)) else array(select unnest($1) union all select unnest($2)) end)::anyelement" _null_ _null_ _null_ ));
ORADESCR("multiset for union all");
ORADATA(insert OID = 9125 ( multiset_fn_ud PGORCL PGUID 14 100 0 0 0 f f f f f i s 2 0 2283 "2283 2283" _null_ _null_ _null_ _null_ _null_ "select (case when array_ndims($1) > 1 then array(select unnest_dim($1, 1) union distinct select unnest_dim($2, 1)) else array(select unnest($1) union distinct select unnest($2)) end)::anyelement" _null_ _null_ _null_ ));
ORADESCR("multiset for union distinct");
ORADATA(insert OID = 9126 ( multiset_fn_ia PGORCL PGUID 14 100 0 0 0 f f f f f i s 2 0 2283 "2283 2283" _null_ _null_ _null_ _null_ _null_ "select (case when array_ndims($1) > 1 then array(select unnest_dim($1, 1) intersect all select unnest_dim($2, 1)) else array(select unnest($1) intersect all select unnest($2)) end)::anyelement" _null_ _null_ _null_ ));
ORADESCR("multiset for intersect all");
ORADATA(insert OID = 9127 ( multiset_fn_id PGORCL PGUID 14 100 0 0 0 f f f f f i s 2 0 2283 "2283 2283" _null_ _null_ _null_ _null_ _null_ "select (case when array_ndims($1) > 1 then array(select unnest_dim($1, 1) intersect distinct select unnest_dim($2, 1)) else array(select unnest($1) intersect distinct select unnest($2)) end)::anyelement" _null_ _null_ _null_ ));
ORADESCR("multiset for intersect distinct");
ORADATA(insert OID = 9128 ( multiset_fn_ea PGORCL PGUID 14 100 0 0 0 f f f f f i s 2 0 2283 "2283 2283" _null_ _null_ _null_ _null_ _null_ "select (case when array_ndims($1) > 1 then array(select unnest_dim($1, 1) except all select unnest_dim($2, 1)) else array(select unnest($1) except all select unnest($2)) end)::anyelement" _null_ _null_ _null_ ));
ORADESCR("multiset for except all");
ORADATA(insert OID = 9129 ( multiset_fn_ed PGORCL PGUID 14 100 0 0 0 f f f f f i s 2 0 2283 "2283 2283" _null_ _null_ _null_ _null_ _null_ "select (case when array_ndims($1) > 1 then array(select unnest_dim($1, 1) except distinct select unnest_dim($2, 1)) else array(select unnest($1) except distinct select unnest($2)) end)::anyelement" _null_ _null_ _null_ ));
ORADESCR("multiset for except distinct");
ORADATA(insert OID = 9130 ( unnest_dim     PGORCL PGUID 12 100 1000 0 0 f f f f t i s 2 0 2277 "2277 23" _null_ _null_ _null_ _null_ _null_ array_unnest_dim _null_ _null_ _null_ ));
ORADESCR("support unnest one dimension");
/*
...
#define PROVOLATILE_CACHABLE	'c' /* does not change within a query, so we can cache its result */
