...
ORADATA(insert OID = 4927 (  "||"    PGORCL PGUID b f f 1186 1186 25  0  0 interval_interval_concate - - ));
ORADESCR("interval and interval concatenate");
...
/* jsonpath */
DATA(insert OID = 4012 (  "@?"	   PGNSP PGUID b f f 3802 4172 16 0 0 jsonb_path_exists_opr contsel contjoinsel ));
DESCR("jsonpath exists");
DATA(insert OID = 4013 (  "@@"	   PGNSP PGUID b f f 3802 4172 16 0 0 jsonb_path_match_opr contsel contjoinsel ));
DESCR("jsonpath match");

/* Numericd */
DATA(insert OID = 9400 (  "="	   PGNSP PGUID b t t	9301  9301	16 9400 9401 numericd_eq eqsel eqjoinsel ));
DESCR("equal");
DATA(insert OID = 9401 (  "<>"	   PGNSP PGUID b f f	9301  9301	16 9401 9400 numericd_ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 9402 (  "<"	   PGNSP PGUID b f f	9301  9301	16 9404 9405 numericd_lt scalarltsel scalarltjoinsel ));
DESCR("less than");
#define numericfLessOperator	672
DATA(insert OID = 9403 (  "<="	   PGNSP PGUID b f f	9301  9301	16 9405 9404 numericd_le scalarlesel scalarlejoinsel ));
DESCR("less than or equal");
DATA(insert OID = 9404 (  ">"	   PGNSP PGUID b f f	9301  9301	16 9402 9403 numericd_gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 9405 (  ">="	   PGNSP PGUID b f f	9301  9301	16 9403 9402 numericd_ge scalargesel scalargejoinsel ));
DESCR("greater than or equal");
DATA(insert OID = 9406 (  "+"	   PGNSP PGUID b f f	9301 9301 9301 9406 0 numericd_pl - - ));
DESCR("add");
DATA(insert OID = 9407 (  "-"	   PGNSP PGUID b f f	9301 9301 9301	 0	 0 numericd_mi - - ));
DESCR("subtract");
DATA(insert OID = 9408 (  "/"	   PGNSP PGUID b f f	9301 9301 9301	 0	 0 numericd_div - - ));
DESCR("divide");
DATA(insert OID = 9409 (  "*"	   PGNSP PGUID b f f	9301 9301 9301 9409 0 numericd_mul - - ));
DESCR("multiply");


/* numericf */
DATA(insert OID = 9450 (  "="	   PGNSP PGUID b t t	9351  9351	16 9450 9451 numericf_eq eqsel eqjoinsel ));
DESCR("equal");
DATA(insert OID = 9451 (  "<>"	   PGNSP PGUID b f f	9351  9351	16 9451 9450 numericf_ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 9452 (  "<"	   PGNSP PGUID b f f	9351  9351	16 9454 9455 numericf_lt scalarltsel scalarltjoinsel ));
DESCR("less than");
#define numericfLessOperator	672
DATA(insert OID = 9453 (  "<="	   PGNSP PGUID b f f	9351  9351	16 9455 9454 numericf_le scalarlesel scalarlejoinsel ));
DESCR("less than or equal");
DATA(insert OID = 9454 (  ">"	   PGNSP PGUID b f f	9351  9351	16 9452 9453 numericf_gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 9455 (  ">="	   PGNSP PGUID b f f	9351  9351	16 9453 9452 numericf_ge scalargesel scalargejoinsel ));
DESCR("greater than or equal");
DATA(insert OID = 9456 (  "+"	   PGNSP PGUID b f f	9351 9351 9351 9456 0 numericf_pl - - ));
DESCR("add");
DATA(insert OID = 9457 (  "-"	   PGNSP PGUID b f f	9351 9351 9351	 0	 0 numericf_mi - - ));
DESCR("subtract");
DATA(insert OID = 9458 (  "/"	   PGNSP PGUID b f f	9351 9351 9301	 0	 0 numericf_div - - ));
DESCR("divide");
DATA(insert OID = 9459 (  "*"	   PGNSP PGUID b f f	9351 9351 9301 9459  0 numericf_mul - - ));
DESCR("multiply");

ORADATA(insert OID = 8052 (  "/"	   PGORCL PGUID b f f 23 23	1700	0 0 orcl_int4div - - ));
ORADESCR("divide");
#define OID_ORCL_INT4_DIV_OP		8052

// support old version upgrade
PGDATA(insert OID = 8135 (  "+"	   PGORCL PGUID b f f 1114 23 1114  0 0 orcl_timestamp_pl_day_i4 - - ));
DESCR("add");
PGDATA(insert OID = 8136 (  "+"	   PGORCL PGUID b f f 1114 20 1114  0 0 orcl_timestamp_pl_day_i8 - - ));
DESCR("add");
PGDATA(insert OID = 8137 (  "+"	   PGORCL PGUID b f f 1114 21 1114  0 0 orcl_timestamp_pl_day_i2 - - ));
DESCR("add");
PGDATA(insert OID = 8138 (  "+"	   PGORCL PGUID b f f 1114 1700 1114  0 0 orcl_timestamp_pl_day_n - - ));
DESCR("add");
PGDATA(insert OID = 8139 (  "-"	   PGORCL PGUID b f f 1114 23 1114  0 0 orcl_timestamp_mi_day_i4 - - ));
DESCR("subtract");
PGDATA(insert OID = 8140 (  "-"	   PGORCL PGUID b f f 1114 20 1114  0 0 orcl_timestamp_mi_day_i8 - - ));
DESCR("subtract");
PGDATA(insert OID = 8141 (  "-"	   PGORCL PGUID b f f 1114 21 1114  0 0 orcl_timestamp_mi_day_i2 - - ));
DESCR("subtract");
PGDATA(insert OID = 8142 (  "-"	   PGORCL PGUID b f f 1114 1700 1114  0 0 orcl_timestamp_mi_day_n - - ));
DESCR("subtract");
/* rowid operators */
ORADATA(insert OID = 8150 (  "="	   PGORCL PGUID b t t 8022 8022 16 8150 8151 rowid_eq eqsel eqjoinsel ));
ORADESCR("equal");
ORADATA(insert OID = 8151 (  "<>"	   PGORCL PGUID b f f 8022 8022 16 8151 8150 rowid_ne neqsel neqjoinsel ));
ORADESCR("not equal");
ORADATA(insert OID = 8152 (  "<"	   PGORCL PGUID b f f 8022 8022 16 8153 8155 rowid_lt scalarltsel scalarltjoinsel ));
ORADESCR("less than");
ORADATA(insert OID = 8153 (  ">"	   PGORCL PGUID b f f 8022 8022 16 8152 8154 rowid_gt scalargtsel scalargtjoinsel ));
ORADESCR("greater than");
ORADATA(insert OID = 8154 (  "<="	   PGORCL PGUID b f f 8022 8022 16 8155 8153 rowid_le scalarltsel scalarltjoinsel ));
ORADESCR("less than or equal");
ORADATA(insert OID = 8155 (  ">="	   PGORCL PGUID b f f 8022 8022 16 8154 8152 rowid_ge scalargtsel scalargtjoinsel ));
ORADESCR("greater than or equal");


/*
 * V3: Revert this since it broke PG default behavior, all || concat logic will
 * automatically pick OperFunc 2779 above. We should REFACTOR the coerce design
 * when merging from V5, maybe.
 */
//#ifdef _PG_ORCL_
//DATA(insert OID = ??? (  "||"	   PGORCL PGUID b f f	1700	1700	25	 0 0 numericcat - - ));
//DESCR("concatenate two numeric as a string");
//#endif
ORADATA(insert OID = 4703 (  "||" PGORCL PGUID b f f 1700 1700 25 0 0 numericcat - - ));
ORADESCR("concatenate two numeric as a string");

/* raw operator */
ORADATA(insert OID = 4833 ( "=" PGORCL PGUID b t t 4831 4831 16 4833 4834 raweq eqsel eqjoinsel));
ORADESCR("equal");
ORADATA(insert OID = 4834 ( "<>" PGORCL PGUID b f f 4831 4831 16 4834 4833 rawne neqsel neqjoinsel));
ORADESCR("not equal");
ORADATA(insert OID = 4835 ( "<" PGORCL PGUID b f f 4831 4831 16 4837 4838 rawlt scalarltsel scalarltjoinsel));
ORADESCR("less than");
ORADATA(insert OID = 4836 ( "<=" PGORCL PGUID b f f 4831 4831 16 4838 4837 rawle scalarltsel scalarltjoinsel));
ORADESCR("less than or equal");
ORADATA(insert OID = 4837 ( ">" PGORCL PGUID b f f 4831 4831 16 4835 4836 rawgt scalargtsel scalargtjoinsel));
ORADESCR("greater than");
ORADATA(insert OID = 4838 ( ">=" PGORCL PGUID b f f 4831 4831 16 4836 4835 rawge scalargtsel scalargtjoinsel));
ORADESCR("greater than or equal");
ORADATA(insert OID = 4839 ( "~~" PGORCL PGUID b f f 4831 4831 16 0 4840 rawlike likesel likejoinsel));
ORADESCR("matches LIKE expression");
ORADATA(insert OID = 4840 ( "!~~" PGORCL PGUID b f f 4831 4831 16 0 4839 rawnlike nlikesel nlikejoinsel));
ORADESCR("does not match LIKE expression");
ORADATA(insert OID = 5077 (  "||" PGORCL PGUID b f f 4831 4831	4831 0	0	 rawcat - - ));
ORADESCR("concatenate");
/* urowid operators */
ORADATA(insert OID = 8156 (  "="	   PGORCL PGUID b t t 8004 8004 16 8156 8157 urowid_eq eqsel eqjoinsel ));
ORADESCR("equal");
ORADATA(insert OID = 8157 (  "<>"	   PGORCL PGUID b f f 8004 8004 16 8157 8156 urowid_ne neqsel neqjoinsel ));
ORADESCR("not equal");
ORADATA(insert OID = 8189 (  "<"	   PGORCL PGUID b f f 8004 8004 16 8190 8196 urowid_lt scalarltsel scalarltjoinsel ));
ORADESCR("less than");
ORADATA(insert OID = 8190 (  ">"	   PGORCL PGUID b f f 8004 8004 16 8189 8191 urowid_gt scalargtsel scalargtjoinsel ));
ORADESCR("greater than");
ORADATA(insert OID = 8191 (  "<="	   PGORCL PGUID b f f 8004 8004 16 8196 8190 urowid_le scalarlesel scalarlejoinsel ));
ORADESCR("less than or equal");
ORADATA(insert OID = 8196 (  ">="	   PGORCL PGUID b f f 8004 8004 16 8191 8189 urowid_ge scalargesel scalargejoinsel ));
ORADESCR("greater than or equal");
