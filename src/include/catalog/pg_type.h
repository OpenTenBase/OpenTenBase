...
/* Numeric bigint128*/
DATA(insert OID = 9301 ( numericd	   PGNSP PGUID 18 f b N f t \054 0	0 9302 numericd_in numericd_out numericd_recv numericd_send numerictypmodin numerictypmodout - s p f 0 -1 0 0 _null_ _null_ _null_ ));
DESCR("numeric as bigint with scale");
#define NUMERICDOID 9301
DATA(insert OID = 9302 (  _numericd	 PGNSP PGUID -1 f b A f t \054 0	9301 0 array_in array_out array_recv array_send numerictypmodin numerictypmodout array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));

/* Numeric bigint64*/
DATA(insert OID = 9351 ( numericf	   PGNSP PGUID 10 f b N f t \054 0	0 9352 numericf_in numericf_out numericf_recv numericf_send numerictypmodin numerictypmodout - s p f 0 -1 0 0 _null_ _null_ _null_ ));
DESCR("numeric as bigint with scale");
#define NUMERICFOID 9351
DATA(insert OID = 9352 (  _numericf	 PGNSP PGUID -1 f b A f t \054 0	9351 0 array_in array_out array_recv array_send numerictypmodin numerictypmodout array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
...
DATA(insert OID = 4172 ( jsonpath		PGNSP PGUID -1 f b U f t \054 0 0 4173 jsonpath_in jsonpath_out jsonpath_recv jsonpath_send - - - i x f 0 -1 0 0 _null_ _null_ _null_ ));
#define JSONPATHOID 4172
DATA(insert OID = 4173 ( _jsonpath		PGNSP PGUID -1 f b A f t \054 0 4172 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
#define JSONPATHARRAYOID 4173

#ifdef _MLS_
DATA(insert OID = 8015 ( clsitem          PGNSP PGUID  4 f b U f t \054 0 0 8016 clsitemin clsitemout - - - - - i p f 0 -1 0 0 _null_ _null_ _null_ ));
DESCR("Cube Label Security Item");
#define CLSITEM_OID       8015
DATA(insert OID = 8016 (  _clsitem        PGNSP PGUID -1 f b A f t \054 0 8015 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
#define CLSITEM_ARRAY_OID 8016
#endif


#ifdef _PG_ORCL_
ORADATA(insert OID = 8024 ( xmltype    PGORCL PGUID -1 f b U f t \054 0 0 8025 xmltype_in xmltype_out xmltype_recv xmltype_send - - - i x f 0 -1 0 100 _null_ _null_ _null_ ));
ORADESCR("OPENTENBASE_ORA XML content");
#define XMLTYPEOID 8024
ORADATA(insert OID = 8025 ( _xmltype   PGORCL PGUID -1 f b A f t \054 0 8024 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 100 _null_ _null_ _null_ ));
/*
 * Internal type for UDT of plpgsql.
 */
ORADATA(insert OID = 3450 ( pludt		PGNSP PGUID  -1 f p P f t \054 0 0 0 pludt_in pludt_out - - - - - i p f 0 -1 0 0 _null_ _null_ _null_ ));
#define PLUDTOID		3450

/* varchar2 */
ORADATA(insert OID = 8026 ( varchar2		PGORCL PGUID -1 f b S f t \054 0 0 8028 varchar2in varchar2out varchar2recv varchar2send varchar2typmodin varchar2typmodout - i x f 0 -1 0 100 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora varchar2(length)");
#define VARCHAR2OID 8026
/* nvarchar2 */
ORADATA(insert OID = 8027 ( nvarchar2		PGORCL PGUID -1 f b S f t \054 0 0 8029 nvarchar2in nvarchar2out nvarchar2recv nvarchar2send nvarchar2typmodin nvarchar2typmodout - i x f 0 -1 0 100 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora nvarchar2(length)");
#define NVARCHAR2OID 8027
/* varchar2 array */
ORADATA(insert OID = 8028 ( _varchar2		PGORCL PGUID -1 f b A f t \054 0 8026 0 array_in array_out array_recv array_send varchar2typmodin varchar2typmodout array_typanalyze i x f 0 -1 0 100 _null_ _null_ _null_ ));
#define VARCHAR2ARRAYOID 8028
/* nvarchar2 array */
ORADATA(insert OID = 8029 ( _nvarchar2		PGORCL PGUID -1 f b A f t \054 0 8027 0 array_in array_out array_recv array_send nvarchar2typmodin nvarchar2typmodout array_typanalyze i x f 0 -1 0 100 _null_ _null_ _null_ ));
#define NVARCHAR2ARRAYOID 8029

ORADATA(insert OID = 8186 (long	PGORCL PGUID -1 f b S f t \054 0	0 8187 longin longout longrecv longsend - - - i x f 0 -1 0 100 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora long");
#define LONGOID			8186
ORADATA(insert OID = 8187 ( _long	PGORCL PGUID -1 f b A f t \054 0	8186 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 100 _null_ _null_ _null_ ));
#define LONGARROID		8187

ORADATA(insert OID = 8022 (rowid		   PGORCL PGUID	16 f b S f t \054 0	0 8023 rowid_in rowid_out rowid_recv rowid_send - - - s p f 0 -1 0 0 _null_ _null_ _null_ ));
ORADESCR("physical location of tuple, like opentenbase_ora's rowid");
#define RIDOID 8022
ORADATA(insert OID = 8023 (_rowid	    PGORCL PGUID	-1 f b A f t \054 0	8022 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
ORADESCR("array to physical location of tuple, like opentenbase_ora's rowid");
#define RIDVECTOROID 8023

ORADATA(insert OID = 8004 ( urowid		   PGORCL PGUID -1 f b S f t \054 0	0 8005 urowid_in urowid_out urowid_recv urowid_send varchartypmodin varchartypmodout - i x f 0 -1 0 100 _null_ _null_ _null_ ));
ORADESCR("like opentenbase_ora universal rowid");
#define URIDOID 8004
ORADATA(insert OID = 8005 ( _urowid		   PGORCL PGUID	-1 f b A f t \054 0	8004 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
ORADESCR("the array of universal rowid");
#define URIDARROID 8005

ORADATA(insert OID = 4831 ( raw		PGORCL PGUID -1 f b U f t \054 0	0  4832 rawin rawout rawrecv rawsend rawmodin rawmodout - i x f 0 -1 0 0 _null_ _null_ _null_ ));
ORADESCR("variable-length string, binary values escaped");
#define RAWOID  4831
ORADATA(insert OID = 4832 ( _raw		PGORCL PGUID -1 f b A f t \054 0 4831 0 array_in array_out array_recv array_send rawmodin rawmodout array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
ORADATA(insert OID = 5504 ( lraw		PGORCL PGUID -1 f b U f t \054 0	0  5505 rawin rawout rawrecv rawsend - - - i x f 0 -1 0 0 _null_ _null_ _null_ ));
ORADESCR("variable-length string, binary values escaped");
#define LRAWOID  5504
ORADATA(insert OID = 5505 ( _lraw		PGORCL PGUID -1 f b A f t \054 0 5504 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));

/* blob and clob type */
DATA(insert OID = 8762 ( blob	PGORCL PGUID -1 f b U f t \054 0  0 8763 byteain byteaout bytearecv byteasend - - - i x f 0 -1 0 0 _null_ _null_ _null_ ));
DESCR("blob type inherits from bytea type");
#define BLOBOID 8762
DATA(insert OID = 8763 ( _blob	PGORCL PGUID -1 f b A f t \054 0  8762 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
#define BLOBARRAYOID 8763
DATA(insert OID = 8764 ( clob	PGORCL PGUID -1 f b S f t \054 0  0 8765 textin textout textrecv textsend - - - i x f 0 -1 0 100 _null_ _null_ _null_ ));
DESCR("clob type inherits from text type");
#define CLOBOID 8764
DATA(insert OID = 8765 ( _clob	PGORCL PGUID -1 f b A f t \054 0 8764 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 100 _null_ _null_ _null_ ));
#define CLOBARRAYOID 8765

ORADATA(insert OID = 8291 ( nclob		PGORCL PGUID -1 f b S f t \054 0 0 8349 textin textout textrecv textsend - - - i x f 0 -1 0 100 _null_ _null_ _null_ ));
ORADESCR("nclob type");
#define NCLOBOID	8291
ORADATA(insert OID = 8349 ( _nclob		PGORCL PGUID -1 f b A f t \054 0 8291 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 100 _null_ _null_ _null_ ));
#define NCLOBARRAYOID 8349
ORADATA(insert OID = 8999 ( bfile		PGORCL PGUID -2 f b S f t \054 0 0 9000 bfilein bfileout bfile_recv bfile_send - - - c p f 0 -1 0 0 _null_ _null_ _null_ ));
ORADESCR("opentenbase_ora bfile");
#define BFILEOID		8999
ORADATA(insert OID = 9000 ( _bfile		PGORCL PGUID -1 f b A f t \054 0 8999 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
...
#define IS_VARSTRING_TYPE(_oid) ((_oid) == TEXTOID || (_oid) == VARCHAROID || \
						(_oid) == VARCHAR2OID || (_oid) == NVARCHAR2OID || \
						(_oid) == LONGOID)
#define IS_CHAR_TYPE(_oid) ((_oid) == CHAROID || (_oid) == BPCHAROID)
#define IS_STRING_TYPE(_oid) (IS_VARSTRING_TYPE(_oid) || IS_CHAR_TYPE(_oid))
#ifdef _PG_ORCL_
#define PLS_INTEGER_NAME "PLS_INTEGER"
#define SIMPLE_INTEGER_NAME "SIMPLE_INTEGER"
#endif
#endif							/* PG_TYPE_H */
