...
DATA(insert (	405		bit_ops				PGNSP PGUID  5068 1560 t 0 ));
...
/* Numericd */
DATA(insert ( 403		numericd_ops 		PGNSP PGUID 9088 9301 t 0 ));
DATA(insert ( 405		numericd_ops		PGNSP PGUID 9089 9301 t 0 ));

/* Numericf */
DATA(insert ( 403		numericf_ops 		PGNSP PGUID 9091 9351 t 0 ));
DATA(insert ( 405		numericf_ops		PGNSP PGUID 9092 9351 t 0 ));
...
DATA(insert (	405		varbit_ops			PGNSP PGUID 5069 1562 t 0 ));
...
#ifdef _PG_ORCL_
ORADATA(insert (	403		rowid_ops			PGNSP PGUID 8145  8022 t 0 ));
ORADATA(insert (	405		rowid_ops			PGNSP PGUID 8146  8022 t 0 ));

/* raw operator classes */
ORADATA(insert ( 403        raw_ops             PGORCL PGUID 4763  4831 t 0 ));
ORADATA(insert ( 405        raw_ops             PGORCL PGUID 4764 4831 t 0 ));
#endif

/* urowid operator classes */
ORADATA(insert (	403		urowid_ops			PGNSP PGUID 8147  8004 t 0 ));
ORADATA(insert (	405		urowid_ops			PGNSP PGUID 8007  8004 t 0 ));
#endif							/* PG_OPCLASS_H */
