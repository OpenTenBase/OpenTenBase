...
/* numericd opertators */
DATA(insert (	9088   9301 9301 1 s	9402 403 0 ));
DATA(insert (	9088   9301 9301 2 s	9403 403 0 ));
DATA(insert (	9088   9301 9301 3 s	9400 403 0 ));
DATA(insert (	9088   9301 9301 4 s	9405 403 0 ));
DATA(insert (	9088   9301 9301 5 s	9404 403 0 ));

/* numericf opertators */
DATA(insert (	9091   9351 9351 1 s	9452 403 0 ));
DATA(insert (	9091   9351 9351 2 s	9453 403 0 ));
DATA(insert (	9091   9351 9351 3 s	9450 403 0 ));
DATA(insert (	9091   9351 9351 4 s	9455 403 0 ));
DATA(insert (	9091   9351 9351 5 s	9454 403 0 ));
...
/* numericd_ops */
DATA(insert (	9089   9301 9301 1 s 9400 405 0 ));
/* numericf_ops */
DATA(insert (	9092   9351 9351 1 s 9450 405 0 ));
...
DATA(insert (	4036   3802 4172 15 s 4012 2742 0 ));
DATA(insert (	4036   3802 4172 16 s 4013 2742 0 ));

/*
 * GIN jsonb_path_ops
 */
DATA(insert (	4037   3802 3802 7 s 3246 2742 0 ));
DATA(insert (	4037   3802 4172 15 s 4012 2742 0 ));
DATA(insert (	4037   3802 4172 16 s 4013 2742 0 ));
...
/* hash bit and varbit */
DATA(insert (  5068   1560 1560 1 s 1784 405 0 ));
DATA(insert (  5069   1562 1562 1 s 1804 405 0 ));

/* btree rowid_ops */
ORADATA(insert (	8145  8022 8022 1 s 8152    403 0 ));
ORADATA(insert (	8145  8022 8022 2 s 8154    403 0 ));
ORADATA(insert (	8145  8022 8022 3 s 8150	403 0 ));
ORADATA(insert (	8145  8022 8022 4 s 8155	403 0 ));
ORADATA(insert (	8145  8022 8022 5 s 8153	403 0 ));
/* hash rowid_ops */
ORADATA(insert (	8146  8022 8022 1 s 8150	405 0 ));

/* btree urowid_ops */
ORADATA(insert (	8147  8004 8004 1 s 8189    403 0 ));
ORADATA(insert (	8147  8004 8004 2 s 8191    403 0 ));
ORADATA(insert (	8147  8004 8004 3 s 8156	403 0 ));
ORADATA(insert (	8147  8004 8004 4 s 8196	403 0 ));
ORADATA(insert (	8147  8004 8004 5 s 8190	403 0 ));
/* hash urowid_ops */
ORADATA(insert (	8007  8004 8004 1 s 8156	405 0 ));

/* btree raw_ops */
ORADATA(insert ( 4763 4831 4831 1 s 4835 403 0 ));
ORADATA(insert ( 4763 4831 4831 2 s 4836 403 0 ));
ORADATA(insert ( 4763 4831 4831 3 s 4833 403 0 ));
ORADATA(insert ( 4763 4831 4831 4 s 4838 403 0 ));
ORADATA(insert ( 4763 4831 4831 5 s 4837 403 0 ));

/* hash raw_ops */
ORADATA(insert ( 4764 4831 4831 1 s 4833 405 0 ));
