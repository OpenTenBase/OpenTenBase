 ...
 * or groups are explicitly stored in pg_shdepend.
 */

extern bool GroupHasRelations(Oid group);
extern void RecordGroupDependency(Oid relId, Oid group);
extern void ClearGroupDependency(Oid relId, Oid group);
