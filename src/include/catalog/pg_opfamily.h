...
DATA(insert OID = 9088 (	403		numericd_ops	PGNSP PGUID ));
DATA(insert OID = 9089 (	405		numericd_ops	PGNSP PGUID ));
DATA(insert OID = 9090 (	3580	numericd_minmax_ops PGNSP PGUID ));
DATA(insert OID = 9091 (	403		numericf_ops	PGNSP PGUID ));
DATA(insert OID = 9092 (	405		numericf_ops	PGNSP PGUID ));
DATA(insert OID = 9093 (	3580	numericf_minmax_ops PGNSP PGUID ));
...
DATA(insert OID = 5068 (	405		bit_ops		PGNSP PGUID ));
DATA(insert OID = 5069 (	405		varbit_ops		PGNSP PGUID ));

#ifdef _PG_ORCL_
ORADATA(insert OID = 8145 (	403	    rowid_ops		        PGNSP PGUID ));
ORADATA(insert OID = 8146 (	405	    rowid_ops		        PGNSP PGUID ));
ORADATA(insert OID = 4763 (	403		raw_ops					PGORCL PGUID));
ORADATA(insert OID = 4764 (	405		raw_ops					PGORCL PGUID));
ORADATA(insert OID = 8805 (	405	    date_ops_orcl			PGORCL PGUID ));
ORADATA(insert OID = 8828 (	405	    timestamp_ops_orcl		PGORCL PGUID ));
ORADATA(insert OID = 8851 (	405	    timestampltz_ops_orcl	PGORCL PGUID ));
ORADATA(insert OID = 8874 (	405	    timestamptz_ops_orcl	PGORCL PGUID ));
ORADATA(insert OID = 8600 (	403		datetime_ops_orcl		PGORCL PGUID ));
// TODO: datetime_minmax_ops_orcl
#endif
/* urowid */
ORADATA(insert OID = 8147 (	403	    urowid_bt_ops		        PGNSP PGUID ));
ORADATA(insert OID = 8007 (	405	    urowid_hash_ops		        PGNSP PGUID ));
