...
#define FIELDNO_FUNCTIONCALLINFODATA_ARGNULL 7
	...
	int32		argtypmod[FUNC_MAX_ARGS]; /* T if arg[i] is actually NULL */
	int			typmod;
...
#ifdef _PG_ORCL_
extern void fmgr_info_withfuncs(Oid functionId, FmgrInfo *finfo, fmNodePtr expr);
extern void fmgr_info_cxt_withfuncs(Oid functionId, FmgrInfo *finfo, fmNodePtr expr,
										MemoryContext mcxt);
#endif
 ...
 *
 * True is returned by default when the range of arguments is exceeded.
 */
#define PG_ARGISNULL(n) ((PG_NARGS() > n) ? fcinfo->argnull[n] : true)
...
#define PG_FREE_DATUM_IF_COPY(ptr,data) \
	do { \
		if ((Pointer) (ptr) != DatumGetPointer(data)) \
			pfree(ptr); \
	} while (0)
...
#define PG_GETARG_INT64_0_IF_EXISTS(_n) \
	(PG_NARGS() > (_n) ? PG_GETARG_INT64(_n) : 0)
#define PG_GETARG_INT64_0_IF_NULL(_n) \
	(PG_ARGISNULL(_n) ? 0 : PG_GETARG_INT64_0_IF_EXISTS(_n))

#define PG_GETARG_INT64_1_IF_EXISTS(_n) \
	(PG_NARGS() > (_n) ? PG_GETARG_INT64(_n) : 1)
#define PG_GETARG_INT64_1_IF_NULL(_n) \
	(PG_ARGISNULL(_n) ? 1 : PG_GETARG_INT64_1_IF_EXISTS(_n))

#define PG_GETARG_BYTEA_P_IF_EXISTS(_n) \
	(PG_ARGISNULL(_n) ? NULL : PG_GETARG_BYTEA_P(_n))
#endif
...
#define PG_GETARG_NAME_IF_EXISTS(_n) \
	(PG_NARGS() > (_n) ? PG_GETARG_NAME(_n) : 0)
#define PG_GETARG_NAME_IF_NULL(_n)\
	(PG_ARGISNULL(_n) ? NULL : PG_GETARG_NAME_IF_EXISTS(_n))
...
#define PG_GETARG_BLOB_P(n)			PG_GETARG_BYTEA_P(n)
#define PG_GETARG_CLOB_P(n)			PG_GETARG_TEXT_P(n)
#define PG_GETARG_BFILE(n)			PG_GETARG_CSTRING(n)

#define PG_GET_FNCOLLACTION		(fcinfo->fncollation)
#define PG_GET_FNFLINFO			(fcinfo->flinfo)
#define PG_GET_FNARGSNUM		(fcinfo->nargs)
...
#define PG_RETURN_BLOB_P(x)   PG_RETURN_POINTER(x)
#define PG_RETURN_CLOB_P(x)    PG_RETURN_POINTER(x)
#define PG_RETURN_BFILE_P(x)   PG_RETURN_POINTER(x)
#define PG_RETURN_INT128(x)	PG_RETURN_POINTER(x)
 ...
 */
extern Datum DirectFunctionCall0Coll(PGFunction func, Oid collation);
...
extern Datum DirectFunctionCall1CollWithSubTran(PGFunction func, Oid collation,
						Datum arg1, bool *hasError);
extern Datum DirectFunctionCall2CollWithSubTran(PGFunction func, Oid collation,
						Datum arg1, Datum arg2, bool *hasError);
extern Datum DirectFunctionCall3CollWithSubTran(PGFunction func, Oid collation,
						Datum arg1, Datum arg2, Datum arg3, bool *hasError);
extern Datum DirectFunctionCall4CollWithSubTran(PGFunction func, Oid collation,
						Datum arg1, Datum arg2, Datum arg3, Datum arg4, bool *hasError);
extern Datum DirectFunctionCall5CollWithSubTran(PGFunction func, Oid collation,
						Datum arg1, Datum arg2, Datum arg3, Datum arg4, Datum arg5,
						bool *hasError);
...
#define DirectFunctionCall1WithSubTran(func, arg1, hasErr) \
	DirectFunctionCall1CollWithSubTran(func, InvalidOid, arg1, hasErr)
#define DirectFunctionCall2WithSubTran(func, arg1, arg2, hasErr) \
	DirectFunctionCall2CollWithSubTran(func, InvalidOid, arg1, arg2, hasErr)
#define DirectFunctionCall3WithSubTran(func, arg1, arg2, arg3, hasErr) \
	DirectFunctionCall3CollWithSubTran(func, InvalidOid, arg1, arg2, arg3, hasErr)
#define DirectFunctionCall4WithSubTran(func, arg1, arg2, arg3, arg4, hasErr) \
	DirectFunctionCall4CollWithSubTran(func, InvalidOid, arg1, arg2, arg3, arg4, hasErr)
#define DirectFunctionCall5WithSubTran(func, arg1, arg2, arg3, arg4, arg5, hasErr) \
	DirectFunctionCall5CollWithSubTran(func, InvalidOid, arg1, arg2, arg3, arg4, arg5, hasErr)

extern Datum DirectCall1(bool *_is_retnull, PGFunction func, Oid collation, Datum arg1);
extern Datum DirectCall2(bool *_is_retnull, PGFunction func, Oid collation, Datum arg1, Datum arg2);
extern Datum DirectCall3(bool *_is_retnull, PGFunction func, Oid collation, Datum arg1, Datum arg2, Datum arg3);
...
#define CHECK_RETNULL_DIRECTCALL1(func, arg1) DirectCall1(&_is_retnull, func, InvalidOid, arg1)
#define CHECK_RETNULL_DIRECTCALL2(func, arg1, arg2)                                           \
	DirectCall2(&_is_retnull, func, InvalidOid, arg1, arg2)
#define CHECK_RETNULL_DIRECTCALL3(func, arg1, arg2, arg3)                                     \
	DirectCall3(&_is_retnull, func, InvalidOid, arg1, arg2, arg3)
#define CHECK_RETNULL_INIT()                                                                       \
	Datum _datum;                                                                                  \
	bool  _is_retnull = false
...
extern Datum XmlInputFunctionCall(FmgrInfo *flinfo, char *str,
								  Oid typioparam, int32 typmod, bool need_check);
/*
 * Routines in fmgr.c
 */
...
#ifdef _PG_ORCL_
extern bool get_fn_from_withfunc(fmNodePtr expr);
extern bool is_local_func_proc(fmNodePtr expr);
extern int get_fnid_from_withfunc(fmNodePtr expr);
extern bool is_local_function(FmgrInfo *flinfo);
#endif
