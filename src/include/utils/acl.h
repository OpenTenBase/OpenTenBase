...
#define ACL_ALL_RIGHTS_STR	"arwdDxtXUCTcm"
...
typedef enum AclObjectKind
{
	...
	ACL_KIND_SYNONYM,			/* pg_synonym */
	ACL_KIND_SPMPLAN,			/* pg_spm_plan */
	ACL_KIND_SPMPLAN_HISTORY,	/* pg_spm_plan_history */
...
extern bool pg_synonym_ownercheck(Oid syn_oid, Oid roleid, List *name);
...
#ifdef _PG_ORCL_
extern bool has_createprofile_privilege(Oid roleid);
#endif
