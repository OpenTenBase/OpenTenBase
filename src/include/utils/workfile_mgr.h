...
typedef struct workfile_set
{
	...
	/* fragment in which the spilling operator was */
	int			fid;
...
extern int	pg_workfile_limit_per_datanode;
extern int	pg_workfile_limit_per_query;
extern int	pg_workfile_limit_files_per_query;
...
extern Datum pg_workfile_mgr_cache_entries_internal(PG_FUNCTION_ARGS);
