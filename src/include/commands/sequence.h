...
typedef struct FormData_pg_ora_sequence_data
{
	int64		log_cnt;
	bool		is_called;
	NumericData	last_value;
} FormData_pg_ora_sequence_data;

typedef FormData_pg_ora_sequence_data *Form_pg_ora_sequence_data;
...
#define ORA_SEQ_COL_LOG			1
#define ORA_SEQ_COL_CALLED		2
#define ORA_SEQ_COL_LASTVAL		3
...
extern int128 nextval_internal(Oid relid, bool check_permissions);
...
#ifdef _PG_ORCL_
extern bool IsLocalSequence(Oid relid);
extern int128 nextval_local(Oid relid, bool check_permissions);
#endif
