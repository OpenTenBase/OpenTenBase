...
extern PartitionPruneInfo *make_partition_pruneinfo(PlannerInfo *root, RelOptInfo *parentrel,
                                                    List *subpaths, List *partitioned_rels,
                                                    List *prunequal);
extern PartitionPruneInfo *make_partition_iter_pruneinfo(PlannerInfo *root, RelOptInfo *parentrel,
