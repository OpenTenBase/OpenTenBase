...
/* INT64_MIN string */
extern const char *int64_min_str;
/* INT128_MIN string */
extern const int int128_min_str_length;
extern const char *int128_min_str;
 ...
 */
static inline bool
pg_add_s128_overflow(int128 a, int128 b, int128 *result)
{
#if defined(HAVE__BUILTIN_OP_OVERFLOW)
	return __builtin_add_overflow(a, b, result);
#else
	if ((a > 0 && b > 0 && a > INT128_MAX - b) ||
		(a < 0 && b < 0 && a < INT128_MIN - b))
		return true;
	*result = a + b;
	return false;
#endif
 ...
 */
static inline bool
pg_sub_s128_overflow(int128 a, int128 b, int128 *result)
{
#if defined(HAVE__BUILTIN_OP_OVERFLOW)
	return __builtin_sub_overflow(a, b, result);
#else
	if ((a < 0 && b > 0 && a < INT128_MIN + b) ||
		(a > 0 && b < 0 && a > INT128_MAX + b))
		return true;
	*result = a - b;
	return false;
#endif
 ...
 */
static inline bool
pg_mul_s128_overflow(int128 a, int128 b, int128 *result)
{
#if defined(HAVE__BUILTIN_OP_OVERFLOW)
	return __builtin_mul_overflow(a, b, result);
#else
	 ...
	 *
	 */
	if ((a > PG_INT64_MAX || a < PG_INT64_MIN ||
		 b > PG_INT64_MAX || b < PG_INT64_MIN) &&
		a != 0 && a != 1 && b != 0 && b != 1 &&
		((a > 0 && b > 0 && a > INT128_MAX / b) ||
		 (a > 0 && b < 0 && b < INT128_MIN / a) ||
		 (a < 0 && b > 0 && a < INT128_MIN / b) ||
		 (a < 0 && b < 0 && a < INT128_MAX / b)))
	{
		return true;
