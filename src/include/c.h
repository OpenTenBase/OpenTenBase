 ...
 */
#ifdef _PG_ORCL_
typedef uint64 RowId;
#define InvalidRowId ((RowId) 0)
#define RowIdIsValid(rowid)  ((bool) ((rowid) != InvalidRowId))
#endif
...
#define SIMDALIGN(LEN)		    TYPEALIGN(ALIGNOF_SIMD, (LEN))

#define POINTERALIGN(PTR, LEN)       ((char*)PTR + (LEN - ((uint64)PTR) % LEN) % LEN)
 ...
 * Sunpro: https://docs.opentenbase_ora.com/cd/E18659_01/html/821-1384/gjzke.html
...
/* input argument: function reads it */
#define _in_
/* output argument: function writes it */
#define _out_    
/* both in and out argument: function r/w it */
#define __inout  
