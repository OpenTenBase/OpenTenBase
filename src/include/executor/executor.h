...
#define EXEC_FLAG_EAGER_FREE	0x0200
#define EXEC_FLAG_IDLE_LEADER	0x0400	/* parallel leader but not participate */
#define EXEC_FLAG_RETURNING		0x0800	/* returning tuples */
#endif
#ifdef __OPENTENBASE__
#ifdef _PG_ORCL_
#define EXEC_FLAG_WITH_ROWID	0x2000	/* force OIDs in returned tuples */
#define EXEC_FLAG_WITHOUT_ROWID	0x4000	/* force no OIDs in returned tuples */
#endif
#define EXEC_FLAG_WITH_DESC     0x8000
#endif
...
extern HeapTuple
EvalPlanQualFetchWithTimeout(EState *estate, Relation relation, int lockmode,
				  LockWaitPolicy wait_policy, int wait_timeout,
				  ItemPointer tid, TransactionId priorXmax);
...
#endif
#ifdef __OPENTENBASE__
extern bool ExecDisconnectNode(PlanState *node);
#endif
#ifdef __OPENTENBASE_C__
extern bool ExecEagerFreeNode(PlanState *node);
extern bool ExecEagerFreeNodeSkipSublink(PlanState *node);
#endif
...
extern ProjectionInfo *ExecBuildProjectionInfo(List *targetList,
											   ...
											   PlanState *parent,
											   TupleDesc inputDesc);
extern ProjectionInfo *ExecBuildUpdateProjection(List *subTargetList, bool evalTargetList,
                                                 List *targetColnos, TupleDesc relDesc,
...
#ifdef __OPENTENBASE_C__
extern bool contain_system_var(Node *node);
extern ProjectionInfo *ExecBuildRIDProjectionInfo(ProjectionInfo *projInfo,
						List *targetRelids,
						TupleTableSlot *slot,
						PlanState *parent);
#endif
...
ExecProject(ProjectionInfo *projInfo)
{
	...
	bool		isnull;
#ifdef __OPENTENBASE_C__
	ExprState  *rid_state = &projInfo->pi_rid_state;
#endif
...
#ifdef __OPENTENBASE_C__
	if(projInfo->pi_rid_projection)
		(void) ExecEvalExprSwitchContext(rid_state, econtext, &isnull);	
#endif
	/*
...
#ifdef _PG_ORCL_
extern TupleDesc ExecTypeFromTLWithRID(List *targetList, bool hasoid,
								bool hasrowid, bool incl_nodeid);
extern TupleDesc ExecCleanTypeFromTLWithRID(List *targetList, bool hasoid,
								bool hasrowid, bool incl_nodeid);
#endif
...
extern void EstateAddItable(EState *estate, Oid oid);
...
extern List *ExecInsertIndexTuples(TupleTableSlot *slot, ItemPointer tupleid, EState *estate,
                                   bool noDupErr, bool *specConflict, List *arbiterIndexes);
extern bool
...
extern bool ExecCheckIndexConstraints(TupleTableSlot *slot, EState *estate,
						  ItemPointer conflictTid, List *arbiterIndexes, bool *isStash);
...
extern void ExecSimpleRelationBatchInsert(EState *estate, ApplyChangeItem **change_item,
                                          unsigned int n_diff_changes, TupleTableSlot **slots);
