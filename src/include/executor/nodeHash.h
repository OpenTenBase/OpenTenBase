...
extern HashJoinTuple ExecParallelHashFirstTuple(HashJoinTable table,
						   int bucketno);
extern HashJoinTuple ExecParallelHashNextTuple(HashJoinTable table,
						  HashJoinTuple tuple);

extern void HashFuncAssign(Oid functionId, FmgrInfo *finfo);
#endif
