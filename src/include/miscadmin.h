...
extern PGDLLIMPORT volatile bool SubThreadErrorPending;
...
extern PGDLLIMPORT volatile bool PersistentConnectionsTimeoutPending;
extern PGDLLIMPORT volatile sig_atomic_t ConfigReloadPending;
extern PGDLLIMPORT volatile sig_atomic_t LogMemoryContextPending;
extern PGDLLIMPORT volatile sig_atomic_t AchieveMemTrackInfoPending;
extern PGDLLIMPORT volatile sig_atomic_t GetMemoryContextDetailPending;
extern PGDLLIMPORT volatile sig_atomic_t GetMemoryDetailPending;

extern volatile bool ClientConnectionLost;

/* SyncRepCanceled use to mark whether synchronous replication is canceled */
extern volatile bool SyncRepCanceled;
...
extern __thread PGDLLIMPORT volatile int PoolerReloadHoldoffCount;
...
extern int pg_workfile_max_entries;
...
extern PGDLLIMPORT pthread_t MyMainThreadId;
extern __thread pthread_t MyLocalThreadId;
...
#endif
#ifdef __OPENTENBASE_C__
extern PGDLLIMPORT int ColNBuffers;		/* To be removed, for compatibility. */
extern PGDLLIMPORT bool IsProcCrash;
extern PGDLLIMPORT bool enable_eager_free;
#endif
...
extern PGDLLIMPORT NameData MyDatabaseName;
 ...
 *	USE_SQL_DATES specifies opentenbase_ora/Ingres-compliant format
...
extern PGDLLIMPORT int work_mem_limit_multiplier;
extern PGDLLIMPORT double hash_mem_multiplier;
extern PGDLLIMPORT int maintenance_work_mem;
extern PGDLLIMPORT int fn_recv_work_mem;

extern bool IsInplaceUpgrade;
extern bool GetSystemOid;
extern const uint32 GRAND_VERSION_NUM;
extern volatile uint32 WorkingGrandVersionNum;
extern char *inplace_upgrade_next_system_object_oids;

extern int upgrade_mode;
#define NON_UPGRADE 0
#define INPLACE_UPGRADE 1
...
extern void PreventCommandIfReadOnlySeq(const char *cmdname);
...
extern void InitializeSessionUserId(const char *rolename, Oid useroid, bool reset);
extern void InitializeSessionUserIdStandalone(void);
extern void SetSessionAuthorization(Oid userid, bool is_superuser);
#ifdef XCP
extern void SetGlobalSession(Oid coordid, int coordpid, uint64 timestamp);
extern char *GetClusterUserName(void);
extern char *GetClusterUserNameDirectly(void);
extern char *GetClusterDBName(void);
extern bool NeedLatestTempNamespace(void);
#endif
...
extern bool forwarduser(void); /* given user is forward */
...
typedef enum
{
	...
	CheckerProcess = 0,
	BootstrapProcess,
	OpenTenBaseOraBootstrapProcess,
	StartupProcess,
	BgWriterProcess,
	SpBgWriterProcess,
	CheckpointerProcess,
...
extern int RowLockTimerIdx;
extern bool	SecContextIsSet;
extern AuxProcType MyAuxProcType;

#define AmBootstrapProcess()		(MyAuxProcType == BootstrapProcess)
#define AmOpenTenBaseOraBootstrapProcess()	(MyAuxProcType == OpenTenBaseOraBootstrapProcess)
...
extern void ResetUserAndPgOptions(char *username, char *pgoptions);
...
extern bool pg_cancel_backend_internal(pid_t pid, char *msg);
