...
\c regression_ora
select pg_catalog.timestamptz(pg_catalog.date(pg_catalog.date '2021-10-19'+ceil(2*(10%31)) * interval '1 day'),  
(pg_catalog.timestamp '2021-10-19'+ceil(2*(10%24)) * interval '1 hour')::pg_catalog.time) + 10*interval '1 min' + 10*interval '1 second';


create database odbtz sql mode opentenbase_ora;
\c ODBTZ
--
-- TIMESTAMPTZ
--
