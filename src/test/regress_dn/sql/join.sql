...
CREATE TABLE t1_20231127_join (name TEXT, n INTEGER);
CREATE TABLE t2_20231127_join (name TEXT, n INTEGER);
CREATE TABLE t3_20231127_join (name TEXT, n INTEGER);

INSERT INTO t1_20231127_join VALUES ( 'bb', 11 );
INSERT INTO t2_20231127_join VALUES ( 'bb', 12 );
INSERT INTO t2_20231127_join VALUES ( 'cc', 22 );
INSERT INTO t2_20231127_join VALUES ( 'ee', 42 );
INSERT INTO t3_20231127_join VALUES ( 'bb', 13 );
INSERT INTO t3_20231127_join VALUES ( 'cc', 23 );
INSERT INTO t3_20231127_join VALUES ( 'dd', 33 );

SELECT * FROM t1_20231127_join FULL JOIN t2_20231127_join USING (name) FULL JOIN t3_20231127_join USING (name) 
ORDER BY name,t1_20231127_join.n, t2_20231127_join.n, t3_20231127_join.n;
...
SELECT * FROM
(SELECT * FROM t2_20231127_join) as s2
INNER JOIN
(SELECT * FROM t3_20231127_join) s3
USING (name)
...
SELECT * FROM
(SELECT name, n as s2_n, 2 as s2_2 FROM t2_20231127_join) as s2
NATURAL INNER JOIN
(SELECT name, n as s3_n, 3 as s3_2 FROM t3_20231127_join) s3
...
SELECT * FROM
(SELECT name, n as s1_n, 1 as s1_1 FROM t1_20231127_join) as s1
NATURAL INNER JOIN
(SELECT name, n as s2_n, 2 as s2_2 FROM t2_20231127_join) as s2
NATURAL INNER JOIN
(SELECT name, n as s3_n, 3 as s3_2 FROM t3_20231127_join) s3
...
SELECT * FROM
(SELECT name, n as s1_n FROM t1_20231127_join) as s1
NATURAL FULL JOIN
  (SELECT * FROM
    (SELECT name, n as s2_n FROM t2_20231127_join) as s2
    NATURAL FULL JOIN
    (SELECT name, n as s3_n FROM t3_20231127_join) as s3
  ) ss2
  ORDER BY name, s1_n, s2_n, s3_n;
...
DROP TABLE t1_20231127_join;
DROP TABLE t2_20231127_join;
DROP TABLE t3_20231127_join;
