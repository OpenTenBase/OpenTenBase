...
drop table tt1;
create table tt1(c1 float4, c2 float8, c3 int2, c4 int4, c5 int8);
insert into tt1 values(1, 1, 1, 1, 1);
insert into tt1 values(3, 3, 3, 3, 3);
insert into tt1 values(5, 5, 5, 5, 5);
insert into tt1 values(1.123, 1.123, 3, 3, 3);
insert into tt1 values(3.02, 3.02, 5, 5, 5);
insert into tt1 values(5.02, 5.02, 5, 5, 5);
...
SELECT MEDIAN(val) FROM ORA_BINARY_AGGREGATE_TEST GROUP BY id;
