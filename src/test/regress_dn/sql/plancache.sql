...
drop table if exists t_pro_20220723_1;
create table t_pro_20220723_1(f1 int,f2 int);
create or replace PROCEDURE pro_20220723_16() as
$$
begin 
  select 1;
exception
  when others then 
    call pro_20220723_15();
    rollback;
...
create or replace PROCEDURE pro_20220723_15() as
$$
begin 
  call pro_20220723_14();
  select 1;
exception
  when others then 
    call pro_20220723_14();
...
create or replace PROCEDURE pro_20220723_14() as
$$ 
begin 
  call pro_20220723_13();
  select 1;
exception
  when others then 
    call pro_20220723_13();
...
create or replace PROCEDURE pro_20220723_13() as
$$ 
begin 
 select 1;
exception
...
call pro_20220723_16();
select * from t_pro_20220723_1;
