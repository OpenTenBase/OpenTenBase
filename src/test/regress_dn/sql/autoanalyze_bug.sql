...
set xact_autoanalyze_naptime=0;
...
drop table col_transaction_1_1;
...
-- test width update
create table update_width_test20231211(id int primary key, int_col1 int, int_col2 int, text_col3 varchar2(1024),text_col4 varchar2(1024));

create index on update_width_test20231211(int_col1);
create index on update_width_test20231211(int_col2);
create index on update_width_test20231211(text_col3);
create index on update_width_test20231211(text_col4);

insert into update_width_test20231211
    select n,
        floor(random() * 100000),
        floor(random() * 1000000), 
        floor(random() * 1000000) || repeat('col3_'||n,10) || floor(random() * 1000000),
        floor(random() * 1000000) || repeat('col4_'||n,10) || floor(random() * 1000000) 
        FROM generate_series(1, 30000) AS n;
        
select count(*) from update_width_test20231211;

begin;
update update_width_test20231211 set text_col3 = text_col3||text_col3, text_col4 = text_col4;      
update update_width_test20231211 set text_col3 = text_col3||text_col4, text_col4 = text_col3;    
update update_width_test20231211 set text_col3 = text_col3||text_col3, text_col4 = text_col4;    
explain (costs off) select * from update_width_test20231211;
analyze update_width_test20231211;
explain (costs off) select * from update_width_test20231211;
select count(*) from update_width_test20231211;
commit;

drop table update_width_test20231211;

-- test global temp table
create global temporary table gtt_test20231211(id int primary key, int_col1 int,int_col2 int, text_col3 varchar2(2048),text_col4 varchar2(2048));
begin;
truncate gtt_test20231211;
insert into gtt_test20231211
    select n,
        floor(random() * 100000),
        floor(random() * 1000000),
        floor(random() * 1000000) || repeat('col3_'||n,10) || floor(random() * 1000000),
...
explain select * from gtt_test20231211;
analyze gtt_test20231211;
explain select * from gtt_test20231211;
rollback;
drop table gtt_test20231211;
