...
/*Drop table if exists t_addmonth;
create table t_addmonth(a int, b timestamp);
explain (COSTS OFF)
Insert into t_addmonth values(1, add_months('2021-08-01 16:00'::timestamp without time zone, 1));
explain (COSTS OFF)
Insert into t_addmonth values(1, add_months('2021-08-01 16:00'::timestamp with time zone, 1));
explain (COSTS OFF)
Insert into t_addmonth values(1, add_months('2021-08-01 16:00'::date, 1));
Drop table t_addmonth;*/
