...
create table t_windos_func(a int, b int);
insert into t_windos_func values(1,1);
insert into t_windos_func values(2,2);
insert into t_windos_func values(4,2);
insert into t_windos_func values(4,2);
insert into t_windos_func values(3,3);
explain (costs off) select count(distinct a) over (partition by b) from t_windos_func;
select count(distinct a) over (partition by b) from t_windos_func;
select distinct count(distinct a) over (partition by b) from t_windos_func;
drop table t_windos_func;

create table t_windos_func(a varchar2(100), b varchar2(100));
insert into t_windos_func values('asd', 'aaa');
insert into t_windos_func values('asd', 'zzz');
insert into t_windos_func values('mmm', 'zzz');
insert into t_windos_func values('mmm', 'zzz');
insert into t_windos_func values('zxc', 'xxx');
explain (costs off) select count(distinct a) over (partition by b) from t_windos_func;
select count(distinct a) over (partition by b) from t_windos_func;
select distinct count(distinct a) over (partition by b) from t_windos_func;
drop table t_windos_func;
