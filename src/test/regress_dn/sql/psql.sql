...
-- testcase for bugfix in opentenbase_ora mode */
\c regression_ora
...
\dx+ oraplsql
\dL oraplsql
\dF pg_catalog.simple
\dF+ simple
\dFd simple
\dFp pg_catalog.default
\dFp+ default
\dFt simple
\c regression

-- testcase for \dx+ in opentenbase_ora mode
create database test_dx_20231225 with sql mode opentenbase_ora;
\c test_dx_20231225
\dx+
