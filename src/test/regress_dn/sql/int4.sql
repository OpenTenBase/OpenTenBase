...
-- function to_integer
SELECT TO_INTEGER('1472538951');
SELECT TO_INTEGER('+1472538951');
SELECT TO_INTEGER('-1472538951');
SELECT TO_INTEGER(NULL);
SELECT PG_TYPEOF(TO_INTEGER('1472538951'));

SELECT TO_INTEGER('14725389519');
SELECT TO_INTEGER('x1472538951');
SELECT TO_INTEGER('1472538951a');
SELECT TO_INTEGER('14725p38951');
SELECT TO_INTEGER('');
