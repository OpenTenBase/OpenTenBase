...
select to_date('2022-09-10') percent from dual;
select '123' || '456' percent from dual;
...
select to_date('2022-09-10') case from dual;
select '123' || '456' case from dual;
-- complex query
...
select to_date('2022-09-10') do from dual;
select '123' || '456' do from dual;
-- complex query
...
drop table t_kw_prompt_20230821;
create table t_kw_prompt_20230821 (prompt timestamp with local time zone);
drop table t_kw_prompt_20230821;
...
select max(prompt) from prompt order by id;
