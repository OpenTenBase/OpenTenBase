...
drop sequence if exists seq_test2;
create table table_test (id int, c1 int, c2 varchar2(10), c3 number, c4 character(10));
create SEQUENCE seq_test start with -10 increment by 1 maxvalue 50 minvalue -50 cycle;
create SEQUENCE seq_test2 start with -10 increment by 1 maxvalue 50 minvalue -50 cycle;
select seq_test.nextval from dual;
select seq_test.currval from dual;
select seq_test.nextval, seq_test2.nextval from dual;
select seq_test.nextval, seq_test2.nextval, seq_test.nextval from dual;
select seq_test.nextval, seq_test2.nextval from dual where seq_test2.nextval = 1;
