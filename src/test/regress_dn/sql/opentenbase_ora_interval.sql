...
-- 
SELECT TO_CHAR(INTERVAL '123-2' YEAR(3) TO MONTH, 'YYYY-MM'), TO_CHAR(INTERVAL '13 15:20:33' DAY TO SECOND, 'DD HH24:MI:SS.US') FROM DUAL;
SELECT TO_CHAR(INTERVAL '11:12:10.2222', 'HH24:MI:SS.US');
select to_char(INTERVAL '11:12:00', 'HH24:MI:SS.US');
select to_char(interval '11:12', 'HH24:MI.US');
--Over
