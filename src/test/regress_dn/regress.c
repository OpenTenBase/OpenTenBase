...
PG_FUNCTION_INFO_V1(test_call_with_subtran);
Datum
test_call_with_subtran(PG_FUNCTION_ARGS)
{
	int		narg = PG_GETARG_INT32_0_IF_NULL(0);
	text    *arg1 = PG_GETARG_TEXT_PP_IF_NULL(1);
	text    *arg2 = PG_GETARG_TEXT_PP_IF_NULL(2);
	text    *arg3 = PG_GETARG_TEXT_PP_IF_NULL(3);
	text    *arg4 = PG_GETARG_TEXT_PP_IF_NULL(4);
	...
	{
	case 0:
		appendStringInfoString(buf, "arg:no args");
		break;
	case 1:
		appendStringInfoString(buf, "arg:");
		appendStringInfoString(buf, text_to_cstring(arg1));
		break;
	case 2:
		appendStringInfoString(buf, "arg:");
		appendStringInfoString(buf, text_to_cstring(arg1));
		appendStringInfoString(buf, ", arg:");
		appendStringInfoString(buf, text_to_cstring(arg2));
		break;
	case 3:
		appendStringInfoString(buf, "arg:");
		appendStringInfoString(buf, text_to_cstring(arg1));
		...
		appendStringInfoString(buf, text_to_cstring(arg2));
		appendStringInfoString(buf, ", arg:");
		appendStringInfoString(buf, text_to_cstring(arg3));
		break;
	case 4:
		appendStringInfoString(buf, "arg:");
		appendStringInfoString(buf, text_to_cstring(arg1));
		...
		appendStringInfoString(buf, text_to_cstring(arg3));
		appendStringInfoString(buf, ", arg:");
		appendStringInfoString(buf, text_to_cstring(arg4));
		break;
	default:
		break;
	}
...
PG_FUNCTION_INFO_V1(test_call_with_subtran_ops);
Datum
test_call_with_subtran_ops(PG_FUNCTION_ARGS)
{
	Datum   res;
	bool	hasError = true;
	Datum a1 = CStringGetDatum(cstring_to_text("Call2"));
	Datum a2 = CStringGetDatum(cstring_to_text("Call3"));
	Datum a3 = CStringGetDatum(cstring_to_text("Call4"));
	Datum a4 = CStringGetDatum(cstring_to_text("Call5"));

	res = DirectFunctionCall1WithSubTran(test_call_with_subtran, Int32GetDatum(0), &hasError);
	elog(NOTICE, "DirectFunctionCall1WithSubTran ret:%s", text_to_cstring(DatumGetTextP(res)));

	res = DirectFunctionCall2WithSubTran(test_call_with_subtran, Int32GetDatum(1), a1, &hasError);
	elog(NOTICE, "DirectFunctionCall2WithSubTran ret:%s", text_to_cstring(DatumGetTextP(res)));

	res = DirectFunctionCall3WithSubTran(test_call_with_subtran, Int32GetDatum(2), a1, a2, &hasError);
	elog(NOTICE, "DirectFunctionCall3WithSubTran ret:%s", text_to_cstring(DatumGetTextP(res)));

	res = DirectFunctionCall4WithSubTran(test_call_with_subtran, Int32GetDatum(3), a1, a2, a3, &hasError);
	elog(NOTICE, "DirectFunctionCall4WithSubTran ret:%s", text_to_cstring(DatumGetTextP(res)));

	res = DirectFunctionCall5WithSubTran(test_call_with_subtran, Int32GetDatum(4), a1, a2, a3, a4, &hasError);
	elog(NOTICE, "DirectFunctionCall5WithSubTran ret:%s", text_to_cstring(DatumGetTextP(res)));
