...
CREATE FUNCTION rw_view1_aa(x rw_view1)
  RETURNS int AS $$ SELECT x.aa $$ LANGUAGE sql pushdown;
...
create table opentenbase_test(id int);
create view test_view as select id from opentenbase_test where id >100;
insert into test_view values(1001),(1002);
select id from test_view order by id;
drop view test_view;
drop table opentenbase_test;
