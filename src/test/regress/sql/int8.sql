...
-- function to_bigint
SELECT TO_BIGINT('1472538969513574267');
SELECT TO_BIGINT('+1472538969513574267');
SELECT TO_BIGINT('-1472538969513574267');
SELECT TO_BIGINT(NULL);
SELECT PG_TYPEOF(TO_BIGINT('1472538969513574267'));

SELECT TO_BIGINT('14725389695135742670');
SELECT TO_BIGINT('x14725389695135742670');
SELECT TO_BIGINT('14725389695135742670a');
SELECT TO_BIGINT('1472538969o5135742670');
SELECT TO_BIGINT('');
