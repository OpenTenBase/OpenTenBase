...
CREATE TABLE FLOAT8_TBL2(f1 float8) DISTRIBUTE BY SHARD(f1);
insert into float8_tbl2 values('1.234567890123456456789e-20');
select * from float8_tbl2;
drop table FLOAT8_TBL2;
--
