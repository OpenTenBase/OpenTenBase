...
select regexp_count(a, c) from regexp_tbl order by a;
select regexp_count(a, c, 3) from regexp_tbl order by a;
select regexp_count(a, c, 3, 'x') from regexp_tbl order by a;

select regexp_count(a, d) from regexp_tbl order by a;
select regexp_count(a, d, 3) from regexp_tbl order by a;
select regexp_count(a, d, 3, 'x') from regexp_tbl order by a;

select regexp_count(b, c) from regexp_tbl order by a;
select regexp_count(b, c, 3) from regexp_tbl order by a;
select regexp_count(b, c, 3, 'x') from regexp_tbl order by a;
