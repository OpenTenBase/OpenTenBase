...
VectorTableSlot StructVectorTableSlot;
VectorDatumData StructVectorDatumData;
PlanState StructPlanState;
HashJoinState StructHashJoinState;
HashJoinTableData StructHashJoinTableData;
HashJoinTupleData StructHashJoinTupleData;
HashJoinTableBuckets StructHashJoinTableBuckets;
HashJoinTupleNext StructHashJoinTupleNext;
