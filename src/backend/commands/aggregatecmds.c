...
DefineAggregate(ParseState *pstate, List *name, List *args, bool oldstyle, List *parameters)
{
	...
	else
	{
		...
		{
			// Assert(parameterDefaults);
			// Assert(llast(parameterDefaults) == NIL);
		}
	...
	return AggregateCreate(aggName, /* aggregate name */
						   ...
						   parameterDefaults,
						   variadicArgType,
						   InvalidOid,	 	/* init function OID */
						   InvalidOid,		/* iterate function OID */
						   InvalidOid,		/* terminate function OID */
						   InvalidOid,		/* merge function OID */
						   ...
						   NULL, /* odci terminate fn return type */
