...
{
	VarBit *arg1 = PG_ARGISNULL(0) ? NULL : PG_GETARG_VARBIT_P(0);
	VarBit *arg2 = PG_ARGISNULL(1) ? NULL : PG_GETARG_VARBIT_P(1);

	if ((!enable_lightweight_ora_syntax && PG_MODE && (arg1 == NULL || arg2 == NULL)) || (arg1 == NULL && arg2 == NULL))
		PG_RETURN_NULL();
...
bit_catenate(VarBit *arg1, VarBit *arg2)
{
	...
	bitlen1 = arg1 ? VARBITLEN(arg1) : 0;
	bitlen2 = arg2 ? VARBITLEN(arg2) : 0;
	...
	{
		/* Copy the first bitstring in */
		memcpy(VARBITS(result), VARBITS(arg2), VARBITBYTES(arg2));
	}
