...
RI_Initial_Check(Trigger *trigger, Relation fk_rel, Relation pk_rel)
{
	...
	/*
	 * In a typical foreign key scenario, key value matching should be performed uniformly
	 * in the local access node. Data incompleteness on the distributed nodes (DN) can lead
	 * to false positives.
	 */
