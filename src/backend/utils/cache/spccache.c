 ...
 *		is still executing.
 *
 * OpenTenBase_V3: The most formal way is to expand spc cost definition options.
 * 		But mostly we do NOT suggest user to modify such fundamental costs,
 * 		thus we just return the pre-defined settings here.
 */
void
