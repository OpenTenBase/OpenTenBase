 ...
 */
static void *GenerationAllocInternal(MemoryContext context, Size size, const char* file, int line);
#define GenerationAlloc(context, size) GenerationAllocInternal(context, size, __FILE__, __LINE__)
 ...
 */
static void *
GenerationAllocInternal(MemoryContext context, Size size, const char* file, int line)
{
	GenerationContext  *set = (GenerationContext *) context;
