 ...
 */
static void *SlabAlloc(MemoryContext context, Size size, const char* file, int line);
 ...
 */
static void *
SlabAlloc(MemoryContext context, Size size, const char* file, int line)
{
	SlabContext *slab = castNode(SlabContext, context);
	SlabBlock  *block;
	SlabChunk  *chunk;
 ...
 */
static void *
SlabRealloc(MemoryContext context, void *pointer, Size size, const char* file,
			int line)
{
	SlabContext *slab = castNode(SlabContext, context);
