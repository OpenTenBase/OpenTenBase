 ...
 *
 * IDENTIFICATION
 *	  src/backend/nodes/rstore_tidbitmap.c
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
 ...
 * is this:
 * 
 * the size is DefaultSiloSize in estore table
 */
...
{
	int			flags;			/* flags for estore or rstore */
	int			nentries;		/* number of entries in pagetable */
	int			maxentries;		/* limit on same to meet maxbytes */
	int			npages;			/* number of exact entries in pagetable */
	int			nchunks;		/* number of lossy entries in pagetable */
...
/*
 * r_tbm_create - create an initially-empty bitmap
 *
 ...
 */
TIDBitmap *
r_tbm_create(long maxbytes, dsa_area *dsa, int flags)
{
	TIDBitmap  *tbm;
	long		nbuckets;
...
/*
 * r_tbm_free - free a TIDBitmap
 */
void
r_tbm_free(TIDBitmap *tbm)
{
	if (tbm->pagetable)
...
/*
 * r_tbm_free_shared_area - free shared state
 *
 ...
 */
void
r_tbm_free_shared_area(dsa_area *dsa, dsa_pointer dp)
{
...
/*
 * r_tbm_add_page - add a whole page to a TIDBitmap
 *
 * This causes the whole page to be reported (with the recheck flag)
 * when the TIDBitmap is scanned.
 */
void
r_tbm_add_page(TIDBitmap *tbm, BlockNumber pageno)
{
...
/*
 * r_tbm_union - set union
 *
 * a is modified in-place, b is not changed
 */
void
r_tbm_union(TIDBitmap *a, const TIDBitmap *b)
{
	Assert(!a->iterating);
...
/*
 * r_tbm_intersect - set intersection
 *
 * a is modified in-place, b is not changed
 */
void
r_tbm_intersect(TIDBitmap *a, const TIDBitmap *b)
{
	Assert(!a->iterating);
...
/*
 * r_tbm_is_empty - is a TIDBitmap completely empty?
 */
bool
r_tbm_is_empty(const TIDBitmap *tbm)
{
	return (tbm->nentries == 0);
}

/*
 * r_tbm_begin_iterate - prepare to iterate through a TIDBitmap
 *
 ...
 */
TBMIterator *
r_tbm_begin_iterate(TIDBitmap *tbm)
{
...
/*
 * r_tbm_prepare_shared_iterate - prepare shared iteration state for a TIDBitmap.
 *
 ...
 */
dsa_pointer
r_tbm_prepare_shared_iterate(TIDBitmap *tbm)
{
	dsa_pointer dp;
...
/*
 * r_tbm_iterate - scan through next page of a TIDBitmap
 *
 ...
 */
TBMIterateResult *
r_tbm_iterate(TBMIterator *iterator)
{
...
/*
 *	r_tbm_shared_iterate - scan through next page of a TIDBitmap
 *
 ...
 */
TBMIterateResult *
r_tbm_shared_iterate(TBMSharedIterator *iterator)
{
	TBMIterateResult *output = &iterator->output;
 ...
 */
TBMSharedIterator *
r_tbm_attach_shared_iterate(dsa_area *dsa, dsa_pointer dp)
{
