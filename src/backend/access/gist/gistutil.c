 ...
 */
void
GISTInitBuffer(Buffer b, uint32 f, bool checksum_enabled)
{
	...
	PageInit(page, pageSize, sizeof(GISTPageOpaqueData), checksum_enabled);
...
gistoptions(Datum reloptions, bool validate)
{
	...
	static const relopt_parse_elt tab[] = {
		...
		{"checksum", RELOPT_TYPE_BOOL, offsetof(GiSTOptions, checksum)},
	};
