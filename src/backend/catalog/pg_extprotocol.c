				  ...
				  bool trusted)
{
	...
	protOid = 0;/*GetNewOidForExtprotocol(rel, ExtprotocolOidIndexId,
...
ValidateProtocolFunction(List *fnName, ExtPtcFuncType fntype)
{
	...
	fdresult = func_get_detail(fnName, NIL, NIL,
							   ...
							   &nvargs, &vatype, &true_oid_array, NULL, NULL);
						  ...
						  bool error)
{
	...
	rel = relation_open(ExtprotocolRelationId, AccessShareLock);
