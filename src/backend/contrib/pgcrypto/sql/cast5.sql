...
-- 128 bit key
SELECT encode(encrypt(
pg_catalog.decode('01 23 45 67 89 AB CD EF', 'hex'),
pg_catalog.decode('01 23 45 67 12 34 56 78 23 45 67 89 34 56 78 9A', 'hex'),
'cast5-ecb/pad:none'), 'hex');
-- result: 23 8B 4F E5 84 7E 44 B2
...
SELECT encode(encrypt(
pg_catalog.decode('01 23 45 67 89 AB CD EF', 'hex'),
pg_catalog.decode('01 23 45 67 12 34 56 78 23 45', 'hex'),
'cast5-ecb/pad:none'), 'hex');
-- result: EB 6A 71 1A 2C 02 27 1B
...
SELECT encode(encrypt(
pg_catalog.decode('01 23 45 67 89 AB CD EF', 'hex'),
pg_catalog.decode('01 23 45 67 12', 'hex'),
'cast5-ecb/pad:none'), 'hex');
-- result: 7A C8 16 D1 6E 9B 30 2E
...
-- iv
select encode(encrypt_iv('foo', '0123456', 'abcd', 'cast5'), 'hex');
select decrypt_iv(pg_catalog.decode('384a970695ce016a', 'hex'),
                '0123456', 'abcd', 'cast5');
