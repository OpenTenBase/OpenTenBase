...
-- test vector from somewhere
SELECT encode(encrypt(
pg_catalog.decode('80 00 00 00 00 00 00 00', 'hex'),
pg_catalog.decode('01 01 01 01 01 01 01 01
	01 01 01 01 01 01 01 01
	01 01 01 01 01 01 01 01', 'hex'),
'3des-ecb/pad:none'), 'hex');
-- val 95 F8 A5 E5 DD 31 D9 00
...
-- iv
select encode(encrypt_iv('foo', '0123456', 'abcd', '3des'), 'hex');
select decrypt_iv(pg_catalog.decode('50735067b073bb93', 'hex'), '0123456', 'abcd', '3des');
