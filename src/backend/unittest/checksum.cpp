 ...
 *
 * IDENTIFICATION
 *	  src/backend/unittest/checksum.cpp
 *
 *-------------------------------------------------------------------------
 */
extern "C" {
...
TEST(PageChecksum, PageOn_TableOn_Success)
{
	...
	ASSERT_EQ(PageIsVerified(page ,blockNumber ,true),true);
	ASSERT_EQ(PageHasCheckSum(page), PD_CRC_CHECK);
...
TEST(PageChecksum, PageOn_TableOn_Failure)
{
	...
	ASSERT_EQ(PageIsVerified(page ,blockNumber ,true),false);
...
TEST(PageChecksum, PageOn_TableOff)
{
	...
	ASSERT_EQ(PageIsVerified(page ,blockNumber ,false),true);
	ASSERT_EQ(PageHasCheckSum(page), 0);
