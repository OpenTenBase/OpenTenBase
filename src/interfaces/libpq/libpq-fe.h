...
extern int PQconnectdbParallel(char const* const* conninfo, int count, PGconn *conn[]);
...
extern int PQcancelSend(PGcancel* cancel, pqbool end_query, char* errbuf, int errbufsize, int timeout, pgsocket *sock);
extern void PQcancelRecv(pgsocket tmpsock);
#ifdef __OPENTENBASE_C__
extern int PQend(PGcancel *cancel, char *errbuf, int errbufsize);
#endif
...
extern int	PQopentenbaseVersion(const PGconn *conn);
...
extern char *PQSqlMode(const PGconn *conn);
extern int PQinOraMode(void);
