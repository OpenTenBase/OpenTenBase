...
plperl_event_trigger_build_args(FunctionCallInfo fcinfo)
{
	...
	hv_store_string(hv, "dictionary_obj_name", cstr2sv(tdata->dictionary_obj_name));
	hv_store_string(hv, "dictionary_obj_type", cstr2sv(tdata->dictionary_obj_type));
	hv_store_string(hv, "sysevent", cstr2sv(tdata->sysevent));
