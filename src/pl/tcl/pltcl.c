...
{
	return pg_any_to_server(src, strlen(src), PG_UTF8, false, false);
}
							...
							bool pltrusted)
{
	...
	Tcl_ListObjAppendElement(NULL, tcl_cmd,
							 Tcl_NewStringObj(utf_e2u(tdata->dictionary_obj_name), -1));
	Tcl_ListObjAppendElement(NULL, tcl_cmd,
							 Tcl_NewStringObj(utf_e2u(tdata->dictionary_obj_type), -1));
	Tcl_ListObjAppendElement(NULL, tcl_cmd,
							 Tcl_NewStringObj(utf_e2u(tdata->sysevent), -1));
