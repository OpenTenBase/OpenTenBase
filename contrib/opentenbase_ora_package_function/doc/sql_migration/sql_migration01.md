...
To implement these data types and functions in line with the orafce external specifications, specify "opentenbase_ora" and "pg_catalog" in the search_path parameter of postgresql.conf. 
