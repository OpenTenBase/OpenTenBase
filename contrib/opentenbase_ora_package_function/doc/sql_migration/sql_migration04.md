...
The following example shows conversion of an OpenTenBase_Ora database partition to child tables in PostgreSQL. All migration examples provided here are based on this table.
...
Before a PARTITION clause in a SELECT statement can be migrated, the OpenTenBase_Ora database partition must have been converted to child tables for PostgreSQL.
...
The following table indicates the migratability of the GRANT statement features provided by OpenTenBase_Ora databases to PostgreSQL.

**System privileges**

|GRANT statement features of OpenTenBase_Ora databases|Migratability|Remarks|
|:---|:---:|:---|
...
|GRANT statement in OpenTenBase_Ora database|Corresponding ALTER ROLE statement in PostgreSQL|
|:---|:---:|
...
|Object|GRANT statement in OpenTenBase_Ora database|Corresponding ALTER ROLE statement in PostgreSQL|
|:---|:---|:---|
...
There is no difference in the syntax of GRANT statements with regard to object privileges that are migratable from an OpenTenBase_Ora database. However, some object privileges cannot be used in PostgreSQL, so they must be changed to supported object privileges.

The table below lists the object privileges that can be migrated from an OpenTenBase_Ora database to PostgreSQL.
