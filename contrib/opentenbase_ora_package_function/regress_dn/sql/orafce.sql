...
--
-- test built-in date type opentenbase_ora compatibility functions
--
...
SET search_path TO opentenbase_ora,"$user", public, pg_catalog;
...
select trunc(to_date('22-AUG-03', 'DD-MON-YY'), 'FMDD')  =  to_date ('22-AUG-03', 'DD-MON-YY');
...
select 4 = instrb('张三','三');
select 10 = instrb('张三张三张三','三', 5);
select 16 = instrb('张三张三张三','三', 5, 2);
select 10 = instrb('张三张三张三','三', -2, 2);
select 0 = instrb('张三',' ');
select instrb('张三','') is NULL;
select instrb('','三') is NULL;
select opentenbase_ora.substr('This is a test', 6, 2) = 'is';
select opentenbase_ora.substr('This is a test', 6) =  'is a test';
select opentenbase_ora.substr('TechOnTheNet', 1, 4) =  'Tech';
select opentenbase_ora.substr('TechOnTheNet', -3, 3) =  'Net';
select opentenbase_ora.substr('TechOnTheNet', -6, 3) =  'The';
select opentenbase_ora.substr('TechOnTheNet', -8, 2) =  'On';
select opentenbase_ora.substr('TechOnTheNet', -8, 0) =  '';
select opentenbase_ora.substr('TechOnTheNet', -8, -1) =  '';
select opentenbase_ora.substr(1234567,3.6::smallint)='4567';
select opentenbase_ora.substr(1234567,3.6::int)='4567';
select opentenbase_ora.substr(1234567,3.6::bigint)='4567';
select opentenbase_ora.substr(1234567,3.6::numeric)='34567';
select opentenbase_ora.substr(1234567,-1)='7';
select opentenbase_ora.substr(1234567,3.6::smallint,2.6)='45';
select opentenbase_ora.substr(1234567,3.6::smallint,2.6::smallint)='456';
select opentenbase_ora.substr(1234567,3.6::smallint,2.6::int)='456';
select opentenbase_ora.substr(1234567,3.6::smallint,2.6::bigint)='456';
select opentenbase_ora.substr(1234567,3.6::smallint,2.6::numeric)='45';
select opentenbase_ora.substr(1234567,3.6::int,2.6::smallint)='456';
select opentenbase_ora.substr(1234567,3.6::int,2.6::int)='456';
select opentenbase_ora.substr(1234567,3.6::int,2.6::bigint)='456';
select opentenbase_ora.substr(1234567,3.6::int,2.6::numeric)='45';
select opentenbase_ora.substr(1234567,3.6::bigint,2.6::smallint)='456';
select opentenbase_ora.substr(1234567,3.6::bigint,2.6::int)='456';
select opentenbase_ora.substr(1234567,3.6::bigint,2.6::bigint)='456';
select opentenbase_ora.substr(1234567,3.6::bigint,2.6::numeric)='45';
select opentenbase_ora.substr(1234567,3.6::numeric,2.6::smallint)='345';
select opentenbase_ora.substr(1234567,3.6::numeric,2.6::int)='345';
select opentenbase_ora.substr(1234567,3.6::numeric,2.6::bigint)='345';
select opentenbase_ora.substr(1234567,3.6::numeric,2.6::numeric)='34';
select opentenbase_ora.substr('abcdef'::varchar,3.6::smallint)='def';
select opentenbase_ora.substr('abcdef'::varchar,3.6::int)='def';
select opentenbase_ora.substr('abcdef'::varchar,3.6::bigint)='def';
select opentenbase_ora.substr('abcdef'::varchar,3.6::numeric)='cdef';
select opentenbase_ora.substr('abcdef'::varchar,3.5::int,3.5::int)='def';
select opentenbase_ora.substr('abcdef'::varchar,3.5::numeric,3.5::numeric)='cde';
select opentenbase_ora.substr('abcdef'::varchar,3.5::numeric,3.5::int)='cdef';
...
select PLVstr.rvrs ('alphabet', 5, 2);
select PLVstr.rvrs ('alphabet', 0, 0);
select PLVstr.rvrs ('alphabet', 0, 1);
select PLVstr.rvrs ('alphabet', 1, 0);
select PLVstr.rvrs ('alphabet', 1, 1);
select PLVstr.rvrs ('alphabet', 0, -1);
select PLVstr.rvrs ('alphabet', -1, 0);
select PLVstr.rvrs ('alphabet', 20, 200);
select PLVstr.rvrs ('alphabet', 200, 200);
select plvstr.rvrs('c4ca4238a0b923820dcc509a6f75849b', -1956435023,- 1956435023);
select PLVstr.rvrs ('alphabet', -1, 5);
select PLVstr.rvrs ('alphabet', 5, -1);
select PLVstr.rvrs ('alphabet', -6, -5);
...
select opentenbase_ora.to_date('210514 12:13:44.55');

-- Tests for opentenbase_ora.to_date(text,text)
SET search_path TO opentenbase_ora,"$user", public, pg_catalog;
...
--Tests for opentenbase_ora.to_char(timestamp)-used to set the DATE output format
SET search_path TO opentenbase_ora,"$user", public, pg_catalog;
SET orafce.nls_date_format to default;
select opentenbase_ora.to_char(to_date('19-APR-16 21:41:48'));
set orafce.nls_date_format='YY-MonDD HH24:MI:SS';
select opentenbase_ora.to_char(to_date('14-Jan08 11:44:49+05:30'));
set orafce.nls_date_format='YY-DDMon HH24:MI:SS';
select opentenbase_ora.to_char(to_date('14-08Jan 11:44:49+05:30'));
set orafce.nls_date_format='DDMMYYYY HH24:MI:SS';
select opentenbase_ora.to_char(to_date('21052014 12:13:44+05:30'));
set orafce.nls_date_format='DDMMYY HH24:MI:SS';
select opentenbase_ora.to_char(to_date('210514 12:13:44+05:30'));
set orafce.nls_date_format='DDMMYYYY HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('2014/04/25 10:13', 'YYYY/MM/DD HH:MI'));
set orafce.nls_date_format='YY-DDMon HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('16-Feb-09 10:11:11', 'DD-Mon-YY HH:MI:SS'));
set orafce.nls_date_format='YY-DDMon HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('02/16/09 04:12:12', 'MM/DD/YY HH24:MI:SS'));
set orafce.nls_date_format='YY-MonDD HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('021609 111213', 'MMDDYY HHMISS'));
set orafce.nls_date_format='DDMMYYYY HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('16-Feb-09 11:12:12', 'DD-Mon-YY HH:MI:SS'));
set orafce.nls_date_format='DDMMYYYY HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('Feb/16/09 11:21:23', 'Mon/DD/YY HH:MI:SS'));
set orafce.nls_date_format='DDMMYYYY HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('February.16.2009 10:11:12', 'Month.DD.YYYY HH:MI:SS'));
set orafce.nls_date_format='YY-MonDD HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('20020315111212', 'yyyymmddhh12miss'));
set orafce.nls_date_format='DDMMYYYY HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('January 15, 1989, 11:00 A.M.','Month dd, YYYY, HH:MI A.M.'));
set orafce.nls_date_format='DDMMYY HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('14-Jan08 11:44:49+05:30' ,'YY-MonDD HH24:MI:SS'));
set orafce.nls_date_format='DDMMYYYY HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('14-08Jan 11:44:49+05:30','YY-DDMon HH24:MI:SS'));
set orafce.nls_date_format='YY-MonDD HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('21052014 12:13:44+05:30','DDMMYYYY HH24:MI:SS'));
set orafce.nls_date_format='DDMMYY HH24:MI:SS';
select opentenbase_ora.to_char(opentenbase_ora.to_date('210514 12:13:44+05:30','DDMMYY HH24:MI:SS'));
SET search_path TO default;

--Tests for opentenbase_ora.-(opentenbase_ora.date,opentenbase_ora.date)
SET search_path TO opentenbase_ora,"$user", public, pg_catalog;
...
SELECT '|' || opentenbase_ora.lpad('あbcd'::char(8), 10) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::char(8),  5) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::char(8), 1) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::char(5), 10, 'xい'::char(3)) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::char(5),  5, 'xい'::char(3)) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::char(5), 10, 'xい'::text) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::char(5), 10, 'xい'::varchar2(5)) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::char(5), 10, 'xい'::nvarchar2(3)) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::text, 10, 'xい'::char(3)) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::text,  5, 'xい'::char(3)) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::varchar2(5), 10, 'xい'::char(3)) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::varchar2(5),  5, 'xい'::char(3)) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::nvarchar2(5), 10, 'xい'::char(3)) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::nvarchar2(5),  5, 'xい'::char(3)) || '|';

/* test opentenbase_ora.lpad(text, int [, text]) */
SELECT '|' || opentenbase_ora.lpad('あbcd'::text, 10) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::text,  5) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::varchar2(10), 10) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::varchar2(10), 5) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::nvarchar2(10), 10) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::nvarchar2(10), 5) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::text, 10, 'xい'::text) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::text, 10, 'xい'::varchar2(5)) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::text, 10, 'xい'::nvarchar2(3)) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::varchar2(5), 10, 'xい'::text) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::varchar2(5), 10, 'xい'::varchar2(5)) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::varchar2(5), 10, 'xい'::nvarchar2(5)) || '|';

SELECT '|' || opentenbase_ora.lpad('あbcd'::nvarchar2(5), 10, 'xい'::text) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::nvarchar2(5), 10, 'xい'::varchar2(5)) || '|';
SELECT '|' || opentenbase_ora.lpad('あbcd'::nvarchar2(5), 10, 'xい'::nvarchar2(5)) || '|';
...
/* cases where one or more arguments are of type CHAR */
SELECT '|' || opentenbase_ora.rpad('あbcd'::char(8), 10) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::char(8),  5) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::char(8), 1) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::char(5), 10, 'xい'::char(3)) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::char(5),  5, 'xい'::char(3)) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::char(5), 10, 'xい'::text) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::char(5), 10, 'xい'::varchar2(5)) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::char(5), 10, 'xい'::nvarchar2(3)) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::text, 10, 'xい'::char(3)) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::text,  5, 'xい'::char(3)) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::varchar2(5), 10, 'xい'::char(3)) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::varchar2(5),  5, 'xい'::char(3)) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::nvarchar2(5), 10, 'xい'::char(3)) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::nvarchar2(5),  5, 'xい'::char(3)) || '|';

/* test opentenbase_ora.lpad(text, int [, text]) */
SELECT '|' || opentenbase_ora.rpad('あbcd'::text, 10) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::text,  5) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::varchar2(10), 10) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::varchar2(10), 5) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::nvarchar2(10), 10) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::nvarchar2(10), 5) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::text, 10, 'xい'::text) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::text, 10, 'xい'::varchar2(5)) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::text, 10, 'xい'::nvarchar2(3)) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::varchar2(5), 10, 'xい'::text) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::varchar2(5), 10, 'xい'::varchar2(5)) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::varchar2(5), 10, 'xい'::nvarchar2(5)) || '|';

SELECT '|' || opentenbase_ora.rpad('あbcd'::nvarchar2(5), 10, 'xい'::text) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::nvarchar2(5), 10, 'xい'::varchar2(5)) || '|';
SELECT '|' || opentenbase_ora.rpad('あbcd'::nvarchar2(5), 10, 'xい'::nvarchar2(5)) || '|';
...
-- LTRIM
--
SELECT '|' || opentenbase_ora.ltrim(' abcd'::char(10)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.ltrim(' abcd'::char(10),'a'::char(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.ltrim(' abcd'::char(10),'a'::text) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.ltrim(' abcd'::char(10),'a'::varchar2(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.ltrim(' abcd'::char(10),'a'::nvarchar2(3)) || '|' as LTRIM;

SELECT '|' || opentenbase_ora.ltrim(' abcd  '::text,'a'::char(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.ltrim(' abcd  '::varchar2(10),'a'::char(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.ltrim(' abcd  '::nvarchar2(10),'a'::char(3)) || '|' as LTRIM;

--
-- RTRIM
--
SELECT '|' || opentenbase_ora.rtrim(' abcd'::char(10)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.rtrim(' abcd'::char(10),'d'::char(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.rtrim(' abcd'::char(10),'d'::text) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.rtrim(' abcd'::char(10),'d'::varchar2(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.rtrim(' abcd'::char(10),'d'::nvarchar2(3)) || '|' as LTRIM;

SELECT '|' || opentenbase_ora.rtrim(' abcd  '::text,'d'::char(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.rtrim(' abcd  '::varchar2(10),'d'::char(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.rtrim(' abcd  '::nvarchar2(10),'d'::char(3)) || '|' as LTRIM;

--
-- BTRIM
--
SELECT '|' || opentenbase_ora.btrim(' abcd'::char(10)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.btrim(' abcd'::char(10),'ad'::char(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.btrim(' abcd'::char(10),'ad'::text) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.btrim(' abcd'::char(10),'ad'::varchar2(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.btrim(' abcd'::char(10),'ad'::nvarchar2(3)) || '|' as LTRIM;

SELECT '|' || opentenbase_ora.btrim(' abcd  '::text,'d'::char(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.btrim(' abcd  '::varchar2(10),'d'::char(3)) || '|' as LTRIM;
SELECT '|' || opentenbase_ora.btrim(' abcd  '::nvarchar2(10),'d'::char(3)) || '|' as LTRIM;

--
-- test opentenbase_ora.length()
--

/* test that trailing blanks are not ignored */
SELECT opentenbase_ora.length('あbb'::char(6));
SELECT opentenbase_ora.length(''::char(6));
...
SELECT opentenbase_ora.round(1.234::double precision, 2), opentenbase_ora.trunc(1.234::double precision, 2);
SELECT opentenbase_ora.round(1.234::float, 2), opentenbase_ora.trunc(1.234::float, 2);
...
CREATE TRIGGER trg_test_xx BEFORE INSERT OR UPDATE
  ON trg_test FOR EACH ROW EXECUTE PROCEDURE opentenbase_ora.replace_empty_strings(true);
...
CREATE TRIGGER trg_test_xx BEFORE INSERT OR UPDATE
  ON trg_test FOR EACH ROW EXECUTE PROCEDURE opentenbase_ora.replace_null_strings();
...
select to_binary_float(123.456, '999.99'); --fail
...
select to_binary_double(123.456, '999.99'); --fail
