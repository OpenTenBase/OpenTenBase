...
extern Datum rowidtou(PG_FUNCTION_ARGS);
...
extern PGDLLEXPORT Datum ora_asciistr(PG_FUNCTION_ARGS);
...
extern PGDLLEXPORT Datum opentenbase_ora_substr2(PG_FUNCTION_ARGS);
extern PGDLLEXPORT Datum opentenbase_ora_substr3(PG_FUNCTION_ARGS);
extern PGDLLEXPORT Datum plvstr_instrb2(PG_FUNCTION_ARGS);
extern PGDLLEXPORT Datum plvstr_instrb3(PG_FUNCTION_ARGS);
extern PGDLLEXPORT Datum plvstr_instrb4(PG_FUNCTION_ARGS);
...
extern PGDLLEXPORT Datum dbms_output_put_line_int(PG_FUNCTION_ARGS);
extern PGDLLEXPORT Datum dbms_output_put_line_float8(PG_FUNCTION_ARGS);
extern PGDLLEXPORT Datum dbms_output_put_line_numeric(PG_FUNCTION_ARGS);
...
extern PGDLLEXPORT Datum format_error_backtrace(PG_FUNCTION_ARGS);
...
/* from userenv.c */
extern PGDLLEXPORT Datum orafce_userenv(PG_FUNCTION_ARGS);
/* from dbms_session */
extern PGDLLEXPORT Datum dbms_session_unique_session_id(PG_FUNCTION_ARGS);
extern PGDLLEXPORT Datum dbms_session_reset_package(PG_FUNCTION_ARGS);
extern PGDLLEXPORT Datum dbms_session_free_unused_user_memory(PG_FUNCTION_ARGS);

/* from opentenbase_ora.c */
#define Natts_plsql_coverage_stat_units 6
#define Anum_plsql_coverage_stat_units_fn_oid 1
#define Anum_plsql_coverage_stat_units_fn_xmin 2
#define Anum_plsql_coverage_stat_units_start_time 3
#define Anum_plsql_coverage_stat_units_finish_time 4
#define Anum_plsql_coverage_stat_units_stmts_num 5
#define Anum_plsql_coverage_stat_units_uncover_code_pos 6
extern bool oraplsql_coverage_stats;
extern PGDLLEXPORT Datum get_plsql_coverage_detail(PG_FUNCTION_ARGS);
