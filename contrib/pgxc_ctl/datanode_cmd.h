...
#ifdef XCP
extern int add_datanodeMaster(char *name, char *host, int port, int pooler, int fwdserver,
...
#endif
extern int add_datanodeSlave(char *name, char *host, int port, int pooler, int fwdserver,
