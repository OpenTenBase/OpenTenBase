...
extern int add_coordinatorMaster(char *name, char *host, int port, int forwardPort, int pooler,
		char *dir, char *extraConf, char *extraPgHbaConf);
extern int add_coordinatorSlave(char *name, char *host, int port, int forwardPort, int pooler, char *dir, char *archDir);
