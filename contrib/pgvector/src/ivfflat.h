...
typedef struct IvfflatScanCandidate
{
	double		distance;
	ItemPointerData heaptid;
}			IvfflatScanCandidate;

typedef float (*IvfflatVectorDistance) (int dim, const float *ax, const float *bx);
...
typedef struct IvfflatScanOpaqueData
{
	...
	IvfflatScanCandidate *candidates;
	int			candidateCount;
	...
	FmgrInfo   *normprocinfo;
	Oid			collation;
	IvfflatVectorDistance vectorDistance;
	bool		negateVectorDistance;

	/* Lists */
	BlockNumber *listPages;
	int			listIndex;
	IvfflatScanList *listHeap;
