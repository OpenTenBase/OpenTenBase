...
ALTER EXTENSION pg_clean ADD function pg_clean_execute_for_deadlock(time_interval integer);
ALTER EXTENSION pg_clean ADD function pg_clean_execute_for_node_removed(time_interval integer);
ALTER EXTENSION pg_clean ADD function pg_clean_execute_on_node(abnormal_nodename text, abnormal_time bigint);
ALTER EXTENSION pg_clean ADD function pg_clean_execute_on_node_for_deadlock(abnormal_nodename text, abnormal_time bigint);
ALTER EXTENSION pg_clean ADD function pg_clean_check_txn(time_interval integer);
ALTER EXTENSION pg_clean ADD function pg_clean_check_txn_for_deadlock(time_interval integer);
ALTER EXTENSION pg_clean ADD function pg_clean_check_txn_for_node_removed(time_interval integer);
