create database contrib_ora_dblink sql mode opentenbase_ora;
\c contrib_ora_dblink
...
set NLS_TIMESTAMP_TZ_FORMAT='DD-MM-YYYY HH24:MI:SS.FF9TZH:TZM BC';
SET intervalstyle = postgres;
SET timezone = UTC;
SELECT dblink_connect('myconn',connection_parameters());
SELECT dblink_exec('myconn', 'set NLS_TIMESTAMP_TZ_FORMAT=''DD-MM-YYYY HH24:MI:SS.FF9TZH:TZM BC'';');
...
SELECT dblink_exec('myconn', 'set NLS_TIMESTAMP_TZ_FORMAT=''MM.DD.YYYY HH24:MI:SS.FF9TZH:TZM BC'';');
INSERT INTO result
  SELECT *
  FROM dblink('myconn',
