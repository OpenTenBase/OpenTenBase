...
#include "libpq-fe.h"
extern int pgfdw_join_pushdown;
extern double pgfdw_join_startup_cost;
extern double pgfdw_join_total_cost;
extern double pgfdw_join_rows;
extern bool pgfdw_pushdown_non_volatile_func;
/*
