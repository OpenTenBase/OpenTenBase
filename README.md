...
> **New to OpenTenBase?** Start with the [architecture glossary and newcomer guide](GLOSSARY.md) to understand Coordinator nodes, DataNodes, GTM, node groups, data distribution, and distributed transactions.
