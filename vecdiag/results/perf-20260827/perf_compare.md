...
|---|---|---|---|---|---|---|---|---|
| M1-内存模型 | 逐例命中 | 旧公式(0.8.0) | 高估 1.00–306.35 倍 | 本模型 | 18/18 逐字命中 | 倍/例 | 平均高估 29.54 倍 | `results/m1-r3-20260826/model_compare.csv` |
...
| T3.5-降级ETA | 降级前平均偏移(负=报早了) | 朴素线性外推 | -58.8 | 接入M2降级预测 | -15.6 | 秒 | 少报早 43.2 秒 | `results/t35-20260827/eta_correction.txt` |
