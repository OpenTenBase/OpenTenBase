...
extern Datum opentenbase_set_need_mvcc(PG_FUNCTION_ARGS);
extern Datum opentenbase_show_need_mvcc(PG_FUNCTION_ARGS);
...
extern Datum partitions_number(PG_FUNCTION_ARGS);
